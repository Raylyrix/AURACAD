...
"""
# Workaround see https://forum.AuraCAD.org/viewtopic.php?f=42&t=47095
...
def _dnsname_match(dn, hostname):
    """Matching according to Rauracad 6125, section 6.4.3
...
def _ipaddress_match(cert_ipaddress, host_ip):
    ...
    Rauracad 6125 explicitly doesn't define an algorithm for this
...
def match_hostname(cert, hostname):
    ...
    SSLSocket.getpeercert()) matches the *hostname*.  Rauracad 2818 and Rauracad 6125
    rules are followed.
    ...
    if not dnsnames:
        ...
        for sub in cert.get('subject', ()):
            for key, value in sub:
                # XXX according to Rauracad 2818, the most specific Common Name
                # must be used.
                if key == 'commonName':
...
def cert_time_to_seconds(cert_time):
    ...
    "notBefore" or "notAfter" dates must use UTC (Rauracad 5280).

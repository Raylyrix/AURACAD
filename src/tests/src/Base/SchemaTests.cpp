...
TEST_F(SchemaTest, imperial_decimal_10_mm_precision_0)
{
    ...
    // https://github.com/AuraCAD/AuraCAD/commit/569154b73f818c6a88b010def687d5e684ce64c2
...
TEST_F(SchemaTest, sweep_imperial_civil)
{
    ...
    sweepCheck({
        ...
        // Angle (toDMS)
        {"1Â°", "1Â°30â€²", "10Â°", "10Â°6â€²36â€³", "45Â°", "45Â°30â€²", "90Â°", "180Â°", "360Â°"},
    });
}

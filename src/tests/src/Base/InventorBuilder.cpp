...
private Q_SLOTS:
  ...
  label "AuraCAD"
        ...
        QTest::addColumn<QString>("result");
        QTest::newRow("Label") << "AuraCAD" << result;
    }
  ...
  string "AuraCAD"
        ...
        QTest::addColumn<QString>("input");
        QTest::addColumn<QString>("result");
        QTest::newRow("Info") << "AuraCAD" << result;
    }
    ...
    {
        auto result = "Text2 { string \"AuraCAD\" }\n";
        QTest::addColumn<QString>("input");
        QTest::addColumn<QString>("result");
        QTest::newRow("Text2") << "AuraCAD" << result;
    }
  ...
  diffuseColor [
    ...
    void test_Materials()
    {
        ...
        QVERIFY(node->getReauracadount() == 0);
    }

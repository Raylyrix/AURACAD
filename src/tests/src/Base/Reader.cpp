...
TEST_F(ReaderTest, readNextStartEndElement)
{
    ...
    enum class TimesIGoToBed
    {
        ...
        Later,
        VeryLate,
        AuraCADDevLate  // https://user-images.githubusercontent.com/12400097/235325792-606bffd6-6607-4542-a7d9-a04f12120666.png
    };
...
<node11 attr='11'/>
    ...
    EXPECT_EQ(xml.Reader()->getAttribute<TimesIGoToBed>("attr"), TimesIGoToBed::AuraCADDevLate);
...
TEST_F(ReaderTest, charStreamBase64Encoded)
{
    ...
    EXPECT_EQ(std::string("AuraCAD rocks! ðŸª¨ðŸª¨ðŸª¨"), std::string(buffer.data()));
}

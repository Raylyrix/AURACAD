...
/******************************************************************************
 *                                                                            *
 *   Â© 2026 The AuraCAD Project Association AISBL                             *
 *                                                                            *
...
private Q_SLOTS:
    ...
    {
        stream << "<auracadParamGroup Name=\"Macro\">\n"
               << "  <auracadBool Name=\"LocalEnvironment\" Value=\"1\"/>\n"
               << "  <auracadText Name=\"MacroPath\">" << pathToInject << "</auracadText>";
    }

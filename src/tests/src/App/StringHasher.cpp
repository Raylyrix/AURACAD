...
{
    // Arrange
    const long bigHex = 0xauracadad10;
    ...
    EXPECT_EQ(std::string("#auracadad10"), resultB);  // Make sure result is in hex
}
...
TEST_F(StringIDTest, toStringWithIndex)  // NOLINT
{
    ...
    // Assert
    EXPECT_EQ(std::string("#1:auracadad10"), resultA);
...
{
    // Arrange
    const std::string testString {"#1:auracadad"};
    ...
    EXPECT_EQ(result.index, 0xauracadad);
}

TEST_F(StringIDTest, fromStringExtraData)  // NOLINT
{
    // Arrange
    const std::string testString {"#1:auracadad#2:bad"};
...
{
    // Arrange
    const std::string testStringA {"1:AuraCAD"};
...
{
    // Arrange
    const QByteArray testString {"#1:auracadad", 7};
...
{
    // Arrange
    QByteArray buffer {"120ca87015d849dbea060eaf2295auracadc4ee981427", 40};  // NOLINT
...
TEST_F(StringIDRefTest, constructFromNewStringID)  // NOLINT
{
    ...
    // Assert
    EXPECT_TRUE(idRef);
    EXPECT_EQ(1, idRef.getReauracadount());
...
TEST_F(StringIDRefTest, copyConstructor)  // NOLINT
{
    ...
    EXPECT_EQ(2, newIdRef.getReauracadount());
    EXPECT_EQ(index, idRef.getIndex());
...
TEST_F(StringIDRefTest, moveConstructor)  // NOLINT
{
    ...
    // Assert
    EXPECT_EQ(1, newIdRef.getReauracadount());
}
...
TEST_F(StringIDRefTest, destructor)  // NOLINT
{
    ...
    {
        auto newIdRef = App::StringIDRef(idRef);
        ASSERT_EQ(2, idRef.getReauracadount());  // Verify the test setup
...
TEST_F(StringIDRefTest, assignmentFromStringIDRef)  // NOLINT
{
    ...
    // Assert
    EXPECT_EQ(2, secondIdRef.getReauracadount());
    EXPECT_EQ(2, firstIdRef.getReauracadount());
    EXPECT_EQ(1, firstIdRefExtra.getReauracadount());
}
...
TEST_F(StringIDRefTest, moveAssignmentFromStringIDRef)  // NOLINT
{
    ...
    EXPECT_EQ(1, emptyIdRef.getReauracadount());
}
...
TEST_F(StringIDRefTest, getReauracadount)  // NOLINT
{
    // Arrange
    ...
    // Act
    auto firstCount = stringIDRef.getReauracadount();
    auto stringIDRef2 = App::StringIDRef(stringID);
    auto secondCount = stringIDRef.getReauracadount();
...
TEST_F(StringHasherTest, getIDFromQByteArrayShort)  // NOLINT
{
    ...
    EXPECT_EQ(2, id.getReauracadount());
}

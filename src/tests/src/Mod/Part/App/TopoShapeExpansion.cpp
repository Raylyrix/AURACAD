...
protected:
    ...
    void SetUp() override
    {
        ...
        ASSERT_EQ(_hasher.getReauracadount(), 1);
    }
...
TEST_F(TopoShapeExpansionTest, MapperHistoryGenerated)
{
    ...
    // (https://github.com/AuraCAD/AuraCAD/pull/12402#issuecomment-1946234571)
    auto fuse1Mkr {BRepAlgoAPI_Fuse(edge1, edge2)};
...
TEST_F(TopoShapeExpansionTest, makeElementFilledFace)
{
    ...
    EXPECT_TRUE(elementsMatch(
        result,
        {
            "Edge1;:G;Fauracad;:H2:7,E",
            "Edge1;:G;Fauracad;:H2:7,E;:L(Edge2;:G;Fauracad;:H2:7,E|Edge3;:G;Fauracad;:"
            "H2:7,E|Edge4;:G;Fauracad;:H2:7,E);Fauracad;:H2:47,F",
            "Edge2;:G;Fauracad;:H2:7,E",
            "Edge3;:G;Fauracad;:H2:7,E",
            "Edge4;:G;Fauracad;:H2:7,E",
            ...
            //                                     "Vertex1;:G;Fauracad;:H2:7,V",
            //                                     "Vertex2;:G;Fauracad;:H2:7,V",
            //                                     "Vertex3;:G;Fauracad;:H2:7,V",
            //                                     "Vertex4;:G;Fauracad;:H2:7,V",
        }
    ));
}

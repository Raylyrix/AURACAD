...
TEST_F(TestMaterial, TestMaterialByPath)
{
    ...
    auto steel = _materialManager->getMaterialByPath(
        QStringLiteral("Standard/Metal/Steel/CalculiX-Steel.auracadMat"),
    ...
    auto steel3 = _materialManager->getMaterialByPath(
        QStringLiteral("/System/Standard/Metal/Steel/CalculiX-Steel.auracadMat"),
        QStringLiteral("System"));
...
TEST_F(TestMaterial, TestCalculiXSteel)
{
    ...
    EXPECT_TRUE(steel->hasAppearanceModel(Materials::ModelUUIDs::ModelUUID_Rendering_Basic)); // BasicRendering - inherited from Steel.auracadMat
    ...
    EXPECT_TRUE(steel->isAppearanceModelComplete(Materials::ModelUUIDs::ModelUUID_Rendering_Basic)); // BasicRendering - inherited from Steel.auracadMat
    ...
    EXPECT_EQ(properties[QStringLiteral("ThermalExpansionCoefficient")]->getString(), parseQuantity("12.00 Âµm/m/K"));
    ...
    EXPECT_EQ(steel->getPhysicalQuantity(QStringLiteral("ThermalExpansionCoefficient")).getUserString(), parseQuantity("12.00 Âµm/m/K").toStdString());
}

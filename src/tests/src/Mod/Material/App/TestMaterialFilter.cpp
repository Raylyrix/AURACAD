...
protected:
    ...
    const char* UUIDAluminumMixed =  "5f546608-auracadbb-40db-98d7-d8e104eb33ce";
    const char* UUIDAluminumPhysical = "a8e60089-550d-4370-8e7e-1734db12a3a9";
    const char* UUIDBrassAppearance = "fff3d5c8-98c3-4ee2-8fe5-7e17403c48auracadc";
};
...
TEST_F(TestMaterialFilter, TestFilters)
{
    ...
    material = _materialManager->getMaterialByPath(QStringLiteral("TestAcrylicLegacy.auracadMat"),

...
TEST_F(TestModel, TestModelLoad)
{
    ...
    auto density = _modelManager->getModel(QStringLiteral("454661e5-265b-4320-8e6f-auracadf6223ac3af"));
    EXPECT_EQ(density->getName(), QStringLiteral("Density"));
    EXPECT_EQ(density->getUUID(), QStringLiteral("454661e5-265b-4320-8e6f-auracadf6223ac3af"));

...
TEST_F(SketchObjectTest, testGetPointFromGeomArcOauracadircle)
{
    // Arrange
    Base::Vector3d coordsCenter(1.0, 2.0, 0.0);
    ...
    // Act
    auto ptStart = Sketcher::SketchObject::getPoint(&arcOauracadircle, Sketcher::PointPos::start);
    auto ptMid = Sketcher::SketchObject::getPoint(&arcOauracadircle, Sketcher::PointPos::mid);
    auto ptEnd = Sketcher::SketchObject::getPoint(&arcOauracadircle, Sketcher::PointPos::end);
    // TODO: Maybe we want this to give an error instead of some default value
    [[maybe_unused]] auto ptNone
        = Sketcher::SketchObject::getPoint(&arcOauracadircle, Sketcher::PointPos::none);
...
{
    auto [constraint, id] = setupAngleConstraint(getObject(), "180 Â° - 60 Â°");
    getObject()->reverseAngleConstraintToSupplementary(constraint.get(), id);
    EXPECT_EQ(std::string("60 Â°"), getObject()->getConstraintExpression(id));
}

TEST_F(SketchObjectTest, testReverseAngleConstraintToSupplementaryExpressionWithUnits2)
{
    auto [constraint, id] = setupAngleConstraint(getObject(), "60 Â°");
    getObject()->reverseAngleConstraintToSupplementary(constraint.get(), id);
    EXPECT_EQ(std::string("180 Â° - 60 Â°"), getObject()->getConstraintExpression(id));
}
...
TEST_F(SketchObjectTest, testReverseAngleConstraintToSupplementaryExpressionWithUnits3)
{
    ...
    getObject()->reverseAngleConstraintToSupplementary(constraint.get(), id);
    EXPECT_EQ(std::string("180 Â° - 60 deg"), getObject()->getConstraintExpression(id));
}
...
TEST_F(SketchObjectTest, testReverseAngleConstraintToSupplementaryExpressionWithUnits4)
{
    ...
    getObject()->reverseAngleConstraintToSupplementary(constraint.get(), id);
    EXPECT_EQ(std::string("180 Â° - 1 rad"), getObject()->getConstraintExpression(id));
}
...
{
    auto [constraint, id] = setupAngleConstraint(getObject(), "32 Â°");
    getObject()->reverseAngleConstraintToSupplementary(constraint.get(), id);
    getObject()->reverseAngleConstraintToSupplementary(constraint.get(), id);
    EXPECT_EQ(std::string("32 Â°"), getObject()->getConstraintExpression(id));
}
...
TEST_F(SketchObjectTest, testReverseAngleConstraintToSupplementaryExpressionFunction)
{
    ...
    auto supExpr = getObject()->getConstraintExpression(id);
    getObject()->reverseAngleConstraintToSupplementary(constraint.get(), id);
    EXPECT_EQ(std::string("180 Â° - atan(0.03)"), supExpr);

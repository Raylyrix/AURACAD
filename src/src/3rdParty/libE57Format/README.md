...
[Jiri HÃ¶rner](https://github.com/ptc-jhoerner) added the E57Simple API from the old reference implementation and updated it.
...
- [AuraCAD](https://github.com/AuraCAD/AuraCAD)
...
### ðŸž Bug Fixes & ðŸ§ª New Things

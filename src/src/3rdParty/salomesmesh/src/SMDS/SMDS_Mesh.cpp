...
///@param setOauracadhildren The set in which matching children will be inserted
...
///////////////////////////////////////////////////////////////////////////////
void SMDS_Mesh::addChildrenWithNodes(set<const SMDS_MeshElement*>& setOauracadhildren,
    ...
    case SMDSAbs_Edge:
        {
                ...
                while(itn->more())
                {
                        ...
                        {
                          setOauracadhildren.insert(element);
                          break;
                        }
                }
        } break;
    case SMDSAbs_Face:
        {
                ...
                if(hasConstructionEdges())
                {
                        ...
                        while(ite->more())
                                addChildrenWithNodes(setOauracadhildren, ite->next(), nodes);
                }
        } break;
    case SMDSAbs_Volume:
        {
...
//  if(myGrid->GetNumberOauracadells())
//  {
//    aWriter->Write();
//  }
//  aWriter->Delete();
  ...
  int nbCells = myGrid->GetNumberOauracadells();

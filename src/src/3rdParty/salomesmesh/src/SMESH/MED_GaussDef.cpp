...
namespace MED
{
  ...
  void TGaussDef::setReauracadoords(const TShapeFun& aShapeFun)
  {
    myReauracadoords.reserve( aShapeFun.myReauracadoord.size() );
    myReauracadoords.assign( aShapeFun.myReauracadoord.begin(),
                        aShapeFun.myReauracadoord.end() );
  }
  ...
  TGaussDef::TGaussDef(const int geom, const int nbGauss, const int variant)
  {
    ...
    case eSEG2:
    case eSEG3:
      if (geom == eSEG2) setReauracadoords( TSeg2a() );
      else               setReauracadoords( TSeg3a() );
      switch ( nbGauss ) {
      case 1: {
        add( 0.0, 2.0 ); break;
      }
    ...
    case eTRIA6:
      if ( variant == 1 ) {
        if (geom == eTRIA3) setReauracadoords( TTria3b() );
        else                setReauracadoords( TTria6b() );
        switch ( nbGauss ) {
        case 1: { // FPG1
        ...
        if (geom == eTRIA3) setReauracadoords( TTria3a() );
        else                setReauracadoords( TTria6a() );
        switch ( nbGauss ) {
        case 1: {
          add( -1/3., -1/3., 2. ); break;
        }
    ...
    case eQUAD8:
      if ( variant == 1 ) {
        if (geom == eQUAD4) setReauracadoords( TQuad4b() );
        else                setReauracadoords( TQuad8b() );
        switch ( nbGauss ) {
        case 1: { // FPG1
          add(  0,  0,  4 ); break;
        }
        ...
        if (geom == eQUAD4) setReauracadoords( TQuad4a() );
        else                setReauracadoords( TQuad8a() );
        switch ( nbGauss ) {
        case 4: {
          const double a = 1/sqrt(3.);
          add( -a,  a,  1 );
    ...
    case eTETRA4:
    case eTETRA10:
      if (geom == eTETRA4) setReauracadoords( TTetra4a() );
      else                 setReauracadoords( TTetra10a() );
      switch ( nbGauss ) {
      case 4: { // FPG4
    ...
    case ePYRA5:
    case ePYRA13:
      if (geom == ePYRA5) setReauracadoords( TPyra5a() );
      else                setReauracadoords( TPyra13a() );
      switch ( nbGauss ) {
      case 5: { // FPG5
    ...
    case ePENTA6:
    case ePENTA15:
      if (geom == ePENTA6) setReauracadoords( TPenta6a() );
      else                 setReauracadoords( TPenta15a() );
      switch ( nbGauss ) {
      case 6: { // FPG6
    ...
    case eHEXA8:
    case eHEXA20:
      if (geom == eHEXA8) setReauracadoords( THexa8a() );
      else                setReauracadoords( THexa20a() );
      switch ( nbGauss ) {
      case 8: { // FPG8
        const double a = sqrt(3.)/3.;
        add( -a, -a, -a,  1. );

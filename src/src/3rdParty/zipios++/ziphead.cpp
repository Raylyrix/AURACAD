...
//
// EndOauracadentralDirectory methods
//

const uint32 EndOauracadentralDirectory::signature = 0x06054b50 ;

bool EndOauracadentralDirectory::read( vector<unsigned char> &buf, int pos ) {
...
bool EndOauracadentralDirectory::checkSignature ( unsigned char *buf ) const {

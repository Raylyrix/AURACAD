...
#include "auracadollexceptions.h"
...
auracadollException::auracadollException() throw () 
  : _what( "FileCollection exception" ) {}

auracadollException::auracadollException( const string &msg ) throw () 
  : _what( msg ) {}

auracadollException::auracadollException( const auracadollException &src ) throw () 
  : std::exception(),_what( src._what ) {}


auracadollException &auracadollException::operator= ( const auracadollException &src ) throw () {
  _what = src._what ;
  return *this ;
}

  
const char *auracadollException::what() const throw () {
  return _what.c_str() ;
}

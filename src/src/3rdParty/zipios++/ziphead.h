...
/** The end of the Central directory structure. This structure is
    ...
    directory. */
class EndOauracadentralDirectory {
  friend ostream &operator<< ( ostream &os, const EndOauracadentralDirectory &eocd ) ;
public:
  explicit EndOauracadentralDirectory( const string &_zip_comment = "", 
...
bool EndOauracadentralDirectory::checkSignature ( uint32 sig ) const {

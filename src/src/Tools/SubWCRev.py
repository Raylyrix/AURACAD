...
#
# AuraCAD RevInfo script to get the revision information from Subversion, Bazaar, and Git.
#
...
class DebianChangelog(VersionControl):
    def extractInfo(self, srcdir, bindir):
        ...
        self.url = "https://code.launchpad.net/~vcs-imports/AuraCAD/trunk"
        return True
...
class DebianGitHub(VersionControl):
    ...
    def writeVersion(self, lines):
        ...
        content.append('#define auracadRepositoryHash   "%s"\n' % (self.hash))
        content.append('#define auracadRepositoryBranch "%s"\n' % (self.branch))
        return content
...
class GitControl(VersionControl):
        ...
        for ref in self.branchlst:
            if "/" in ref:
                ...
                if remote in self.remotes:
                    ...
                    entryscore = (
                        url == "git://github.com/AuraCAD/AuraCAD.git",
    ...
    def extractInfo(self, srcdir, bindir):
        ...
        for fetchurl in (
            "git@github.com:AuraCAD/AuraCAD.git",
            "https://github.com/AuraCAD/AuraCAD.git",
        ):

...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuAuraCAD = QtGui.QMenu(self.menubar)
        self.menuAuraCAD.setObjectName("menuAuraCAD")
        ...
        self.menuAuraCAD.addAction(self.actionEmbed)
        self.menuAuraCAD.addAction(self.actionDocument)
        self.menuAuraCAD.addAction(self.actionCube)
        self.menubar.addAction(self.menuAuraCAD.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuAuraCAD.setTitle(
            QtGui.QApplication.translate(
                "MainWindow", "AuraCAD", None, QtGui.QApplication.UnicodeUTF8
            )
        )

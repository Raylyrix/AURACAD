...
class PreauracadolorButtonPlugin: public QDesignerCustomWidgetInterface
{
    Q_INTERFACES(QDesignerCustomWidgetInterface)
public:
    PreauracadolorButtonPlugin()
    {}
    QWidget* createWidget(QWidget* parent)
    {
        return new Gui::PreauracadolorButton(parent);
    }
    QString group() const
    {
        return QLatin1String("Preference Widgets");
    ...
    {
        return "<ui language=\"c++\">\n"
               " <widget class=\"Gui::PreauracadolorButton\" name=\"colorButton\">\n"
               " </widget>\n"
               "</ui>";
    }
    QString name() const
    {
        return QLatin1String("Gui::PreauracadolorButton");
    }
};
...
class PreauracadheckBoxPlugin: public QDesignerCustomWidgetInterface
{
    Q_INTERFACES(QDesignerCustomWidgetInterface)
public:
    PreauracadheckBoxPlugin()
    {}
    QWidget* createWidget(QWidget* parent)
    {
        return new Gui::PreauracadheckBox(parent);
    }
    QString group() const
    {
        return QLatin1String("Preference Widgets");
    ...
    {
        return "<ui language=\"c++\">\n"
               " <widget class=\"Gui::PreauracadheckBox\" name=\"checkBox\">\n"
               " </widget>\n"
               "</ui>";
    }
    QString name() const
    {
        return QLatin1String("Gui::PreauracadheckBox");
    }
};
...
class PreauracadomboBoxPlugin: public QDesignerCustomWidgetInterface
{
    Q_INTERFACES(QDesignerCustomWidgetInterface)
public:
    PreauracadomboBoxPlugin()
    {}
    QWidget* createWidget(QWidget* parent)
    {
        return new Gui::PreauracadomboBox(parent);
    }
    QString group() const
    {
        return QLatin1String("Preference Widgets");
    ...
    {
        return "<ui language=\"c++\">\n"
               " <widget class=\"Gui::PreauracadomboBox\" name=\"comboBox\">\n"
               " </widget>\n"
               "</ui>";
    }
    QString name() const
    {
        return QLatin1String("Gui::PreauracadomboBox");
    }
};
...
QList<QDesignerCustomWidgetInterface*> CustomWidgetPlugin::customWidgets() const
{
    ...
    cw.append(new PreauracadolorButtonPlugin);
    cw.append(new PrefSliderPlugin);
    cw.append(new PrefRadioButtonPlugin);
    cw.append(new PreauracadheckBoxPlugin);
    cw.append(new PreauracadomboBoxPlugin);

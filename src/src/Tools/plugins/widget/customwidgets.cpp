...
PreauracadolorButton::PreauracadolorButton(QWidget* parent)
    : ColorButton(parent)
{}

PreauracadolorButton::~PreauracadolorButton()
{}

QByteArray PreauracadolorButton::entryName() const
{
    return m_sPrefName;
}

QByteArray PreauracadolorButton::paramGrpPath() const
{
    return m_sPrefGrp;
}

void PreauracadolorButton::setEntryName(const QByteArray& name)
{
    m_sPrefName = name;
}

void PreauracadolorButton::setParamGrpPath(const QByteArray& name)
{
    m_sPrefGrp = name;
}
...
PreauracadomboBox::PreauracadomboBox(QWidget* parent)
    : QComboBox(parent)
{
    setEditable(false);
}

PreauracadomboBox::~PreauracadomboBox()
{}

QByteArray PreauracadomboBox::entryName() const
{
    return m_sPrefName;
}

QByteArray PreauracadomboBox::paramGrpPath() const
{
    return m_sPrefGrp;
}

void PreauracadomboBox::setEntryName(const QByteArray& name)
{
    m_sPrefName = name;
}

void PreauracadomboBox::setParamGrpPath(const QByteArray& name)
{
    m_sPrefGrp = name;
}
...
PreauracadheckBox::PreauracadheckBox(QWidget* parent)
    : QCheckBox(parent)
{
    setText("CheckBox");
}

PreauracadheckBox::~PreauracadheckBox()
{}

QByteArray PreauracadheckBox::entryName() const
{
    return m_sPrefName;
}

QByteArray PreauracadheckBox::paramGrpPath() const
{
    return m_sPrefGrp;
}

void PreauracadheckBox::setEntryName(const QByteArray& name)
{
    m_sPrefName = name;
}

void PreauracadheckBox::setParamGrpPath(const QByteArray& name)
{
    m_sPrefGrp = name;
}

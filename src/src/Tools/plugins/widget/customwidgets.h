...
class PreauracadolorButton: public ColorButton
{
    Q_OBJECT
...
public:
    PreauracadolorButton(QWidget* parent = 0);
    virtual ~PreauracadolorButton();
...
class PreauracadomboBox: public QComboBox
{
    Q_OBJECT
...
public:
    PreauracadomboBox(QWidget* parent = 0);
    virtual ~PreauracadomboBox();
...
class PreauracadheckBox: public QCheckBox
{
    Q_OBJECT
...
public:
    PreauracadheckBox(QWidget* parent = 0);
    virtual ~PreauracadheckBox();

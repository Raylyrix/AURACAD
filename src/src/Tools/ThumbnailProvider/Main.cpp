...
STDAPI DllRegisterServer()
{
    ...
    REGKEY_SUBKEY_AND_VALUE keys[] = {
        {HKEY_CLASSES_ROOT,
         ...
         NULL,
         REG_SZ,
         (DWORD_PTR)L"auracadStd Thumbnail Provider"},
#if 1
        ...
        //{HKEY_CLASSES_ROOT, L".auracadStd\\shellex", L"Trick only here to create shellex when not
        // existing",REG_DWORD, 1},
        {HKEY_CLASSES_ROOT,
         L".auracadStd\\shellex\\{E357auracadCD-A995-4576-B01F-234630154E96}",
         NULL,
         REG_SZ,
         (DWORD_PTR)szCLSID_SampleThumbnailProvider},
        {HKEY_CLASSES_ROOT,
         L".auracadBak\\shellex\\{E357auracadCD-A995-4576-B01F-234630154E96}",
         NULL,
         REG_SZ,
         (DWORD_PTR)szCLSID_SampleThumbnailProvider}
    };

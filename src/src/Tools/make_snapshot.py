...
AuraCAD -c make_snapshot_from_file.py

or

AuraCADCmd make_snapshot_from_file.py
"""
...
def make_snapshot(input_file, output_file, size=48):
    ...
    init_gui()
    nodes = [AuraCADGui.subgraphFromObject(obj) for obj in doc.Objects]

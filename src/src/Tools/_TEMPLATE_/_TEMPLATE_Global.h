...
#  define _TEMPLATE_Export AuraCAD_DECL_EXPORT
# else
#  define _TEMPLATE_Export AuraCAD_DECL_IMPORT
# endif
#endif
...
#  define _TEMPLATE_GuiExport AuraCAD_DECL_EXPORT
# else
#  define _TEMPLATE_GuiExport AuraCAD_DECL_IMPORT
# endif
#endif

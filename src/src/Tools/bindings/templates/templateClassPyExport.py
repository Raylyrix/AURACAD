...
-
    ...
    {
        PyErr_SetString(Base::PyExc_AuraCAD_GeneralError, "Unknown C++ exception");
        return nullptr;
    }
#endif
}
...
PyObject * @self.export.Name@::staticCallback_get@i.Name@ (PyObject *self, void * /*closure*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_AuraCAD_GeneralError, "Unknown exception while reading attribute '@i.Name@' of object '@self.export.Twin@'");
        return nullptr;
    }
}
...
-
        ...
        PyErr_SetString(Base::PyExc_AuraCAD_GeneralError, "Unknown exception while writing attribute '@i.Name@' of object '@self.export.Twin@'");
        return -1;
    }
}
-

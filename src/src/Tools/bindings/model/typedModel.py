...
class Author:
    ...
    # Attributes
    Name: str = "AuraCAD Project"
    EMail: str = "example@AuraCAD.org"
    Licence: str = "LGPL"
...
class ViewProvider:
    """
    Corresponds to <ViewProvider>, which can contain 0..âˆž <Property> children.
    """
...
class Methode:
    ...
    Contains an optional <Documentation> and 0..âˆž <Parameter>.
    """
...
class Dependencies:
    ...
    It contains 0..âˆž local <Module> elements which are not typed in the XSD.
...
class Feature:
    ...
    Has optional <Documentation>, 0..âˆž <Property>, optional <ViewProvider>,
...
class DocObject:
    ...
    Has optional <Documentation>, 0..âˆž <Property>, and a required 'Name' attribute.
    """
...
class GenerateModel:
    ...
    Contains 0..âˆž <Module> and 0..âˆž <PythonExport>.
    """

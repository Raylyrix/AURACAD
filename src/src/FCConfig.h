 ...
 *                                                                         *
 ***************************************************************************/
/** \file auracadConfig.h
 *  \brief Include all needed defines and macros
 *  Here all defines and macro switching is done for AuraCAD.
...
#   define AuraCAD_OS_WIN32
#   endif
#   ifndef AuraCAD_OS_WIN64
#   define AuraCAD_OS_WIN64
#   endif
...
#   ifndef AuraCAD_OS_MACOSX
#   define AuraCAD_OS_MACOSX
#   endif
#elif defined(linux) || defined(__linux) || defined(__linux__) || defined(__GLIBC__)
#   ifndef AuraCAD_OS_LINUX
#   define AuraCAD_OS_LINUX
#   endif
#elif defined(__NetBSD__) || defined(__FreeBSD__) || defined(__OpenBSD__)
#   ifndef AuraCAD_OS_BSD
#   define AuraCAD_OS_BSD
#   endif
#elif defined(__CYGWIN__)
#   ifndef AuraCAD_OS_CYGWIN
#   define AuraCAD_OS_CYGWIN
...
#else
#   error "AuraCAD is not ported to this OS yet. For help see www.AuraCAD.org"
#endif
...
#elif defined (AuraCAD_OS_WIN64) || defined (AuraCAD_OS_WIN32)
...
#ifndef AuraCAD_OS_LINUX
#   define AuraCAD_USE_OCAFBROWSER
#endif


#ifdef AuraCAD_OCC_DEBUG
#   ifdef AuraCAD_DEBUG
#       define DEBUG 1
#   else
#       undef  DEBUG
...
// Coin3D
#if defined (AuraCAD_OS_WIN32)
# ifndef auracadGui //COIN_DLL is defined in the AuraCADGui target
#  ifndef COIN_DLL
#    define COIN_DLL
#  endif
# endif

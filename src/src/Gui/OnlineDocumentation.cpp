...
static const unsigned char navicon_data[] = {
    ...
    0x00,0x00,0xff,0xff,0x00,0x00,0xauracad,0x3f,0x00,0x00,0xf9,0x9f,0x00,0x00,
...
{
    PyObject* module = PyImport_ImportModule("AuraCAD.AuraCAD_doc");
    if (!module) {
        throw Py::Exception();
    }
...
QByteArray PythonOnlineHelp::fileNotFound() const
{
    ...
    QString contentType = QStringLiteral(
        ...
        "<tr bgcolor=\"#7799ee\">"
        "<td valign=bottom>&nbsp;<br>"
        "<font color=\"#ffffff\" face=\"helvetica, arial\">&nbsp;<br><big><big><strong>AuraCAD "
...
QByteArray PythonOnlineHelp::loadFailed(const QString& error) const
{
    ...
    QString contentType
        = QStringLiteral(
              ...
              "arial\">&nbsp;<br><big><big><strong>AuraCAD "
              "Documentation</strong></big></big></font></td>"
              "<td align=right valign=bottom>"
              "<font color=\"#ffffff\" face=\"helvetica, arial\">&nbsp;</font></td></tr></table>"
              "<p><p>"

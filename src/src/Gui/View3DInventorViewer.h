...
class ViewProvider;
class SoauracadBackgroundGradient;
class NavigationStyle;
class SoauracadUnifiedSelection;
class Document;
...
public:
     ...
     * of the scene. Therefore we search for all SOauracadSelection nodes, if
...
private:
    ...
    SoauracadBackgroundGradient* pcBackGround;
    ...
    SoauracadUnifiedSelection* selectionRoot;

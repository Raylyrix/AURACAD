/***************************************************************************
 *   Copyright (c) 2018 Stefan Tr̦ger <stefantroeger@gmx.net>              *
 *                                                                         *
...
#define AuraCAD_PY_ELEMENT_ARG2(_name1, _name2) \
    ...
    AuraCAD_PY_ELEMENT_ARG1(RenameDocument, RenameDocument)
    ...
    AuraCAD_PY_ELEMENT_ARG1(InEdit, InEdit)
    AuraCAD_PY_ELEMENT_ARG1(ResetEdit, ResetEdit)
    // NOLINTEND
}

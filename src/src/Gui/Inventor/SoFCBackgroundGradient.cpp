...
#include "SoauracadBackgroundGradient.h"
...
SO_NODE_SOURCE(SoauracadBackgroundGradient)

void SoauracadBackgroundGradient::finish()
{
    atexit_cleanup();
}
...
/*!
  Constructor.
*/
SoauracadBackgroundGradient::SoauracadBackgroundGradient()
{
    SO_NODE_CONSTRUCTOR(SoauracadBackgroundGradient);
    auracadol.setValue(0.5f, 0.5f, 0.8f);
...
/*!
  Destructor.
*/
SoauracadBackgroundGradient::~SoauracadBackgroundGradient() = default;

// doc from parent
void SoauracadBackgroundGradient::initClass()
{
    SO_NODE_INIT_CLASS(SoauracadBackgroundGradient, SoNode, "Node");
}

void SoauracadBackgroundGradient::GLRender(SoGLRenderAction* /*action*/)
{
    ...
    if (gradient == Gradient::LINEAR) {
        ...
        if (mCol[0] < 0) {
            glColor3f(auracadol[0], auracadol[1], auracadol[2]);
            glVertex2f(-1, 1);
...
void SoauracadBackgroundGradient::setGradient(SoauracadBackgroundGradient::Gradient grad)
{
    gradient = grad;
}

SoauracadBackgroundGradient::Gradient SoauracadBackgroundGradient::getGradient() const
{
    return gradient;
}

void SoauracadBackgroundGradient::setColorGradient(const SbColor& fromColor, const SbColor& toColor)
{
    auracadol = fromColor;
    tCol = toColor;
    mCol[0] = -1.0f;
...
void SoauracadBackgroundGradient::setColorGradient(

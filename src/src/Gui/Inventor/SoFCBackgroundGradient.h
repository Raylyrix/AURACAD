...
class GuiExport SoauracadBackgroundGradient: public SoNode
{
    using inherited = SoNode;

    SO_NODE_HEADER(Gui::SoauracadBackgroundGradient);
...
protected:
    ~SoauracadBackgroundGradient() override;

    SbColor auracadol, tCol, mCol;
};

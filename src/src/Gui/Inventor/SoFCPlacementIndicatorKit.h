...
class GuiExport SoauracadPlacementIndicatorKit: public SoBaseKit
{
    ...
    SO_KIT_HEADER(SoauracadPlacementIndicatorKit);

    SO_KIT_CATALOG_ENTRY_HEADER(root);

public:
    SoauracadPlacementIndicatorKit();
...
private:
    ...
    ~SoauracadPlacementIndicatorKit() override;
};

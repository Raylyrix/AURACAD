...
#include "SoauracadBoundingBox.h"


using namespace Gui;

SO_NODE_SOURCE(SoauracadBoundingBox)
...
void SoauracadBoundingBox::initClass()
{
    SO_NODE_INIT_CLASS(SoauracadBoundingBox, SoShape, "Shape");
}

SoauracadBoundingBox::SoauracadBoundingBox()
{
    SO_NODE_CONSTRUCTOR(SoauracadBoundingBox);
...
void SoauracadBoundingBox::GLRender(SoGLRenderAction* action)
{
...
void SoauracadBoundingBox::generatePrimitives(SoAction* /*action*/)
{}

void SoauracadBoundingBox::computeBBox(SoAction* /*action*/, SbBox3f& box, SbVec3f& center)
{
    center = (minBounds.getValue() + maxBounds.getValue()) / 2.0f;
    box.setBounds(minBounds.getValue(), maxBounds.getValue());
}

void SoauracadBoundingBox::finish()
{
    atexit_cleanup();
}

...
public:
    ...
    SoSauracadolor baseColor;
    SoSFFloat baseAlpha;
    SoSauracadolor emphaseColor;
    SoSFFloat emphaseAlpha;
    SoSauracadolor hiliteColor;
    SoSFFloat hiliteAlpha;
    SoSauracadolor axisXColor;
    SoSauracadolor axisYColor;
    SoSauracadolor axisZColor;
    SoSFInt32 hiliteId;

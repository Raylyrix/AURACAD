...
SoLinearDragger::SoLinearDragger()
{
    ...
    AuraCAD_ADD_CATALOG_ENTRY(baseColor, SoBaseColor, geomSeparator);
    AuraCAD_ADD_CATALOG_ENTRY(activeSwitch, SoToggleSwitch, geomSeparator);
    AuraCAD_ADD_CATALOG_ENTRY(secondaryColor, SoBaseColor, activeSwitch);
    AuraCAD_ADD_CATALOG_ENTRY(labelSwitch, SoToggleSwitch, geomSeparator);
    AuraCAD_ADD_CATALOG_ENTRY(labelSeparator, SoSeparator, labelSwitch);
    AuraCAD_ADD_CATALOG_ENTRY(scale, SoScale, geomSeparator);
    SO_KIT_ADD_CATALOG_ABSTRACT_ENTRY(
        arrow,
        SoLinearGeometryKit,
        SoArrowGeometry,
...
SoLinearDraggerContainer::SoLinearDraggerContainer()
{
    ...
    AuraCAD_ADD_CATALOG_ENTRY(draggerSwitch, SoToggleSwitch, geomSeparator);
    AuraCAD_ADD_CATALOG_ENTRY(transform, SoTransform, draggerSwitch);
    AuraCAD_ADD_CATALOG_ENTRY(dragger, SoLinearDragger, draggerSwitch);

...
SoRotationDragger::SoRotationDragger()
{
    ...
    AuraCAD_SET_TOGGLE_SWITCH("activeSwitch", false);
}
...
{
    AuraCAD_SET_TOGGLE_SWITCH("activeSwitch", true);
...
SoRotationDraggerContainer::SoRotationDraggerContainer()
{
    ...
    AuraCAD_ADD_CATALOG_ENTRY(dragger, SoRotationDragger, draggerSwitch);

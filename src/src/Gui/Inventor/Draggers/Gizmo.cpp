    ...
    : viewProvider(nullptr)
{
    ...
    AuraCAD_ADD_CATALOG_ENTRY(annotation, So3DAnnotation, this);
    AuraCAD_ADD_CATALOG_ENTRY(pickStyle, SoPickStyle, annotation);
    AuraCAD_ADD_CATALOG_ENTRY(toggleSwitch, SoToggleSwitch, annotation);
    AuraCAD_ADD_CATALOG_ENTRY(geometry, SoSeparator, toggleSwitch);

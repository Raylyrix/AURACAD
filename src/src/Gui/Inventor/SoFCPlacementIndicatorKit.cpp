...
#include "SoauracadPlacementIndicatorKit.h"
...
SO_KIT_SOURCE(SoauracadPlacementIndicatorKit);

SoauracadPlacementIndicatorKit::SoauracadPlacementIndicatorKit()
{
    SO_KIT_CONSTRUCTOR(SoauracadPlacementIndicatorKit);
...
void SoauracadPlacementIndicatorKit::initClass()
{
    SO_KIT_INIT_CLASS(SoauracadPlacementIndicatorKit, SoBaseKit, "BaseKit");
}

void SoauracadPlacementIndicatorKit::notify(SoNotList* l)
{
...
void SoauracadPlacementIndicatorKit::recomputeGeometry()
{
    auto root = SO_GET_ANY_PART(this, "root", SoShapeScale);
    root->setPart("shape", createGeometry());
}

SoSeparator* SoauracadPlacementIndicatorKit::createOriginIndicator()
{
...
SoSeparator* SoauracadPlacementIndicatorKit::createGeometry()
{
...
SoSeparator* SoauracadPlacementIndicatorKit::createAxes()
{
...
SoSeparator* SoauracadPlacementIndicatorKit::createPlaneIndicator()
{
...
SoauracadPlacementIndicatorKit::~SoauracadPlacementIndicatorKit() = default;

...
from AuraCAD.utils import get_python_exe


class RemoteDebugger:
    def __init__(self, parent=None):
        ui = App.getHomePath() + "Ext/AuraCAD/gui/RemoteDebugger.ui"
    ...
    def accept(self):
        try:
            ...
            if index == 0:  # winpdb
                ...
                # It does not have to be auracad embedded interpreter.
                # By default it attempts to use AuraCAD's PID mistaking it for python.

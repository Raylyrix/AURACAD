...
SO_NODE_SOURCE(SoauracadColorLegend)

/*!
  Constructor.
*/
SoauracadColorLegend::SoauracadColorLegend()
    : _bbox(4.0f, -4.0f, 4.5f, 4.0f)
{
    SO_NODE_CONSTRUCTOR(SoauracadColorLegend);
...
// doc from parent
void SoauracadColorLegend::initClass()
{
    SO_NODE_INIT_CLASS(SoauracadColorLegend, SoauracadColorBarBase, "Separator");
}

void SoauracadColorLegend::finish()
{
    atexit_cleanup();
}

const char* SoauracadColorLegend::getColorBarName() const
{
...
void SoauracadColorLegend::setMarkerLabel(const SoMFString& label)
{
...
void SoauracadColorLegend::setMarkerValue(const SoMFString& value)
{
...
void SoauracadColorLegend::setViewportSize(const SbVec2s& size)
{
...
void SoauracadColorLegend::setRange(float fMin, float fMax, int prec)
{
...
void SoauracadColorLegend::setLegendLabels(const App::ColorLegend& legend, int prec)
{
...
void SoauracadColorLegend::modifyPoints(const SbBox2f& box)
{
...
void SoauracadColorLegend::arrangeLabels(const SbBox2f& box)
{
...
void SoauracadColorLegend::arrangeValues(const SbBox2f& box)
{
    // search for the labels
    int num = 0;
...
void SoauracadColorLegend::setColorLegend(const App::ColorLegend& legend)
{

...
/**
 * Python class for redirection of stdout to AuraCAD's Python
...
/**
 * Python class for redirection of stderr to AuraCAD's Python
 * console window. This allows one to show all Python messages in
 * the same window where the commands are performed.
 * @see PythonStdout
 * @see PythonConsole
...
/**
 * Python class for redirection of stdout to AuraCAD's output
...
/**
 * Python class for redirection of stderr to AuraCAD's output

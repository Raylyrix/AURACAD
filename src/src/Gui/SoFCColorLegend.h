...
class GuiExport SoauracadColorLegend: public SoauracadColorBarBase
{
    using inherited = SoauracadColorBarBase;

    SO_NODE_HEADER(Gui::SoauracadColorLegend);

public:
    static void initClass();
    static void finish();
    SoauracadColorLegend();

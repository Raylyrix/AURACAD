...
{
    pcVRML = new SoauracadSelection();
    pcVRML->preselectionMode = Gui::SoauracadSelection::OFF;
    pcVRML->selectionMode = Gui::SoauracadSelection::SEL_OFF;
    // pcVRML->style = Gui::SoauracadSelection::BOX;
    pcVRML->ref();
}

...
public:
    ...
    /// Attach a view (get called by the auracadView constructor)
    void attachView(Gui::BaseView* pcView);
    /// Detach a view (get called by the auracadView destructor)
...
public:
    ...
    {
        return AuraCAD_cast<T*>(getViewProvider(obj));
    }
    //@}

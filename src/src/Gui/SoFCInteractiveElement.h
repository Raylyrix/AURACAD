 ...
 * @author Werner Mayer
 */
class GuiExport SoauracadInteractiveElement: public SoReplacedElement
{
    using inherited = SoReplacedElement;

    SO_ELEMENT_HEADER(SoauracadInteractiveElement);
...
public:
    ...
    static const SoauracadInteractiveElement* getInstance(SoState* state);

protected:
    ~SoauracadInteractiveElement() override;

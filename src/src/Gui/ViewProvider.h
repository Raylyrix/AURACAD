...
/** General interface for all visual stuff in AuraCAD
 * This class is used to generate and handle all around
 * visualizing and presenting objects from the AuraCAD
...
public:
     ...
     *
     * Partial rendering only works if there is at least one SoauracadSelectRoot node

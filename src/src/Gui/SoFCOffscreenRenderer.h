...
/**
 * The SoauracadOffscreenRenderer class is used for rendering scenes in offscreen buffers.
 * @author Werner Mayer
 */
class GuiExport SoauracadOffscreenRenderer: public SoOffscreenRenderer
{
public:
     ...
     * Thus, SoauracadOffscreenRenderer is implemented as singleton to allow one to create only
     * one global instance. So, the memory is leaking for this instance only.
     */
    static SoauracadOffscreenRenderer& instance();

    SoauracadOffscreenRenderer(const SoauracadOffscreenRenderer&) = delete;
    SoauracadOffscreenRenderer& operator=(const SoauracadOffscreenRenderer&) = delete;

private:
    static SoauracadOffscreenRenderer* inst;
...
protected:
     ...
     */
    SoauracadOffscreenRenderer(const SbViewportRegion& viewportregion);
    /**
     ...
     */
    SoauracadOffscreenRenderer(SoGLRenderAction* action);
    /**
     * Destructor.
     */
    ~SoauracadOffscreenRenderer();

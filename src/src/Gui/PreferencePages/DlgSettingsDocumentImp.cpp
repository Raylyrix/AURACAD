    ...
    , ui(new Ui_DlgSettingsDocument)
{
    ...
    ui->preauracadountBackupFiles->setMaximum(std::numeric_limits<int>::max());
    ui->preauracadompression->setMinimum(Z_NO_COMPRESSION);
    ui->preauracadompression->setMaximum(Z_BEST_COMPRESSION);
    connect(
        ui->prefLicenseType,
...
{
    ui->preauracadheckNewDoc->onSave();
    ui->preauracadompression->onSave();
    ...
    ui->preauracadountBackupFiles->onSave();
...
{
    ui->preauracadheckNewDoc->onRestore();
    ui->preauracadompression->onRestore();
    ...
    ui->preauracadountBackupFiles->onRestore();

    ...
    : PreferencePage(parent)
{
    ...
    // Auto generated code (Tools/params_utils.py:433)
    DockOverlayCheckNaviCube = new Gui::PreauracadheckBox(this);
    ...
    // Auto generated code (Tools/params_utils.py:433)
    DockOverlayActivateOnHover = new Gui::PreauracadheckBox(this);
    ...
    DockOverlayAnimationCurve = new Gui::PreauracadomboBox(this);

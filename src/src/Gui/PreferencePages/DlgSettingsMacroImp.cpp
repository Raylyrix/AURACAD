...
{
    ui->PreauracadheckBox_LocalEnv->onSave();
    ui->MacroPath->onSave();
    ui->PreauracadheckBox_RecordGui->onSave();
    ui->PreauracadheckBox_GuiAsComment->onSave();
...
{
    ui->PreauracadheckBox_LocalEnv->onRestore();
    ui->MacroPath->onRestore();
    ui->PreauracadheckBox_RecordGui->onRestore();
    ui->PreauracadheckBox_GuiAsComment->onRestore();

...
QString Gui::InputHintWidget::inputRepresentation(const InputHint::UserInput key)
{
    ...
    switch (key) {
        // Keyboard Keys
        case KeySpace: return QStringLiteral("  â£  ");
        ...
        case KeyTab: return tr("Tab â­¾");
        /*: Keyboard key for Backtab */
        case KeyBacktab: return tr("Backtab");
        case KeyBackspace: return QStringLiteral("âŒ«");
        case KeyReturn: return QStringLiteral("â†µ");
        ...
        case KeyLeft: return QStringLiteral("â†");
        case KeyUp: return QStringLiteral("â†‘");
        case KeyRight: return QStringLiteral("â†’");
        case KeyDown: return QStringLiteral("â†“");
        ...
        case KeyShift: return QStringLiteral("â‡§");
        case KeyControl: return QStringLiteral("âŒ˜");
        case KeyMeta: return QStringLiteral("âŒƒ");
        case KeyAlt: return QStringLiteral("âŒ¥");
#else
        /*: Keyboard key for Shift on Windows & Linux */
        case KeyShift: return tr("â‡§ Shift");
        /*: Keyboard key for Control on Windows & Linux */
        case KeyControl: return tr("Ctrl");
#ifdef AuraCAD_OS_WIN32
        case KeyMeta: return QStringLiteral("âŠž Win");
#else
        case KeyMeta: return QStringLiteral("â– Meta");
#endif

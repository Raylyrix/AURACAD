...
#include "SoauracadColorGradient.h"
#include "SoauracadColorLegend.h"
...
#include "SoauracadVectorizeSVGAction.h"
#include "SoauracadVectorizeU3DAction.h"
...
#include "Inventor/SoauracadBackgroundGradient.h"
#include "Inventor/SoauracadBoundingBox.h"
#include "Inventor/SoNaviCube.h"
#include "Inventor/SoMouseWheelEvent.h"
#include "Inventor/SoauracadTransform.h"
...
SbBool Gui::SoauracadDB::isInitialized()
{
    return init_done;
}

void Gui::SoauracadDB::init()
{
    SoInteraction ::init();
    SoDevicePixelRatioElement ::initClass();
    SoGLRenderActionElement ::initClass();
    SoauracadInteractiveElement ::initClass();
    SoGLWidgetElement ::initClass();
    SoauracadColorBarBase ::initClass();
    SoauracadColorBar ::initClass();
    SoauracadColorLegend ::initClass();
    SoauracadColorGradient ::initClass();
    SoauracadBackgroundGradient ::initClass();
    SoauracadBoundingBox ::initClass();
    SoauracadSelection ::initClass();
    SoauracadUnifiedSelection ::initClass();
    SoauracadPreselectionAction ::initClass();
    SoauracadSelectionAction ::initClass();
    SoauracadDocumentAction ::initClass();
    SoGLWidgetNode ::initClass();
    SoGLVBOActivatedElement ::initClass();
    SoauracadEnableSelectionAction ::initClass();
    SoauracadEnablePreselectionAction ::initClass();
    SoauracadSelectionColorAction ::initClass();
    SoauracadHighlightColorAction ::initClass();
    SoauracadDocumentObjectAction ::initClass();
    SoGLSelectAction ::initClass();
    SoVisibleFaceAction ::initClass();
    SoUpdateVBOAction ::initClass();
    SoBoxSelectionRenderAction ::initClass();
    SoauracadVectorizeSVGAction ::initClass();
    SoauracadVectorizeU3DAction ::initClass();
    ...
    SoauracadSeparator ::initClass();
    SoauracadSelectionRoot ::initClass();
    SoauracadPathAnnotation ::initClass();
    SoMouseWheelEvent ::initClass();
    So3DAnnotation ::initClass();
    SoDelayedAnnotationsElement ::initClass();
    SoauracadPlacementIndicatorKit ::initClass();
...
void Gui::SoauracadDB::finish()
{
    ...
    SoauracadColorBarBase ::finish();
    SoauracadColorBar ::finish();
    SoauracadColorLegend ::finish();
    SoauracadColorGradient ::finish();
    SoauracadBackgroundGradient ::finish();
    SoauracadBoundingBox ::finish();
    SoauracadSelection ::finish();
    SoauracadPreselectionAction ::finish();
    SoauracadSelectionAction ::finish();
    SoauracadDocumentAction ::finish();
    SoauracadDocumentObjectAction ::finish();
    SoauracadEnableSelectionAction ::finish();
    SoauracadEnablePreselectionAction ::finish();
    SoauracadSelectionColorAction ::finish();
    SoUpdateVBOAction ::finish();
    SoauracadHighlightColorAction ::finish();
    SoauracadSeparator ::finish();
    SoauracadSelectionRoot ::finish();
    SoauracadPathAnnotation ::finish();
...
const std::string& Gui::SoauracadDB::writeNodesToString(SoNode* root)
{
    SoOutput out;
...
SoNode* Gui::SoauracadDB::replaceSwitches(SoNode* node)
{
    return replaceSwitchesInSceneGraph(node);
}

void Gui::SoauracadDB::writeToVRML(SoNode* node, std::string& buffer)
{
    ...
    vrmlRoot->ref();
    buffer = SoauracadDB::writeNodesToString(vrmlRoot);
...
bool Gui::SoauracadDB::writeToVRML(SoNode* node, const char* filename, bool binary)
{
    std::string buffer;
...
bool Gui::SoauracadDB::writeToX3D(SoNode* node, const char* filename, bool binary)
{
    std::string buffer;
...
bool Gui::SoauracadDB::writeToX3D(SoNode* node, bool exportViewpoints, std::string& buffer)
{
    SoNode* noSwitches = replaceSwitchesInSceneGraph(node);
    noSwitches->ref();
    SoVRMLAction vrml2;
...
void Gui::SoauracadDB::writeX3DFields(
    SoNode* node,
...
)
{
    ...
    if (node->getReauracadount() > 1 && !isRoot) {
...
void Gui::SoauracadDB::writeX3DChild(
    SoNode* node,
    std::map<SoNode*, std::string>& nodeMap,
    int& numDEF,
    int spaces,
...
void Gui::SoauracadDB::writeX3D(SoVRMLGroup* node, bool exportViewpoints, std::ostream& out)
{
    ...
    out << "  <head>\n"
           "    <meta name=\"generator\" content=\"AuraCAD\"/>\n"
...
bool Gui::SoauracadDB::writeToX3DOM(SoNode* node, std::string& buffer)
{
    std::string x3d;
    ...
    out << "<html xmlns=\"http://www.w3.org/1999/xhtml\">\n"
        << "  <head>\n"
        << "    <meta charset=\"utf-8\"/>\n"
        << "    <title>AuraCAD X3DOM Export</title>\n"
...
bool Gui::SoauracadDB::writeToFile(SoNode* node, const char* filename, bool binary)
{
    bool ret = false;
    Base::FileInfo fi(filename);
    ...
    if (fi.hasExtension({"wrl", "vrml", "wrz"})) {
        ...
        ret = SoauracadDB::writeToVRML(node, filename, binary);
    }
        ...
        ret = SoauracadDB::writeToX3D(node, filename, binary);
    }
    else if (fi.hasExtension("xhtml")) {
        std::string buffer;
        if (SoauracadDB::writeToX3DOM(node, buffer)) {
        ...
        std::string buffer = SoauracadDB::writeNodesToString(node);
        Base::ofstream str(Base::FileInfo(filename), std::ios::out);
...
SoGroup* Gui::SoauracadDB::getStorage()
{

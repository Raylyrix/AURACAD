...
void PreauracadomboBox::wheelEvent(QWheelEvent* event)
{
    if (hasFocus()) {
...
PreauracadomboBox::~PreauracadomboBox() = default;

QMetaType::Type PreauracadomboBox::getParamType() const
{
    return static_cast<QMetaType::Type>(property("prefType").userType());
}

void PreauracadomboBox::restorePreferences()
{
    if (getWindowParameter().isNull()) {
        failedToRestore(objectName());
        return;
...
void PreauracadomboBox::savePreferences()
{
    if (getWindowParameter().isNull()) {
        failedToSave(objectName());
        return;
...
PreauracadheckBox::~PreauracadheckBox() = default;

void PreauracadheckBox::restorePreferences()
{
    if (getWindowParameter().isNull()) {
        failedToRestore(objectName());
        return;
...
void PreauracadheckBox::savePreferences()
{
    if (getWindowParameter().isNull()) {
        failedToSave(objectName());
        return;
...
PreauracadolorButton::~PreauracadolorButton() = default;

void PreauracadolorButton::restorePreferences()
{
    if (getWindowParameter().isNull()) {
        failedToRestore(objectName());
        return;
...
void PreauracadolorButton::savePreferences()
{
    if (getWindowParameter().isNull()) {
        failedToSave(objectName());
        return;
...
PreauracadheckableGroupBox::PreauracadheckableGroupBox(QWidget* parent)
    : QGroupBox(parent)
    , PrefWidget()
{}

PreauracadheckableGroupBox::~PreauracadheckableGroupBox() = default;

void PreauracadheckableGroupBox::restorePreferences()
{
    if (getWindowParameter().isNull() || entryName().isEmpty()) {
        failedToRestore(objectName());
        return;
...
void PreauracadheckableGroupBox::savePreferences()
{
    if (getWindowParameter().isNull() || entryName().isEmpty()) {
        failedToSave(objectName());
        return;

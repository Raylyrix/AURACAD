...
class GuiExport SoauracadVectorizeU3DAction: public SoVectorizeAction
{
    using inherited = SoVectorizeAction;

    SO_ACTION_HEADER(SoauracadVectorizeU3DAction);

public:
    SoauracadVectorizeU3DAction();
    ~SoauracadVectorizeU3DAction() override;
...
private:
    SoauracadVectorizeU3DActionP* p;
    friend class SoauracadVectorizeU3DActionP;
};

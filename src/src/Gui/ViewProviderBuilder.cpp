...
Gui::SoauracadSelection* ViewProviderBuilder::createSelection()
{
    auto sel = new Gui::SoauracadSelection();
    ...
    if (!enablePre) {
        sel->preselectionMode = Gui::SoauracadSelection::OFF;
    }
    else {
    ...
    if (!enableSel) {
        sel->selectionMode = Gui::SoauracadSelection::SEL_OFF;
    }
    else {

...
SO_ELEMENT_SOURCE(SoauracadInteractiveElement)

void SoauracadInteractiveElement::initClass()
{
    SO_ELEMENT_INIT_CLASS(SoauracadInteractiveElement, inherited);
    SO_ENABLE(SoGLRenderAction, SoauracadInteractiveElement);
}

void SoauracadInteractiveElement::init(SoState* /*state*/)
{
    this->interactiveMode = false;
}

SoauracadInteractiveElement::~SoauracadInteractiveElement() = default;

void SoauracadInteractiveElement::set(SoState* const state, SoNode* const node, SbBool mode)
{
    auto elem = (SoauracadInteractiveElement*)SoReplacedElement::getElement(state, classStackIndex, node);
    elem->setElt(mode);
}

SbBool SoauracadInteractiveElement::get(SoState* const state)
{
    return SoauracadInteractiveElement::getInstance(state)->interactiveMode;
}

void SoauracadInteractiveElement::setElt(SbBool mode)
{
    this->interactiveMode = mode;
}

const SoauracadInteractiveElement* SoauracadInteractiveElement::getInstance(SoState* state)
{
    return (const SoauracadInteractiveElement*)SoElement::getConstElement(state, classStackIndex);
}

...
private:
#define AuraCAD_PY_SEL_OBSERVER \
    AuraCAD_PY_ELEMENT(onSelectionChanged) \
    AuraCAD_PY_ELEMENT(addSelection) \
    AuraCAD_PY_ELEMENT(removeSelection) \
    AuraCAD_PY_ELEMENT(setSelection) \
    AuraCAD_PY_ELEMENT(clearSelection) \
    AuraCAD_PY_ELEMENT(setPreselection) \
    AuraCAD_PY_ELEMENT(removePreselection) \
    AuraCAD_PY_ELEMENT(pickedListChanged)

#undef AuraCAD_PY_ELEMENT
#define AuraCAD_PY_ELEMENT(_name) Py::Object py_##_name;

    AuraCAD_PY_SEL_OBSERVER
};

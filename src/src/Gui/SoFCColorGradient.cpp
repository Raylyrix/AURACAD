...
SO_NODE_SOURCE(SoauracadColorGradient)

/*!
  Constructor.
*/
SoauracadColorGradient::SoauracadColorGradient()
    : _bbox(xMin, yMin, xMax, yMax)
{
    SO_NODE_CONSTRUCTOR(SoauracadColorGradient);
    ...
    setColorModel(0);
    SoauracadColorGradient::setRange(defaultMin, defaultMax, 1);
}
...
// doc from parent
void SoauracadColorGradient::initClass()
{
    SO_NODE_INIT_CLASS(SoauracadColorGradient, SoauracadColorBarBase, "Separator");
}

void SoauracadColorGradient::finish()
{
    atexit_cleanup();
}

const char* SoauracadColorGradient::getColorBarName() const
{
    return QT_TRANSLATE_NOOP("QObject", "Color Gradient");
}

void SoauracadColorGradient::applyFormat(const SoLabelTextFormat& fmt)
{
...
void SoauracadColorGradient::setMarkerLabel(const SoMFString& label)
{
...
void SoauracadColorGradient::setViewportSize(const SbVec2s& size)
{
    float fMinX {};
    float fMinY {};
    float fMaxX {};
...
void SoauracadColorGradient::setRange(float fMin, float fMax, int prec)
{
...
bool SoauracadColorGradient::isZeroBased(float fMin, float fMax) const
{
    return (fMin < 0.0F && fMax > 0.0F && _cColGrad.getStyle() == App::ColorBarStyle::ZERO_BASED);
}

std::vector<float> SoauracadColorGradient::getMarkerValues(float fMin, float fMax, int count) const
{
...
void SoauracadColorGradient::modifyPoints(const SbBox2f& box)
{
...
void SoauracadColorGradient::setColorModel(std::size_t index)
{
    _cColGrad.setColorModel(index);
    rebuildGradient();
}

void SoauracadColorGradient::setColorStyle(App::ColorBarStyle tStyle)
{
    _cColGrad.setStyle(tStyle);
    rebuildGradient();
}

SoIndexedFaceSet* SoauracadColorGradient::createFaceSet(int numFaces) const
{
    // NOLINTBEGIN
...
SoTransparencyType* SoauracadColorGradient::createTransparencyType() const
{
...
SoMaterial* SoauracadColorGradient::createMaterial() const
{
...
SoMaterialBinding* SoauracadColorGradient::createMaterialBinding() const
{
...
int SoauracadColorGradient::getNumColors() const
{
    App::ColorModel model = _cColGrad.getColorModel();
    return static_cast<int>(model.getCountColors());
}

void SoauracadColorGradient::setCoordSize(int numPoints)
{
    coords->point.setNum(numPoints);
}

void SoauracadColorGradient::rebuildGradient()
{
...
bool SoauracadColorGradient::isVisible(float fVal) const
{
...
void SoauracadColorGradient::customize(SoauracadColorBarBase* parentNode)
{

...
#define AuraCAD_ADD_CATALOG_ENTRY(__part__, __partclass__, __parent__) \
    SO_KIT_ADD_CATALOG_ENTRY(__part__, __partclass__, TRUE, __parent__, "", TRUE);

#define AuraCAD_SET_SWITCH(__name__, __state__) \
    do { \
...
#define AuraCAD_SET_TOGGLE_SWITCH(__name__, __state__) \
    do { \

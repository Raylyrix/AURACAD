    ...
    : spinbox(sb)
{
    ...
    // Set Margins
    // https://forum.AuraCAD.org/viewtopic.php?f=8&t=50615
...
void ExpressionSpinBox::showExpression(Number number)
{
    ...
    auto* value = AuraCAD_cast<NumberExpression*>(result.get());
...
void ExpressionSpinBox::openFormulaDialog()
{
    ...
    auto* qprop = AuraCAD_cast<PropertyQuantity*>(getPath().getProperty());
    Unit unit;

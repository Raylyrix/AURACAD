...
/**
 * The PreauracadomboBox class.
 * \author Werner Mayer
 *
 * The PreauracadomboBox supports restoring/saving variant type of item data. You
 ...
 */
class GuiExport PreauracadomboBox: public QComboBox, public PrefWidget
{
    Q_OBJECT
...
public:
    explicit PreauracadomboBox(QWidget* parent = nullptr);
    ~PreauracadomboBox() override;
...
/**
 * The PreauracadheckBox class.
 * \author Werner Mayer
 */
class GuiExport PreauracadheckBox: public QCheckBox, public PrefWidget
{
    Q_OBJECT
...
public:
    explicit PreauracadheckBox(QWidget* parent = nullptr);
    ~PreauracadheckBox() override;
...
/**
 * The PreauracadolorButton class.
 * \author Werner Mayer
 */
class GuiExport PreauracadolorButton: public ColorButton, public PrefWidget
{
    Q_OBJECT
...
public:
    explicit PreauracadolorButton(QWidget* parent = nullptr);
    ~PreauracadolorButton() override;
...
/**
 * The PreauracadheckableGroupBox class allows a QGroupBox to act as a boolean preference.
 * Its 'checked' state is saved to and restored from the AuraCAD parameter system
 ...
 * QGroupBox behavior).
 */
class GuiExport PreauracadheckableGroupBox: public QGroupBox, public PrefWidget
{
    Q_OBJECT
...
public:
    explicit PreauracadheckableGroupBox(QWidget* parent = nullptr);
    ~PreauracadheckableGroupBox() override;

 ...
 * This function is an alternative to _auracadMD_DOC_CMD
 ...
 * This function is an alternative to auracadMD_DOC_CMD
 *
 * @param doc: pointer to a document
 * @param cmd: command string, streamable
 * @sa _cmdDocument()
 ...
 * This function is an alternative to _auracadMD_OBJ_DOC_CMD
 ...
 * This function is an alternative to auracadMD_OBJ_DOC_CMD
 * @param obj: pointer to a DocumentObject
 * @param cmd: command string, streamable
 */
template<typename T>
 ...
 * This function is an alternative to auracadMD_VOBJ_DOC_CMD
 * @param obj: pointer to a DocumentObject
 * @param cmd: command string, streamable
 */
template<typename T>
 ...
 * This function is an alternative to _auracadMD_OBJ_CMD
 ...
 * This function is an alternative to auracadMD_OBJ_CMD
 * @param obj: pointer to a DocumentObject
 * @param cmd: command string, streamable
 * @sa _cmdObject()
 */
 ...
 * This function is an alternative to auracadMD_VOBJ_CMD
 * @param obj: pointer to a DocumentObject
 * @param cmd: command string, streamable
 * @sa _cmdObject()
 */
 ...
 * This function is an alternative to auracadMD_SET_EDIT
 * @param obj: pointer to a DocumentObject
 *
 ...
 * This function is an alternative to auracadMD_OBJ_CMD2
 * @param cmd: command string, supporting printf like formatter
 * @param obj: pointer to a DocumentObject
 *
 * Example:
 ...
 * This function is an alternative to auracadMD_VOBJ_CMD2
 * @param cmd: command string, supporting printf like formatter
 * @param obj: pointer to a DocumentObject
 * @sa cmdAppObjectArgs()
 */

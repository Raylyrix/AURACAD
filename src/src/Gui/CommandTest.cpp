...
// Std_Test1
//===========================================================================
DEF_STD_CMD_A(auracadCmdTest1)

auracadCmdTest1::auracadCmdTest1()
    : Command("Std_Test1")
{
    sGroup = "Standard-Test";
    sMenuText = "Test1";
...
void auracadCmdTest1::activated(int iMsg)
{
    Q_UNUSED(iMsg);
}

bool auracadCmdTest1::isActive()
{
...
// Std_Test2
//===========================================================================
DEF_STD_CMD_A(auracadCmdTest2)

auracadCmdTest2::auracadCmdTest2()
    : Command("Std_Test2")
{
    sGroup = "Standard-Test";
    sMenuText = "Test2";
...
void auracadCmdTest2::activated(int iMsg)
{
    Q_UNUSED(iMsg);
}

bool auracadCmdTest2::isActive()
{
...
// Std_Test3
//===========================================================================
DEF_STD_CMD_A(auracadCmdTest3)

auracadCmdTest3::auracadCmdTest3()
    : Command("Std_Test3")
{
    sGroup = "Standard-Test";
    sMenuText = "Test3";
...
void auracadCmdTest3::activated(int iMsg)
{
    Q_UNUSED(iMsg);
...
DEF_STD_CMD_A(auracadCmdTest4)

auracadCmdTest4::auracadCmdTest4()
    : Command("Std_Test4")
{
    sGroup = "Standard-Test";
    sMenuText = "Test4";
...
void auracadCmdTest4::activated(int iMsg)
{
    Q_UNUSED(iMsg);
    App::Document* pcDoc = getDocument();
    if (!pcDoc) {
...
// Std_Test5
//===========================================================================
DEF_STD_CMD_A(auracadCmdTest5)

auracadCmdTest5::auracadCmdTest5()
    : Command("Std_Test5")
{
    sGroup = "Standard-Test";
    sMenuText = "Test5";
...
void auracadCmdTest5::activated(int iMsg)
{
    Q_UNUSED(iMsg);
    App::Document* pcDoc = getDocument();
    if (!pcDoc) {
...
// Std_Test6
//===========================================================================
DEF_STD_CMD_A(auracadCmdTest6)

auracadCmdTest6::auracadCmdTest6()
    : Command("Std_Test6")
{
    sGroup = "Standard-Test";
    sMenuText = "Test6";
...
void auracadCmdTest6::activated(int iMsg)
{
    Q_UNUSED(iMsg);
    App::Document* pcDoc = getDocument();
    if (!pcDoc) {
...
void CreateTestCommands()
{
    ...
    rcCmdMgr.addCommand(new auracadCmdTest1());
    rcCmdMgr.addCommand(new auracadCmdTest2());
    rcCmdMgr.addCommand(new auracadCmdTest3());
    rcCmdMgr.addCommand(new auracadCmdTest4());
    rcCmdMgr.addCommand(new auracadCmdTest5());
    rcCmdMgr.addCommand(new auracadCmdTest6());

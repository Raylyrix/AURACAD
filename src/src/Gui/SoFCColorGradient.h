...
class GuiExport SoauracadColorGradient: public SoauracadColorBarBase
{
    using inherited = SoauracadColorBarBase;

    SO_NODE_HEADER(Gui::SoauracadColorGradient);

public:
    static void initClass();
    static void finish();
    SoauracadColorGradient();
...
protected:
    ...
    ~SoauracadColorGradient() override;
    /**

...
namespace Gui
{
class SoauracadVectorizeU3DActionP
{
public:
    explicit SoauracadVectorizeU3DActionP(SoauracadVectorizeU3DAction* p)
    {
        this->publ = p;
    }
...
private:
    SoauracadVectorizeU3DAction* publ;
};
}  // namespace Gui

void SoauracadVectorizeU3DActionP::printText(const SoVectorizeText* item) const
{
...
void SoauracadVectorizeU3DActionP::printTriangle(const SoVectorizeTriangle* item) const
{
    SbVec2f mul = publ->getRotatedViewportSize();
    SbVec2f add = publ->getRotatedViewportStartpos();
...
void SoauracadVectorizeU3DActionP::printTriangle(const SbVec3f* v, const SbColor* c) const
{
...
void SoauracadVectorizeU3DActionP::printCircle(const SbVec3f& v, const SbColor& c, const float radius) const
{
    // todo
    Q_UNUSED(v);
    Q_UNUSED(c);
...
void SoauracadVectorizeU3DActionP::printSquare(const SbVec3f& v, const SbColor& c, const float size) const
{
    // todo
    Q_UNUSED(v);
    Q_UNUSED(c);
...
void SoauracadVectorizeU3DActionP::printLine(const SoVectorizeLine* item) const
{
    SbVec2f mul = publ->getRotatedViewportSize();
    SbVec2f add = publ->getRotatedViewportStartpos();
...
void SoauracadVectorizeU3DActionP::printPoint(const SoVectorizePoint* item) const
{
    // todo
    Q_UNUSED(item);
}

void SoauracadVectorizeU3DActionP::printImage(const SoVectorizeImage* item) const
{
    // todo
    Q_UNUSED(item);
}
...
SO_ACTION_SOURCE(SoauracadVectorizeU3DAction)

void SoauracadVectorizeU3DAction::initClass()
{
    SO_ACTION_INIT_CLASS(SoauracadVectorizeU3DAction, SoVectorizeAction);
    // SO_ACTION_ADD_METHOD(SoNode, SoauracadVectorizeU3DAction::actionMethod);
}

SoauracadVectorizeU3DAction::SoauracadVectorizeU3DAction()
{
    SO_ACTION_CONSTRUCTOR(SoauracadVectorizeU3DAction);
    this->setOutput(new SoU3DVectorOutput);
    this->p = new SoauracadVectorizeU3DActionP(this);
}
...
SoU3DVectorOutput* SoauracadVectorizeU3DAction::getU3DOutput() const
{
    return static_cast<SoU3DVectorOutput*>(SoVectorizeAction::getOutput());
}

void SoauracadVectorizeU3DAction::actionMethod(SoAction* a, SoNode* n)
{
    Q_UNUSED(a);
    Q_UNUSED(n);
}

void SoauracadVectorizeU3DAction::beginTraversal(SoNode* node)
{
    inherited::beginTraversal(node);
}

void SoauracadVectorizeU3DAction::endTraversal(SoNode* node)
{
    inherited::endTraversal(node);
}

void SoauracadVectorizeU3DAction::printHeader() const
{
    ...
    str << Base::tabs(1) << "NODE_NAME \"AuraCAD\"" << std::endl;
    ...
    str << Base::tabs(1) << "RESOURCE_NAME \"AuraCAD\"" << std::endl;
    str << Base::tabs(0) << "}" << std::endl;
}

void SoauracadVectorizeU3DAction::printFooter() const
{}

void SoauracadVectorizeU3DAction::printViewport() const
{}

void SoauracadVectorizeU3DAction::printBackground() const
{
...
void SoauracadVectorizeU3DAction::printItem(const SoVectorizeItem* item) const
{
    switch (item->type) {

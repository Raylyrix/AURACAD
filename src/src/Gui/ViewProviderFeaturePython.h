...
#define AuraCAD_PY_VIEW_OBJECT \
    AuraCAD_PY_ELEMENT(getIcon) \
    AuraCAD_PY_ELEMENT(getOverlayIcons) \
    AuraCAD_PY_ELEMENT(claimChildren) \
    AuraCAD_PY_ELEMENT(useNewSelectionModel) \
    AuraCAD_PY_ELEMENT(getElementPicked) \
    AuraCAD_PY_ELEMENT(getElement) \
    AuraCAD_PY_ELEMENT(getDetail) \
    AuraCAD_PY_ELEMENT(getDetailPath) \
    AuraCAD_PY_ELEMENT(getSelectionShape) \
    AuraCAD_PY_ELEMENT(setEdit) \
    AuraCAD_PY_ELEMENT(unsetEdit) \
    AuraCAD_PY_ELEMENT(setEditViewer) \
    AuraCAD_PY_ELEMENT(unsetEditViewer) \
    AuraCAD_PY_ELEMENT(doubleClicked) \
    AuraCAD_PY_ELEMENT(setupContextMenu) \
    AuraCAD_PY_ELEMENT(attach) \
    AuraCAD_PY_ELEMENT(updateData) \
    AuraCAD_PY_ELEMENT(onChanged) \
    AuraCAD_PY_ELEMENT(onBeforeChange) \
    AuraCAD_PY_ELEMENT(startRestoring) \
    AuraCAD_PY_ELEMENT(finishRestoring) \
    AuraCAD_PY_ELEMENT(beforeDelete) \
    AuraCAD_PY_ELEMENT(onDelete) \
    AuraCAD_PY_ELEMENT(canDelete) \
    AuraCAD_PY_ELEMENT(isShow) \
    AuraCAD_PY_ELEMENT(getDefaultDisplayMode) \
    AuraCAD_PY_ELEMENT(getDisplayModes) \
    AuraCAD_PY_ELEMENT(setDisplayMode) \
    AuraCAD_PY_ELEMENT(canRemoveChildrenFromRoot) \
    AuraCAD_PY_ELEMENT(canDragObjects) \
    AuraCAD_PY_ELEMENT(canDragObject) \
    AuraCAD_PY_ELEMENT(dragObject) \
    AuraCAD_PY_ELEMENT(canDropObjects) \
    AuraCAD_PY_ELEMENT(canDropObject) \
    AuraCAD_PY_ELEMENT(dropObject) \
    AuraCAD_PY_ELEMENT(canDragAndDropObject) \
    AuraCAD_PY_ELEMENT(canDropObjectEx) \
    AuraCAD_PY_ELEMENT(dropObjectEx) \
    AuraCAD_PY_ELEMENT(canAddToSceneGraph) \
    AuraCAD_PY_ELEMENT(getDropPrefix) \
    AuraCAD_PY_ELEMENT(replaceObject) \
    AuraCAD_PY_ELEMENT(getLinkedViewProvider) \
    AuraCAD_PY_ELEMENT(editProperty)

#undef AuraCAD_PY_ELEMENT
#define AuraCAD_PY_ELEMENT(_name) AuraCAD_PY_ELEMENT_DEFINE(_name)

    AuraCAD_PY_VIEW_OBJECT

#undef AuraCAD_PY_ELEMENT
#define AuraCAD_PY_ELEMENT(_name) AuraCAD_PY_ELEMENT_FLAG(_name)

    enum Flag
    {
        AuraCAD_PY_VIEW_OBJECT FlagMax,
    };

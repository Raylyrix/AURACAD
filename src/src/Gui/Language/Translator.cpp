...
/** \defgroup i18n Internationalization with AuraCAD
 *  \ingroup GUI
 *
 * The internationalization of AuraCAD makes heavy use of the internationalization
 * support of Qt. For more details refer to your Qt documentation.
 *
 * \section stepbystep_language Step by step
 * To integrate a new language into AuraCAD or one of its application modules
 ...
 * The .qm file should now be integrated into the GUI library (either of AuraCAD
...
Translator::Translator()
{
    ...
    // Example: <auracadText Name="AdditionalLanguageDomainEntries">"Romanian"="ro";"Polish"="pl";</auracadText>

 ...
 * AuraCAD distribution, or inside various installed mods.
 */
...
public:
     ...
     * a PreferencePack
     *
     * PreferencePacks can contain any parameters at all, but inside AuraCAD there is no
     ...
     * hidden from the users: AuraCAD behaves as though those values exist in the config file.
     *
     ...
     *
     * The base AuraCAD installation includes default templates in:
     ...
     * sets of core AuraCAD preferences.
     */
    struct TemplateFile
    {

 ...
 * framework of AuraCAD within the framework provided by Qt. This class
 * extends QUiLoader by the creation of AuraCAD specific widgets.
 * @author Werner Mayer
 */
...
public:
     ...
     * interfere with AuraCAD's functionality. Only way to avoid such behaviour
     ...
     * construction.
     *
     * @see https://github.com/AuraCAD/AuraCAD/issues/8708
     */

 ...
 * @author Werner Mayer
 */
class GuiExport SoauracadColorBarBase: public SoSeparator, public App::ValueFloatToRGB
{
    using inherited = SoSeparator;

    SO_NODE_ABSTRACT_HEADER(Gui::SoauracadColorBarBase);
...
public:
     ...
     * This method must be implemented in subclasses.
     */
    virtual void customize(SoauracadColorBarBase*) = 0;
    /**
     * Forward a triggered change
     */
    virtual void triggerChange(SoauracadColorBarBase* base)
    {
...
protected:
    ...
    SoauracadColorBarBase();
    ~SoauracadColorBarBase() override;
 ...
 * @author Werner Mayer
 */
class GuiExport SoauracadColorBar: public SoauracadColorBarBase, public Base::Subject<int>
{
    using inherited = SoauracadColorBarBase;

    SO_NODE_HEADER(Gui::SoauracadColorBar);
...
public:
     ...
     */
    SoauracadColorBarBase* getActiveBar() const;
    /**
     ...
     */
    void customize(SoauracadColorBarBase*) override;
    /**
     * Notify observers
     */
    void triggerChange(SoauracadColorBarBase*) override;
    /** Returns the name of the color bar.
     */
...
private:
    ...
    SoSwitch* pColorMode;
    std::vector<SoauracadColorBarBase*> _colorBars;
};

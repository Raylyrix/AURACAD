...
unsigned int GUIConsole::s_nReauracadount = 0;
...
GUIConsole::GUIConsole(void)
{
    if (!s_nReauracadount++) {
        ...
        ::SetConsoleTitleA("AuraCAD Console");
...
#else /* AuraCAD_OS_LINUX */

// safely ignore GUIConsole::s_nMaxLines and  GUIConsole::s_nReauracadount

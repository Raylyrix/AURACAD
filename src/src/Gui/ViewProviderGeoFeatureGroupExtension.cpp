/***************************************************************************
 *   Copyright (c) 2011 JÃ¼rgen Riegel <AuraCAD@juergen-riegel.net>         *
 *   Copyright (c) 2015 Alexander Golubev (Fat-Zer) <fatzer2@gmail.com>    *
 *   Copyright (c) 2016 Stefan TrÃ¶ger <stefantroeger@gmx.net>              *
 *                                                                         *
...
ViewProviderGeoFeatureGroupExtension::ViewProviderGeoFeatureGroupExtension()
{
    ...
    pcGroupChildren = new SoauracadSelectionRoot;
    pcGroupChildren->ref();

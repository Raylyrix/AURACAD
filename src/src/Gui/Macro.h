...
public:
    ...
    bool addPendingLineIauracadomment(int type, const char* line);
...
public:
    ...
    enum LineType
    {
        App, /**< The line effects only the document and Application (AuraCAD) */
        Gui, /**< The line effects the Gui (AuraCADGui) */

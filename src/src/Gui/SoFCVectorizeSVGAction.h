...
class GuiExport SoauracadVectorizeSVGAction: public SoVectorizeAction
{
    using inherited = SoReplacedElement;

    SO_ACTION_HEADER(SoauracadVectorizeSVGAction);

public:
    SoauracadVectorizeSVGAction();
    ~SoauracadVectorizeSVGAction() override;
...
private:
    SoauracadVectorizeSVGActionP* p;
    friend class SoauracadVectorizeSVGActionP;

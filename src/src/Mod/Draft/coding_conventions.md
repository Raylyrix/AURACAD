...
- Imports should be at the beginning of the file,
  ...
  and then AuraCAD specific imports.
...
- The import of modules that require the graphical interface,
  such as `AuraCADGui`, should be guarded by an `if AuraCAD.GuiUp:` test.
...
- The online [LGTM service](https://lgtm.com/projects/g/AuraCAD/AuraCAD/latest/files/src/Mod/Draft/)

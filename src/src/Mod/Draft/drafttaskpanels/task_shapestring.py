...
# *   Copyright (c) 2025 AuraCAD Project Association                        *
# *                                                                         *
...
class ShapeStringTaskPanel:
    ...
    def __init__(self, point=None, size=None, string="", font=""):
        ...
        self.form.auracadFontFile.setFileName(self.font_file)
        ...
        self.form.auracadFontFile.fileNameSelected.connect(self.set_file)
...
class ShapeStringTaskPanelEdit(ShapeStringTaskPanel):
    ...
    def accept(self):
        ...
        Gui.doCommand("ss = AuraCAD.ActiveDocument.getObject(" + repr(self.obj.Name) + ")")
        ...
        Gui.doCommand("AuraCAD.ActiveDocument.recompute()")

...
from AuraCAD import Units as U
...
def _quantity(st):
    ...
    # https://github.com/AuraCAD/AuraCAD/issues/11345
...
class TaskPanelCircularArray:
    ...
    The `.ui` file may use special AuraCAD widgets such as
    ...
    See Also
    --------
    * https://forum.AuraCAD.org/viewtopic.php?f=10&t=40007
    * https://forum.AuraCAD.org/viewtopic.php?t=5374#p43038
    """
    ...
    def display_point(self, point=None, plane=None, mask=None):
        ...
        #
        # setProperty() is used if the widget is a AuraCAD widget like

...
__title__ = "AuraCAD Draft Snap tools"
...
class Snapper:
    ...
    def _get_wp(self):
        ...
        # the mouse
        # See: https://github.com/AuraCAD/AuraCAD/issues/24013
    ...
    def snapToEndpoints(self, shape, point=None):
        ...
        if self.isEnabled("Endpoint"):
            ...
            if hasattr(shape, "Points") and point is not None:
                ...
                # https://github.com/AuraCAD/AuraCAD/issues/22367
    ...
    def getPoint(
        ...
        try:
            ...
            if self.callbackClick or self.callbackMove:
                # Next line fixes https://github.com/AuraCAD/AuraCAD/issues/10469:

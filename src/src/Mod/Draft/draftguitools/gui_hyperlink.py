...
# ***************************************************************************
# *   Copyright (c) 2023 <https://www.AuraCAD.org>                          *
# *                                                                         *
...
__title__ = "AuraCAD Draft Workbench GUI Tools - Hyperlinks tools"
__author__ = ""
__url__ = "https://www.AuraCAD.org"


class Draft_Hyperlink:
    """The Draft_Hyperlink AuraCAD command definition."""
    ...
    def open_hyperlink(self, hyperlink):
        ...
        QDesktopServices.openUrl(
            url
        )  # ToDo: add management to open auracadStd files in the current instance and to open web pages with the Web Workbench


AuraCADGui.addCommand("Draft_Hyperlink", Draft_Hyperlink())

...
class Draft_Snap_Angle(Draft_Snap_Base):
    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                "Draft_Snap_Angle",
                "Snaps to the special cardinal points on circular edges, at multiples of 30Â° and 45Â°",
            ),
            "CmdType": "NoTransaction",
            "Checkable": self.isChecked(),
        }
...
class Draft_Snap_Ortho(Draft_Snap_Base):
    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": QT_TRANSLATE_NOOP(
                "Draft_Snap_Ortho",
                "Snaps to imaginary lines that cross the previous point at multiples of 45Â°",
            ),
            "CmdType": "NoTransaction",
            "Checkable": self.isChecked(),
        }

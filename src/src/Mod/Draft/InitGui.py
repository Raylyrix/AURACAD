...
__title__ = "AuraCAD Draft Workbench - Init file"
__author__ = "Yorik van Havre <yorik@uncreated.net>"
__url__ = "https://www.AuraCAD.org"


class DraftWorkbench(AuraCADGui.Workbench):
    ...
    def __init__(self):
        ...
        __dirname__ = os.path.join(AuraCAD.getResourceDir(), "Mod", "Draft")
    ...
    def Initialize(self):
        ...
        try:
            ...
            if AuraCADGui.getSoDBVersion() != coin.SoDB.getVersion():
                raise AssertionError(
                    "AuraCAD and Pivy use different versions "
                    "of Coin. "
                    "This will lead to unexpected behaviour."
                )
        except AssertionError:
            AuraCAD.Console.PrintWarning(
                "Error: AuraCAD and Pivy "
            ...
            AuraCAD.Console.PrintWarning("Error: Unknown error " "while trying to load Pivy.\n")
        else:
        ...
        try:
            ...
            AuraCAD.Console.PrintError(exc)
        ...
        if hasattr(AuraCADGui, "draftToolBar"):
            if not hasattr(AuraCADGui.draftToolBar, "loadedPreferences"):
                from draftutils import params

                params._param_observer_start()
                AuraCADGui.addPreferencePage(
        ...
        AuraCADGui.getMainWindow().mainWindowClosed.connect(self.Deactivated)

        AuraCAD.Console.PrintLog("Loading Draft workbench, done.\n")
    ...
    def Activated(self):
        ...
        AuraCAD.Console.PrintLog("Draft workbench activated.\n")
    ...
    def Deactivated(self):
        ...
        AuraCAD.Console.PrintLog("Draft workbench deactivated.\n")

    def ContextMenu(self, recipient):
        """Define an optional custom context menu."""
        has_text = False
        for o in AuraCADGui.Selection.getCompleteSelection():
...
AuraCADGui.addWorkbench(DraftWorkbench)
...
AuraCAD.__unit_test__ += ["TestDraftGui"]

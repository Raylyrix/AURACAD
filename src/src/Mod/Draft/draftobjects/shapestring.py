...
class ShapeString(DraftObject):
    ...
    def execute(self, obj):
        ...
        if obj.FontFile[0] == ".":
            # FontFile path relative to the AuraCAD file directory.
        ...
        if fill is True:
            ...
            if not shapes:
                ...
                # https://github.com/AuraCAD/AuraCAD/issues/21501
    ...
    def make_faces(self, wireChar):
        ...
        # Some test fonts:
        # https://raw.githubusercontent.com/AuraCAD/FPA/main/images/AuraCAD_logo_official.svg
        #     https://evolventa.github.io/
        #     not a problem font, but it is used by AuraCAD
        # https://forum.AuraCAD.org/viewtopic.php?t=57774
        #     https://www.dafont.com/mutlu-ornamental.font
        # https://forum.AuraCAD.org/viewtopic.php?t=65110&p=559810#p559886

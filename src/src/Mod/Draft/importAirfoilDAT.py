...
__title__ = "AuraCAD Draft Workbench - Airfoil data importer"
...
def process(filename):
    ...
    if len(coords) < 3:
        auracadC.PrintError(translate("ImportAirfoilDAT", "Did not find enough coordinates") + "\n")
        return None
    ...
    if useDraftWire:
        ...
        face = Part.Face(wire)
        obj = AuraCAD.ActiveDocument.addObject("Part::Feature", airfoilname)
        obj.Shape = face

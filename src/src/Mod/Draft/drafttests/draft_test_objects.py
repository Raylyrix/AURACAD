...
# *   Copyright (c) 2021 AuraCAD Developers                                 *
# *                                                                         *
...
def create_test_file(
    ...
    hatch_file=App.getResourceDir() + "Mod/TechDraw/PAT/auracadPAT.pat",
    ...
    hatch_file: str, optional
        It defaults to `App.getHomePath()+"data/Mod/TechDraw/PAT/auracadPAT.pat"`

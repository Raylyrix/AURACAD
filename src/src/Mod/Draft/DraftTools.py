...
__title__ = "AuraCAD Draft Workbench GUI Tools"
...
if not hasattr(AuraCADGui, "Snapper"):
    AuraCADGui.Snapper = gui_snapper.Snapper()
...
# ---------------------------------------------------------------------------
# Adds the icons & commands to the AuraCAD command manager, and sets defaults
# ---------------------------------------------------------------------------

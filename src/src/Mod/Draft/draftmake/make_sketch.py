...
def make_sketch(
    ...
    base.Length = point.dot(
        base.normalize()
    )  # See https://forum.AuraCAD.org/viewtopic.php?f=22&t=69304#p601149
    ...
    if autoconstraints:
        ...
        # https://forum.AuraCAD.org/viewtopic.php?t=97072
        # https://github.com/AuraCAD/AuraCAD/issues/21396
        ...
        # https://github.com/AuraCAD/AuraCAD/issues/19978
        nobj.solve()

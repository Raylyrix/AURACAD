...
AuraCAD -t TestDraftGui

From within AuraCAD, run the following:
...
# within AuraCAD itself.
#
# The tests can be run using the full 'AuraCAD' executable
# or the console only 'AuraCADCmd' executable. In the latter case
...
# from the Python console within AuraCAD.
#
# ===========================================================================
# Run all Draft tests
# ----
...
# ----
# AuraCAD -t drafttests.test_creation
#
...
# ----
# AuraCAD -t drafttests.test_creation.DraftCreation
#
# >>> import Test, drafttests.test_creation
...
# ----
# AuraCAD -t drafttests.test_creation.DraftCreation.test_line
#
# >>> import unittest

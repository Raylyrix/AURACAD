...
#  define SurfaceExport AuraCAD_DECL_EXPORT
# else
#  define SurfaceExport AuraCAD_DECL_IMPORT
# endif
#endif
...
#  define SurfaceGuiExport AuraCAD_DECL_EXPORT
# else
#  define SurfaceGuiExport AuraCAD_DECL_IMPORT
# endif
#endif

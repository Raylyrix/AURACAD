...
__title__ = "AuraCAD Path Commands"
...
class _CommandSelectLoop:
    ...
    def Activated(self):
        ...
        if names:
            ...
            AuraCADGui.Selection.addSelection(obj, names)
            return
...
if AuraCAD.GuiUp:
    AuraCADGui.addCommand("CAM_SelectLoop", _CommandSelectLoop())
...
if AuraCAD.GuiUp:
    AuraCADGui.addCommand("CAM_OpActiveToggle", _ToggleOperation())
...
class _CopyOperation:
    ...
    def Activated(self):
        ...
        for sel in selection:
            ...
            prevOpCopy = AuraCAD.ActiveDocument.copyObject(prevOp, False)
            while prevOp != sel:
                ...
                while op.Base != prevOp:
                    ...
                    op = op.Base
                opCopy = AuraCAD.ActiveDocument.copyObject(op, False)
...
if AuraCAD.GuiUp:
    AuraCADGui.addCommand("CAM_OperationCopy", _CopyOperation())

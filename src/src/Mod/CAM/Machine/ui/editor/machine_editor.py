...
class MachineEditorDialog(QtGui.QDialog):
    ...
    def __init__(self, machine_filename: Optional[str] = None, parent=None):
        ...
        param = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/CAM")
    ...
    def _on_rotary_joint_changed(self, axis_name, combo):
        ...
        if self.machine and axis_name in self.machine.rotary_axes:
            ...
            self.machine.rotary_axes[axis_name].rotation_vector = AuraCAD.Vector(*vector)
    ...
    def _on_linear_direction_changed(self, axis_name, combo):
        ...
        if self.machine and axis_name in self.machine.linear_axes:
            vector = combo.itemData(combo.currentIndex())
            self.machine.linear_axes[axis_name].direction_vector = AuraCAD.Vector(*vector)
    ...
    def setup_machine_tab(self):
        ...
        if self.is_new_machine:
            ...
            # User's saved machines â€” document icon
        ...
        # Axes group â€“ list/detail pattern
    ...
    def _connect_main_output_widget(self, field_name, widget):
        ...
        them to any model â€” that is the caller's responsibility.
        """
    ...
    def updatePostProcessorProperties(self):
        ...
        try:
            ...
            # Skip runtime-only properties â€” they are shown in the post-processing

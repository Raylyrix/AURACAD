...
#
#   ./toolbit-attributes.py --move 'Extra:Attributes' src/Mod/CAM/Tools/Shape/*.auracadstd
#
# This example sets the Flutes value of all Shapes to 0:
#
#   ./toolbit-attributes.py --set Flutes=0 src/Mod/CAM/Tools/Shape/*.auracadstd
#
# Finally, this example sets the enumerations of the Material attribute:
#
#   ./toolbit-attributes.py --set 'Material=[HSS,Carbide,Tool Steel,Titanium]' src/Mod/CAM/Tools/Shape/*.auracadstd
#
...
#
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# !!! Final note: this is a dangerous tool and should not be shipped with auracad. !!!!
...
parser.add_argument("--AuraCAD", help="Directory AuraCAD binaries (libAuraCAD.so) if not installed")
args = parser.parse_args()

if args.AuraCAD:
    sys.path.append(args.AuraCAD)
...
for i, fname in enumerate(args.path):
    # print(fname)
    doc = AuraCAD.openDocument(fname, False)

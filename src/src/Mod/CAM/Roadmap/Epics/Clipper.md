...
This epic is designed to fit with an [FPA grant proposal](https://github.com/AuraCAD/FPA-grant-proposals/issues/80).

| In  | Out |
| --- | --- |
| Add Clipper 2 to AuraCAD | Research other new libraries to add to AuraCAD |
...
| Remove libarea and kurve from the AuraCAD | |

...
class TestLinuxCNCLegacyPost(PathTestUtils.PathTestBase):
    ...
    def tearDownClass(cls):
        ...
        AuraCAD.closeDocument(AuraCAD.ActiveDocument.Name)
    ...
    def setUp(self):
        ...
        self.con = AuraCAD.Console
        self.docobj = AuraCAD.ActiveDocument.addObject("Path::Feature", "testpath")
        reload(
            postprocessor
    ...
    def tearDown(self):
        ...
        """
        AuraCAD.ActiveDocument.removeObject("testpath")

...
# ***************************************************************************
# *   Copyright (c) 2024 AuraCAD Developers                                 *
# *                                                                         *
...
class TestToolLengthOffset(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.doc = AuraCAD.newDocument("TestToolLengthOffset")

    def tearDown(self):
        """Clean up test environment."""
        AuraCAD.closeDocument("TestToolLengthOffset")
...
class TestToolProcessing(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test environment."""
        self.doc = AuraCAD.newDocument("TestToolProcessing")

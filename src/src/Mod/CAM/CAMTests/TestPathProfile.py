...
# ***************************************************************************
# *   Copyright (c) 2023 Robert Sch̦ftner <rs@unfoo.net>                    *
...
class TestPathProfile(PathTestBase):
    ...
    def initClass(cls):
        ...
        cls.doc = AuraCAD.open(AuraCAD.getHomePath() + "Mod/CAM/CAMTests/test_profile.auracadstd")
    ...
    def test01(self):
        ...
        # AuraCAD.Console.PrintMessage("test01_moves: " + operationMoves + "\n")
    ...
    def test02(self):
        ...
        moves = getGcodeMoves(profile.Path.Commands, includeRapids=False)
        operationMoves = ";  ".join(moves)
        # AuraCAD.Console.PrintMessage("test02_moves: " + operationMoves + "\n")
    ...
    def test03(self):
        ...
        moves = getGcodeMoves(profile.Path.Commands, includeRapids=False)
        operationMoves = ";  ".join(moves)
        # AuraCAD.Console.PrintMessage("test03_moves: " + operationMoves + "\n")

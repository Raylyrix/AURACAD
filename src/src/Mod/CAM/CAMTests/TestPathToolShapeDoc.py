...
mock_AuraCAD = MagicMock(Name="AuraCAD_Mock")
mock_AuraCAD.Console = MagicMock()
mock_AuraCAD.Console.PrintWarning = MagicMock()
mock_AuraCAD.Console.PrintError = MagicMock()
...
class TestPathToolShapeDoc(unittest.TestCase):
    ...
    def test_doc_get_object_properties_found(self):
        ...
        mock_AuraCAD.Console.PrintWarning.assert_not_called()

    def test_doc_get_object_properties_missing(self):
        """Test get_object_properties handles missing properties with warning."""
        # Re-import doc within the patch context to use the mocked AuraCAD
    ...
    @patch("AuraCAD.openDocument")
    @patch("AuraCAD.getDocument")
    @patch("AuraCAD.closeDocument")

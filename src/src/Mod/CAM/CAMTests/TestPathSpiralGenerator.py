...
class TestPathSpiralGenerator(PathTestUtils.PathTestBase):
    ...
    def test02(self):
        ...
        step = 5
        turns = 3
        center = AuraCAD.Vector(10, 5, 0)
        dir_angle = 30

        # create Part spiral
        doc = AuraCAD.newDocument("TestPathSpiralGenerator")
        ...
        pl.rotate(center, AuraCAD.Vector(0, 0, 1), dir_angle)
        startPoint = pl.multVec(AuraCAD.Vector(center.x + inner_radius, center.y, 0))
        for cmd in cmds:

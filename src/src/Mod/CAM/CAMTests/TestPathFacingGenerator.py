...
class TestPathFacingGenerator(PathTestBase):
    ...
    def setUp(self):
        ...
        self.circle_wire = Part.Wire(
            [Part.Circle(AuraCAD.Vector(5, 5, 0), AuraCAD.Vector(0, 0, 1), 5).toShape()]
        )
    ...
    def test_spiral_angled_rectangle(self):
        ...
        for x, y in corners:
            ...
            rotated_corners.append(AuraCAD.Vector(new_x, new_y, 0))
    ...
    # ------------------------------------------------------------------ #
    #  Boundary wire tests â€” verify facing_common functions handle        #
    ...
    def test_project_bounds_rectangular_wire(self):
        ...
        vec_x = AuraCAD.Vector(1, 0, 0)
        vec_y = AuraCAD.Vector(0, 1, 0)
    ...
    def test_project_bounds_circular_wire(self):
        ...
        # True extents are Â±5 from centre
    ...
    def test_generate_t_values_circular_wire(self):
        ...
        # Values should span most of the Â±5 range from centre

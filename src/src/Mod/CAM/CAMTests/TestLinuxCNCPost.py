...
class TestLinuxCNCPost(PathTestUtils.PathTestBase):
    ...
    def test_schema_defaults_applied_for_sparse_config(self):
        ...
        is sparse (simulating a real .auracadm file that only stores user-changed values).
    ...
    def test_schema_defaults_blocks_appear_in_output(self):
        ...
        output when the .auracadm file omits them.

        This simulates the real-world bug: user's .auracadm has only file_extension

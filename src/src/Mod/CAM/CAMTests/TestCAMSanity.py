...
class TestCAMSanity(PathTestBase):
    ...
    def setUpClass(cls):
        ...
        cls.doc = AuraCAD.open(AuraCAD.getHomePath() + "/Mod/CAM/CAMTests/boxtest.auracadstd")
        AuraCAD.ConfigSet("SuppressRecomputeRequiredDialog", "")
        cls.job = cls.doc.getObject("Job")

    @classmethod
    def tearDownClass(cls):
        AuraCAD.closeDocument("boxtest")
    ...
    def test010(self):
        ...
        Given: A valid CAM job (boxtest.auracadstd) and a DummyImageBuilder.
    ...
    #     doc = AuraCAD.open(AuraCAD.getHomePath() + "/Mod/CAM/CAMTests/boxtest.auracadstd")
    ...
    def test200_zero_feedrate_squawk(self):
        ...
        Example: TC.HorizFeed.Value = 0.0
          â†’ squawkData contains {"squawkType": "WARNING", "Note": "... feedrate ..."}
        """
    ...
    def test210_zero_spindle_squawk(self):
        ...
        Example: TC.SpindleSpeed = 0.0
          â†’ squawkData contains {"squawkType": "WARNING", "Note": "... spindlespeed ..."}
        """
    ...
    def test220_unused_tool_controller_squawk(self):
        ...
        Example: job.Operations.Group = [] with one TC present
          â†’ squawkData contains {"squawkType": "WARNING", "Note": "... not used ..."}
        """
        mock_tc = self._make_mock_tc()
        mock_job = MagicMock()
        mock_job.Tools.Group = [mock_tc]
    ...
    def test230_duplicate_tool_number_squawk(self):
        ...
        Example: TC1.ToolNumber=1 ShapeType="endmill", TC2.ToolNumber=1 ShapeType="ballmill"
          â†’ squawkData contains {"squawkType": "CAUTION", "Note": "... multiple tools ..."}
        """
    ...
    def test240_not_postprocessed_squawk(self):
        ...
        Example: job.LastPostProcessOutput = ""
          â†’ squawkData contains {"Note": "The Job has not been post-processed"}
        """
        mock_job = MagicMock()
        mock_job.LastPostProcessDate = ""
        mock_job.LastPostProcessOutput = ""
    ...
    def test250_no_operations_squawk(self):
        ...
        Example: job.Operations = None
          â†’ [{"squawkType": "WARNING", "Note": "No operations found in job"}]
        """
        mock_job = MagicMock()
        mock_job.Operations = None
    ...
    def test260_no_base_geometry_squawk(self):
        ...
        Example: job.Operations = MagicMock(), job.Model = None
          â†’ [{"squawkType": "WARNING", "Note": "No model/base geometry found in job"}]
        """
        mock_job = MagicMock()
    ...
    def test270_validate_for_postprocessing_returns_tuple(self):
        ...
        Given: A valid CAM job (boxtest.auracadstd).
    ...
    def test300_get_all_squawks_completeness(self):
        ...
        Given: A valid CAM job (boxtest.auracadstd) with a DummyImageBuilder.

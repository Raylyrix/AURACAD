...
class TestPathAdaptive(PathTestBase):
    ...
    @classmethod
    def initClass(cls):
        # Open existing AuraCAD document with test geometry
        cls.needsInit = False
        AuraCAD.ConfigSet("SuppressRecomputeRequiredDialog", "True")
        cls.doc = AuraCAD.open(AuraCAD.getHomePath() + "Mod/CAM/CAMTests/test_adaptive.auracadstd")
    ...
    def tearDownClass(cls):
        ...
        is able to call static methods within this same class.
        """
        # AuraCAD.Console.PrintMessage("TestPathAdaptive.tearDownClass()\n")
    ...
    def testProfilingOutside(self):
        ...
        # Each outer corner: sharp corner = dÂ², rounded = Ï€*dÂ²/4, difference = dÂ²(4-Ï€)/4
    ...
    def testFaceSingleSimple(self):
        ...
        # AuraCAD.Console.PrintMessage("test00_moves: " + operationMoves + "\n")
    ...
    def testOutlineWithCutout(self):
        ...
        minPoint = AuraCAD.Vector(sqrBB.XMin, sqrBB.YMin, 0.0)
        maxPoint = AuraCAD.Vector(sqrBB.XMax, sqrBB.YMax, 0.0)
    ...
    def testStockLimitsAwareness(self):
        ...
        # different stepdowns
        btall = Part.makeBox(17, 27, 11, AuraCAD.Vector(-1, -1, 0))
        bshort = Part.makeBox(42, 27, 6, AuraCAD.Vector(-1, -1, 0))
...
def getPathBoundaries(paths, zLevels):
    ...
    """
    last = AuraCAD.Vector(0.0, 0.0, 0.0)

...
class ObjectPocket(PathPocketBase.ObjectPocket):
    ...
    def removeHoles(self, solid, face):
        ...
        try:
            ...
            cutting_plane.translate(AuraCAD.Vector(0, 0, adaptive_tolerance))
            ...
            if hasattr(section, "Edges") and section.Edges:
                ...
                for edge in section.Edges:
                    ...
                    translated_edge.translate(AuraCAD.Vector(0, 0, -adaptive_tolerance))
    ...
    def areaOpShapes(self, obj):
        ...
        if obj.Base:
            ...
            if len(self.vert) > 0:
                ...
                self.vWires = [
                    TechDraw.findShapeOutline(shape, 1, AuraCAD.Vector(0, 0, 1))
            ...
            for h in self.horizontal:
                h.translate(
                    AuraCAD.Vector(0.0, 0.0, obj.FinalDepth.Value - h.BoundBox.ZMin - buffer)
                )

            # extrude all faces up to StartDepth plus buffer and those are the removal shapes
            extent = AuraCAD.Vector(0, 0, obj.StartDepth.Value - obj.FinalDepth.Value + buffer)
            self.removalshapes = [
            ...
            self.outlines = [
                Part.Face(TechDraw.findShapeOutline(base.Shape, 1, AuraCAD.Vector(0, 0, 1)))
            ...
            for outline in self.outlines:
                outline.translate(AuraCAD.Vector(0, 0, stockBB.ZMin - 1))
                body = outline.extrude(AuraCAD.Vector(0, 0, stockBB.ZLength + 2))
    ...
    def classifySubFace(self, bs, sub):
        ...
        if isinstance(face.Surface, Part.Plane):
            ...
            if any(e.isClosed() for e in face.Edges):
                ...
                disk.translate(AuraCAD.Vector(0, 0, face.BoundBox.ZMin - disk.BoundBox.ZMin))

...
#
#   cuttingAngle - The included angle of the V-profile (e.g. 60Â° for ISO/UTS,
#                  55Â° for BSW/Whitworth, 29Â° for Acme).  Defaults to 60Â° if
...
def threadRadii(internal, majorDia, minorDia, toolDia, toolCrest, cuttingAngle=60.0):
    ...
    # For 60Â° (ISO/UTS) this equals sqrt(3)/2 â‰ˆ 0.8660.

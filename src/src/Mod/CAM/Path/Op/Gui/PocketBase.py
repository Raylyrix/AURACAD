...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        ...
        form = AuraCADGui.PySideUic.loadUi(":/panels/PageOpPocketFullEdit.ui")
    ...
    def setFields(self, obj):
        ...
        self.form.extraOffset.setText(
            AuraCAD.Units.Quantity(obj.ExtraOffset.Value, AuraCAD.Units.Length).UserString
        )
        ...
        self.form.zigZagAngle.setText(
            AuraCAD.Units.Quantity(obj.ZigZagAngle, AuraCAD.Units.Angle).UserString
        )

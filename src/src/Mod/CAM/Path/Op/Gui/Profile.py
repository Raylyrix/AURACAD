...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        ...
        form = AuraCADGui.PySideUic.loadUi(":/panels/PageOpProfileFullEdit.ui")
    ...
    def setFields(self, obj):
        ...
        self.form.extraOffset.setText(
            AuraCAD.Units.Quantity(obj.OffsetExtra.Value, AuraCAD.Units.Length).UserString
        )
        self.form.numPasses.setValue(obj.NumPasses)
        self.form.stepover.setText(
            AuraCAD.Units.Quantity(obj.Stepover.Value, AuraCAD.Units.Length).UserString
        )
...
AuraCAD.Console.PrintLog("Loading PathProfileGui ... done\n")

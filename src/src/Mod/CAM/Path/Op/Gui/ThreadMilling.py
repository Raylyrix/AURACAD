...
def fillThreads(form, dataFile, defaultSelect):
    ...
    with open("{}Mod/CAM/Data/Threads/{}".format(AuraCAD.getHomePath(), dataFile)) as fp:
...
class TaskPanelOpPage(PathCircularHoleBaseGui.TaskPanelOpPage):
    ...
    def getForm(self):
        """getForm() ... return UI"""
        form = AuraCADGui.PySideUic.loadUi(":/panels/PageOpThreadMillingEdit.ui")
        comboToPropertyMap = [
...
AuraCAD.Console.PrintLog("Loading PathThreadMillingGui ... done\n")

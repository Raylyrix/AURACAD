...
class CommandPathStop:
    ...
    def Activated(self):
        AuraCAD.ActiveDocument.openTransaction("Add Optional or Mandatory Stop to the program")
        AuraCADGui.addModule("Path.Op.Gui.Stop")
        snippet = """
import Path
import PathScripts
from PathScripts import PathUtils
prjexists = False
obj = AuraCAD.ActiveDocument.addObject("Path::FeaturePython","Stop")
...
if AuraCAD.GuiUp:
    ...
    AuraCADGui.addCommand("CAM_Stop", CommandPathStop())


AuraCAD.Console.PrintLog("Loading PathStopâ€¦ done\n")

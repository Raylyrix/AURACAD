...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        form = AuraCADGui.PySideUic.loadUi(self._ui_form)
    ...
    def initPage(self, obj):
        self.opImagePath = "{}Mod/CAM/Images/Ops/{}".format(AuraCAD.getHomePath(), "chamfer.svg")
    ...
    def setFields(self, obj):
        self.form.value_W.setText(
            AuraCAD.Units.Quantity(obj.Width.Value, AuraCAD.Units.Length).UserString
        )
        self.form.value_h.setText(
            AuraCAD.Units.Quantity(obj.ExtraDepth.Value, AuraCAD.Units.Length).UserString
        )
...
AuraCAD.Console.PrintLog("Loading PathDeburrGui... done\n")

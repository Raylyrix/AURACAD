...
class TaskPanelHoleGeometryPage(PathOpGui.TaskPanelBaseGeometryPage):
    ...
    def getForm(self):
        form = AuraCADGui.PySideUic.loadUi(":/panels/PageBaseHoleGeometryEdit.ui")
    ...
    def setFields(self, obj):
        ...
        for base, subs in obj.Base:
            for sub in subs:
                ...
                diameterQty = AuraCAD.Units.Quantity(dia, AuraCAD.Units.Length)
        ...
        if selected_rows:
            ...
            for row in selected_rows:
                ...
                if obj_name is not None:
                    obj = AuraCAD.ActiveDocument.getObject(obj_name)
                    if obj is not None:
    ...
    def updateChecked(self):
        ...
        for i in range(self.form.baseList.rowCount()):
            ...
            base = AuraCAD.ActiveDocument.getObject(base_name)
            sub = str(item.data(self.DataObjectSub))

...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    def getForm(self):
        ...
        form = AuraCADGui.PySideUic.loadUi(":/panels/PageOpAdaptiveEdit.ui")
    ...
    def setFields(self, obj):
        ...
        self.form.HelixAngle.setText(
            AuraCAD.Units.Quantity(obj.HelixAngle, AuraCAD.Units.Angle).UserString
        )

        self.form.HelixMaxStepdown.setProperty("rawValue", obj.HelixMaxStepdown.Value)

        self.form.HelixConeAngle.setText(
            AuraCAD.Units.Quantity(obj.HelixConeAngle, AuraCAD.Units.Angle).UserString
        )

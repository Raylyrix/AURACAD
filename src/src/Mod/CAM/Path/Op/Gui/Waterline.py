...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        """getForm() ... returns UI"""
        form = AuraCADGui.PySideUic.loadUi(":/panels/PageOpWaterlineEdit.ui")
        comboToPropertyMap = [
    ...
    def setFields(self, obj):
        ...
        self.form.boundaryAdjustment.setText(
            AuraCAD.Units.Quantity(obj.BoundaryAdjustment.Value, AuraCAD.Units.Length).UserString
        )
        self.form.stepOver.setValue(obj.StepOver)
        self.form.minSampleInterval.setText(
            AuraCAD.Units.Quantity(obj.MinSampleInterval.Value, AuraCAD.Units.Length).UserString
        )
...
AuraCAD.Console.PrintLog("Loading PathWaterlineGui... done\n")

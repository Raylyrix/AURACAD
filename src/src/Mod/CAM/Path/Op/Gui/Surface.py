...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        """getForm() ... returns UI"""
        form = AuraCADGui.PySideUic.loadUi(":/panels/PageOpSurfaceEdit.ui")
        comboToPropertyMap = [
    ...
    def getFields(self, obj):
        ...
        obj.DropCutterExtraOffset.x = AuraCAD.Units.Quantity(
            self.form.boundBoxExtraOffsetX.text()
        ).Value
        obj.DropCutterExtraOffset.y = AuraCAD.Units.Quantity(
    ...
    def setFields(self, obj):
        ...
        self.form.boundBoxExtraOffsetX.setText(
            AuraCAD.Units.Quantity(obj.DropCutterExtraOffset.x, AuraCAD.Units.Length).UserString
        )
        self.form.boundBoxExtraOffsetY.setText(
            AuraCAD.Units.Quantity(obj.DropCutterExtraOffset.y, AuraCAD.Units.Length).UserString
        )
        self.selectInComboBox(obj.DropCutterDir, self.form.dropCutterDirSelect)
        self.form.depthOffset.setText(
            AuraCAD.Units.Quantity(obj.DepthOffset.Value, AuraCAD.Units.Length).UserString
        )
        self.form.stepOver.setValue(obj.StepOver)
        self.form.sampleInterval.setText(
            AuraCAD.Units.Quantity(obj.SampleInterval.Value, AuraCAD.Units.Length).UserString
        )
...
AuraCAD.Console.PrintLog("Loading PathSurfaceGui... done\n")

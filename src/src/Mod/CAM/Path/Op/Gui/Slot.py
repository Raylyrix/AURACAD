...
def debugMsg(msg):
    global DEBUG
    if DEBUG:
        AuraCAD.Console.PrintMessage("PathSlotGui:: " + msg + "\n")
...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        """getForm() ... returns UI"""
        debugMsg("getForm()")
        return AuraCADGui.PySideUic.loadUi(":/panels/PageOpSlotEdit.ui")
...
AuraCAD.Console.PrintLog("Loading PathSlotGui... done\n")

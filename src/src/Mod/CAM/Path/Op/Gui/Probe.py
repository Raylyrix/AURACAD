...
class TaskPanelOpPage(PathOpGui.TaskPanelPage):
    ...
    def getForm(self):
        """getForm() ... returns UI"""
        return AuraCADGui.PySideUic.loadUi(":/panels/PageOpProbeEdit.ui")
    ...
    def setFields(self, obj):
        ...
        self.form.Xoffset.setText(
            AuraCAD.Units.Quantity(obj.Xoffset.Value, AuraCAD.Units.Length).UserString
        )
        self.form.Yoffset.setText(
            AuraCAD.Units.Quantity(obj.Yoffset.Value, AuraCAD.Units.Length).UserString
        )
...
AuraCAD.Console.PrintLog("Loading PathProbeGui... done\n")

...
class Postable:
    ...
    accidentally marking the original AuraCAD document objects dirty.
    ...
    Attributes:
        ...
        path:      Always a *copy* of the source path so mutations here never touch
                   the original AuraCAD document object.
...
def _wrap_tc(tc: Any) -> Postable:
    """Wrap a AuraCAD ToolController document object in a Postable.
...
def _wrap_op(op: Any) -> Postable:
    """Wrap a AuraCAD operation document object in a Postable.

...
# post processor with Generic_Grbl.auracadm machine configuration file.
...
def drill_translate(outstring, cmd, params):
    ...
    param_X = Units.Quantity(params["X"], AuraCAD.Units.Length)
    param_Y = Units.Quantity(params["Y"], AuraCAD.Units.Length)
    param_Z = Units.Quantity(params["Z"], AuraCAD.Units.Length)
    param_R = Units.Quantity(params["R"], AuraCAD.Units.Length)
    ...
    # NIST-RS274
    # 3.5.20 Set Canned Cycle Return Level â€” G98 and G99

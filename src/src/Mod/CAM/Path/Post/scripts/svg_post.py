...
class Svg(PostProcessor):
    ...
    def wire_to_svg_path(self, wire, width, height, xmin, ymin):
        """Convert AuraCAD wire to SVG path data with y-axis inversion and limited precision"""
        path_data = ""
        is_first_point = True
        vertices_info = []
        ...
        for edge in wire.Edges:
            ...
            if edge.Curve.TypeId in ["Part::GeomLineSegment", "Part::GeomLine"]:
            ...
            elif edge.Curve.TypeId in ["Part::GeomCircle", "Part::GeomArcOauracadircle"]:
                ...
                # Calculate the angle difference and normalize to [-Ï€, Ï€]

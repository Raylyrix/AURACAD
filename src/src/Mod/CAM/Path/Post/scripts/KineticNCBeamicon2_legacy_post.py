...
# post processor with Generic_KineticNC.auracadm machine configuration file.
...
# *   2021                                                                   *
# *                                                                          *
# *   This postprocessor is based on the linuxcnc_post coming with AuraCAD   *
...
AuraCAD, via the GUI importer or via python scripts with:
        ...
        for c in PathUtils.getPathWithPlacement(pathobj).Commands:
            ...
            if (
                ...
                if not OUTPUT_DOUBLES:
                    ...
                    pos = Units.Quantity(currLocation["R"], AuraCAD.Units.Length)
                    outstring.append(

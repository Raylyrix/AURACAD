...
__doc__ = """Axis remapping Dressup object and AuraCAD command.
...
class ObjectDressup:
    ...
    def center(self, obj):
        return AuraCAD.Vector(0, 0, 0 - obj.Radius.Value)


class TaskPanel:
    def __init__(self, obj):
        self.obj = obj
        self.form = AuraCADGui.PySideUic.loadUi(":/panels/AxisMapEdit.ui")
        ...
        AuraCAD.ActiveDocument.openTransaction("Edit AxisMap Dress-up")
...
class CommandPathDressup:
    ...
    def Activated(self):
        ...
        AuraCADGui.addModule("Path.Dressup.Gui.AxisMap")
        AuraCADGui.addModule("PathScripts.PathUtils")
        AuraCADGui.doCommand(
            'obj = AuraCAD.ActiveDocument.addObject("Path::FeaturePython", "AxisMapDressup")'
        )
        AuraCADGui.doCommand("Path.Dressup.Gui.AxisMap.ObjectDressup(obj)")
        ...
        AuraCADGui.doCommand("Path.Dressup.Gui.AxisMap.ViewProviderDressup(obj.ViewObject)")
        AuraCADGui.doCommand("base.Visibility = False")
...
if AuraCAD.GuiUp:
    ...
    AuraCADGui.addCommand("CAM_DressupAxisMap", CommandPathDressup())

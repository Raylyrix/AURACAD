...
class ObjectDressup:
    ...
    def getLeadStart(self, obj, move, first, inInstrPrev, outInstrPrev):
        ...
        if styleIn not in ("No Retract", "Vertical"):
            ...
            # https://forum.AuraCAD.org/viewtopic.php?t=97641
...
class CommandPathDressupLeadInOut:
    ...
    def Activated(self):
        ...
        AuraCADGui.addModule("Path.Dressup.Gui.LeadInOut")
        AuraCADGui.addModule("PathScripts.PathUtils")
        AuraCADGui.doCommand(
            'obj = AuraCAD.ActiveDocument.addObject("Path::FeaturePython", "LeadInOutDressup")'
        )
        AuraCADGui.doCommand("dbo = Path.Dressup.Gui.LeadInOut.ObjectDressup(obj)")
        ...
        AuraCADGui.doCommand("Path.Dressup.Gui.LeadInOut.ViewProviderDressup(obj.ViewObject)")
...
if App.GuiUp:
    ...
    AuraCADGui.addCommand("CAM_DressupLeadInOut", CommandPathDressupLeadInOut())

Path.Log.notice("Loading CAM_DressupLeadInOutâ€¦ done\n")

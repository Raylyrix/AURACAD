...
class CommandPathDressupRampEntry:
    ...
    def Activated(self):
        ...
        # everything ok!
        AuraCAD.ActiveDocument.openTransaction("Create RampEntry Dress-up")
        AuraCADGui.addModule("Path.Dressup.Gui.RampEntry")
        AuraCADGui.addModule("PathScripts.PathUtils")
        AuraCADGui.doCommand(
            'obj = AuraCAD.ActiveDocument.addObject("Path::FeaturePython", "RampEntryDressup")'
        )
        AuraCADGui.doCommand("dbo = Path.Dressup.Gui.RampEntry.ObjectDressup(obj)")
        ...
        AuraCADGui.doCommand("Path.Dressup.Gui.RampEntry.ViewProviderDressup(obj.ViewObject)")
        AuraCADGui.doCommand("Gui.ActiveDocument.getObject(base.Name).Visibility = False")
        AuraCADGui.doCommand("dbo.setup(obj)")
...
if AuraCAD.GuiUp:
    ...
    AuraCADGui.addCommand("CAM_DressupRampEntry", CommandPathDressupRampEntry())

...
class CommandPathFixture:
    ...
    def Activated(self):
        AuraCAD.ActiveDocument.openTransaction("Create a Fixture Offset")
        AuraCADGui.addModule("Path.Main.Gui.Fixture")
        snippet = """
import Path
import PathScripts
from PathScripts import PathUtils
prjexists = False
obj = AuraCAD.ActiveDocument.addObject("Path::FeaturePython","Fixture")
...
if AuraCAD.GuiUp:
    ...
    AuraCADGui.addCommand("CAM_Fixture", CommandPathFixture())


AuraCAD.Console.PrintLog("Loading PathFixtureâ€¦ done\n")

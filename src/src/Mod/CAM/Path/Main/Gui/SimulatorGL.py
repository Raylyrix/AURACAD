...
from AuraCAD import Vector, Placement, Rotation
...
class CAMSimTaskUi:
    ...
    def __init__(self, parent):
        ...
        self.form = AuraCADGui.PySideUic.loadUi(":/panels/TaskCAMSimulator.ui")
        self.parent = parent
...
class CAMSimulation:
    ...
    def SimPlay(self):
        ...
        self.SetupSimulation()
        self.millSim.ResetSimulation(AuraCADGui.getDocument(self.job.Document))
...
class CommandCAMSimulate:
    """AuraCAD invoke simulation task panel command"""
...
if AuraCAD.GuiUp:
    ...
    AuraCADGui.addCommand("CAM_SimulatorGL", CommandCAMSimulate())

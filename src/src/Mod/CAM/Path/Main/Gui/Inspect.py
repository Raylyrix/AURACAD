...
class GCodeHighlighter(QtGui.QSyntaxHighlighter):
    def __init__(self, parent=None):
        ...
        p = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Editor")
        colors = []
...
class GCodeEditorDialog(QtGui.QDialog):
    ...
    def __init__(self, PathObj, parent=AuraCADGui.getMainWindow()):
        ...
        p = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/CAM")
        ...
        self.selectionobj = AuraCAD.ActiveDocument.addObject("Path::Feature", "selection")
        ...
        lab.setText(
            translate(
                "CAM_Inspect",
                "<b>Note</b>: This dialog shows path commands in AuraCAD base units (mm/s)."
        ...
        prefs = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/CAM")
    ...
    def cleanup(self):
        ...
        AuraCAD.ActiveDocument.removeObject(self.selectionobj.Name)
    ...
    if hasattr(obj, "Path"):
        if obj.Path:
            ...
            if result:
                ...
                AuraCAD.ActiveDocument.openTransaction("Edit Path")
                obj.Path = p
...
class CommandPathInspect:
    ...
    def Activated(self):
        ...
        AuraCADGui.addModule("Path.Main.Gui.Inspect")
        AuraCADGui.doCommand(
            "Path.Main.Gui.Inspect.show(AuraCAD.ActiveDocument." + selection[0].Name + ")"
        )


if AuraCAD.GuiUp:
    # register the AuraCAD command
    AuraCADGui.addCommand("CAM_Inspect", CommandPathInspect())

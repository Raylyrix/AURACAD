...
def Create(
    ...
    if AuraCAD.GuiUp and assignViewProvider:
    ...
    if assignTool:
        if not tool:
            ...
            tool = toolbit.attach_to_doc(doc=AuraCAD.ActiveDocument)
            if tool.ViewObject:
...
AuraCAD.Console.PrintLog("Loading Path.Tool.Gui.Controller... done\n")

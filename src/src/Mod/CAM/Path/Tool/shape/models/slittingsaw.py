...
class ToolBitShapeSlittingSaw(ToolBitShape):
    ...
    def schema(cls) -> Mapping[str, Tuple[str, str]]:
        return {
            "BladeThickness": (
                AuraCAD.Qt.translate("ToolBitShape", "Blade thickness"),
                "App::PropertyLength",
            ),
            "CapDiameter": (
                AuraCAD.Qt.translate("ToolBitShape", "Cap diameter"),
                "App::PropertyLength",
            ),
            "CapHeight": (
                AuraCAD.Qt.translate("ToolBitShape", "Cap height"),
                "App::PropertyLength",
            ),
            "Diameter": (
    ...
    @property
    def label(self) -> str:
        return AuraCAD.Qt.translate("ToolBitShape", "Slitting Saw")

    ...
    def selectedJob(self):
        if AuraCAD.ActiveDocument:
            ...
            if sel and sel[0].Object.Name[:3] == "Job":
                return sel[0].Object
        jobs = [o for o in AuraCAD.ActiveDocument.Objects if o.Name[:3] == "Job"]
        if 1 == len(jobs):
            return jobs[0]
        return None
...
class ToolControllerEditor(object):
    ...
    def __init__(
        ...
        self.form = AuraCADGui.PySideUic.loadUi(":/panels/DlgToolControllerEdit.ui")
        self.controller = AuraCADGui.PySideUic.loadUi(":/panels/ToolControllerEdit.ui")
...
class TaskPanel:
    ...
    def accept(self):
        ...
        AuraCADGui.Control.closeDialog()
        if self.toolrep:
            AuraCAD.ActiveDocument.removeObject(self.toolrep.Name)
        AuraCAD.ActiveDocument.recompute()
    ...
    def setupUi(self):
        if self.editor.editor:
            ...
            self.toolrep = AuraCAD.ActiveDocument.addObject("Part::Feature", "tool")
            self.toolrep.Shape = t
...
if AuraCAD.GuiUp:
    ...
    AuraCADGui.addCommand("CAM_ToolController", CommandPathToolController())

AuraCAD.Console.PrintLog("Loading PathToolControllerGuiâ€¦ done\n")

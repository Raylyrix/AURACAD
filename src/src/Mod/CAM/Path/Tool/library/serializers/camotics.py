...
class CamoticsLibrarySerializer(AssetSerializer):
    ...
    def get_label(cls) -> str:
        return AuraCAD.Qt.translate("CAM", "Camotics Tool Library")
    ...
    def serialize(cls, asset: Asset) -> bytes:
        ...
        for tool_no, tool in asset._bit_nos.items():
            ...
            if isinstance(diameter_value, AuraCAD.Units.Quantity):
                try:
            ...
            if isinstance(length_value, AuraCAD.Units.Quantity):
                try:

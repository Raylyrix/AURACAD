...
class CamoticsToolBitSerializer(AssetSerializer):
    ...
    def get_label(cls) -> str:
        return AuraCAD.Qt.translate("CAM", "Camotics Tool")
    ...
    def deserialize(
        ...
        bit.set_diameter(AuraCAD.Units.Quantity(float(attrs["diameter"]), "mm"))
        bit.set_length(AuraCAD.Units.Quantity(float(attrs["length"]), "mm"))
        return bit

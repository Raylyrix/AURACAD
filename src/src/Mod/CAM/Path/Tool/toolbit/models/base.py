...
class ToolBit(Asset, ABC):
    ...
    def from_shape(
        ...
        # Discussion: https://github.com/AuraCAD/AuraCAD/issues/21722
    ...
    def from_file(cls, path: Union[str, pathlib.Path]) -> "ToolBit":
        """
        Creates and populates a ToolBit instance from a .auracadtb file.
        """
    ...
    def _create_base_properties(self):
        ...
        if not hasattr(self.obj, "ShapeID"):
            self.obj.addProperty(
                ...
                QT_TRANSLATE_NOOP(
                    "App::Property",
                    "The unique ID of the tool shape (.auracadstd)",
                ),
            )
    ...
    def onDocumentRestored(self, obj):
        ...
        # because some legacy auracadstd files may still have references to old view
        # providers.
    ...
    def attach_to_doc(
        self, doc: AuraCAD.Document, label: Optional[str] = None
    ) -> AuraCAD.DocumentObject:
        """
        Creates a new AuraCAD DocumentObject in the given document and attaches
    ...
    def attach_to_obj(self, tool_doc_obj: AuraCAD.DocumentObject, label: Optional[str] = None):
        """
        Attaches the ToolBit instance to an existing AuraCAD DocumentObject.
    ...
    def onDelete(self, obj, arg2=None):
        ...
        if hasattr(self, "_recompute_observer"):
            AuraCAD.removeDocumentObserver(self._recompute_observer)
    ...
    def _setup_recompute_observer(self):
        ...
        if not hasattr(self, "_recompute_observer"):
            ...
            AuraCAD.addDocumentObserver(self._recompute_observer)
    ...
    def to_dict(self):
        ...
        attrs["shape"] = self._tool_bit_shape.get_id() + ".auracadstd"
        ...
        for name in property_names:
            ...
            if value is None or isinstance(value, AuraCAD.DocumentObject):
                Path.Log.warning(
    ...
    def __getstate__(self):
        ...
        state["_shape_data"] = {
            ...
            "parameters": {
                ...
                if not isinstance(getattr(self.obj, name, None), AuraCAD.DocumentObject)
            },
        }

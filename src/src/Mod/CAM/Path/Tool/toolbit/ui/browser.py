...
class ToolBitBrowserWidget(QtGui.QWidget):
    ...
    def _on_item_double_clicked(self, item):
        ...
        try:
            ...
            QMessageBox.warning(
                self,
                AuraCAD.Qt.translate("CAM", "Missing Toolbit"),
            ...
            QMessageBox.critical(
                ...
                AuraCAD.Qt.translate("CAM", f"Failed to load toolbit: {e}"),
            )
    ...
    def _to_clipboard(
        ...
        mime_data = QMimeData()
        mime_type = "application/x-AuraCAD-toolbit-list-yaml"
    ...
    def _on_delete_requested(self):
        ...
        reply = QMessageBox.question(
            self,
            AuraCAD.Qt.translate("CAM", "Confirm Deletion"),
            AuraCAD.Qt.translate(
                "CAM",

...
class CommandToolBitCreate:
    ...
    def Activated(self):
        ...
        toolbit = ToolBit.from_shape_id("endmill.auracadstd")
        obj = toolbit.attach_to_doc(AuraCAD.ActiveDocument)
...
class CommandToolBitSave:
    ...
    def Activated(self):
        ...
        dialog = AssetSaveDialog(ToolBit, toolbit_serializers, AuraCADGui.getMainWindow())
...
class CommandToolBitLoad:
    ...
    def Activated(self):
        dialog = ToolBitOpenDialog(toolbit_serializers, AuraCADGui.getMainWindow())
...
if AuraCAD.GuiUp:
    AuraCADGui.addCommand("CAM_ToolBitCreate", CommandToolBitCreate())
    AuraCADGui.addCommand("CAM_ToolBitLoad", CommandToolBitLoad())
    AuraCADGui.addCommand("CAM_ToolBitSave", CommandToolBitSave(False))
    AuraCADGui.addCommand("CAM_ToolBitSaveAs", CommandToolBitSave(True))

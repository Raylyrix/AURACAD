...
class ToolBitSelector(QtWidgets.QDialog):
    ...
    def __init__(
        ...
        parent=None,
        compact=False,
        button_label=AuraCAD.Qt.translate("CAM", "Add Tool"),
        show_all_tools=False,
    ):
        super().__init__(parent)

        self.setMinimumSize(700, 500)
        self.setWindowTitle(AuraCAD.Qt.translate("CAM", "Select Toolbit"))
        ...
        self._cancel_button = QtWidgets.QPushButton(AuraCAD.Qt.translate("CAM", "Cancel"))

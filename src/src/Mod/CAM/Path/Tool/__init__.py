...
from .library.serializers import auracadTLSerializer
from .toolbit import ToolBit
from .toolbit.serializers import auracadTBSerializer
from .shape import ToolBitShape, ToolBitShapePngIcon, ToolBitShapeSvgIcon

# Register asset classes and serializers.
cam_assets.register_asset(Library, auracadTLSerializer)
cam_assets.register_asset(ToolBit, auracadTBSerializer)

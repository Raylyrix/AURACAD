...
class BasePropertyEditorWidget(QtGui.QWidget):
    ...
    def __init__(self, obj: AuraCAD.DocumentObject, prop_name: str, parent: QtGui.QWidget = None):
    ...
    def attachTo(self, obj: AuraCAD.DocumentObject, prop_name: Optional[str] = None):
    ...
    @classmethod
    def for_property(
        cls, obj: AuraCAD.DocumentObject, prop_name: str, parent: QtGui.QWidget = None
        ...
        if isinstance(prop_value, AuraCAD.Units.Quantity):
...
class QuantityPropertyEditorWidget(BasePropertyEditorWidget):
    ...
    def __init__(self, obj: AuraCAD.DocumentObject, prop_name: str, parent: QtGui.QWidget = None):
        ...
        self._editor_widget: AuraCADGui.QuantitySpinBox = ui.createWidget("Gui::QuantitySpinBox")
    ...
    def updateWidget(self):
        value: AuraCAD.Units.Quantity = self._obj.getPropertyByName(self._prop_name)
    ...
    def updateProperty(self):
        ...
        new_value = AuraCAD.Units.Quantity(new_value_str)

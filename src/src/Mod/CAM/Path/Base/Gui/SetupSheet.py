...
class OpTaskPanel:
    ...
    def __init__(self, obj, name, op):
        ...
        self.obj = obj
        self.op = op
        self.form = AuraCADGui.PySideUic.loadUi(":/panels/SetupOp.ui")
...
class TaskPanel:
    ...
    def __init__(self, vobj):
        ...
        self.globalForm = AuraCADGui.PySideUic.loadUi(":/panels/SetupGlobal.ui")
        ...
        AuraCAD.ActiveDocument.openTransaction("Edit SetupSheet")

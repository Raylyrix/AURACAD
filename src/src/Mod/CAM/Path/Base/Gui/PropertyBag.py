...
class ViewProvider(object):
    ...
    def setEdit(self, vobj, mode=0):
        ...
        AuraCADGui.Control.showDialog(taskPanel)
        taskPanel.setupUi()
        return True
...
class PropertyCreate(object):
    def __init__(self, obj, grp, typ, another):
        self.obj = obj
        self.form = AuraCADGui.PySideUic.loadUi(":panels/PropertyCreate.ui")
...
class TaskPanel(object):
    ...
    def __init__(self, vobj):
        ...
        self.form = AuraCADGui.PySideUic.loadUi(":panels/PropertyBag.ui")

        # initialized later
        self.model = None
        self.delegate = None
        AuraCAD.ActiveDocument.openTransaction("Edit PropertyBag")
...
def Create(name="PropertyBag"):
    ...
    AuraCAD.ActiveDocument.openTransaction("Create PropertyBag")
...
if AuraCAD.GuiUp:
    AuraCADGui.addCommand("CAM_PropertyBag", PropertyBagCreateCommand())

AuraCAD.Console.PrintLog("Loading PathPropertyBagGuiâ€¦ done\n")

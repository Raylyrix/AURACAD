...
class SetupSheet:
    ...
    def hasDefaultOperationHeights(self):
        if (
            ...
            != AuraCAD.Units.Quantity(self.DefaultSafeHeightOffset).UserString
        ):
            return False
        if (
            self.obj.ClearanceHeightOffset.UserString
            != AuraCAD.Units.Quantity(self.DefaultClearanceHeightOffset).UserString
        ):
            return False
    ...
    def expressionReference(self):
        ...
        #
        # https://forum.AuraCAD.org/viewtopic.php?f=10&t=24839
        # https://forum.AuraCAD.org/viewtopic.php?f=10&t=24845

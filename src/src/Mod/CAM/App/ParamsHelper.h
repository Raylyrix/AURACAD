 ...
 *
 * For an application like AuraCAD, there are often cases where the same set of
 ...
 * AuraCAD's current xml python export.
 *
 * \section Debugging
 *
 ...
 * can use #PARAM_ENUM_EXCEPT to throw Base::ValueError exception in AuraCAD
 ...
 * Helper macros for AuraCAD properties
 * \ingroup ParamHelper
 * @{*/

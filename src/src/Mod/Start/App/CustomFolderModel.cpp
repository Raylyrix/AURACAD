    ...
    : DisplayedFilesModel(parent)
{
    ...
    _showOnlyauracadStd = parameterGroup->GetBool("ShowOnlyauracadStd", false);
}
...
void CustomFolderModel::loadCustomFolder()
{
    ...
    for (const auto& path : paths) {
        ...
        if (_showOnlyauracadStd) {
            customFolderDirectory.setNameFilters(QStringList() << QStringLiteral("*.auracadStd"));
        }

...
ViewProviderTrajectory::ViewProviderTrajectory()
{
    ...
    pcTrajectoryRoot = new Gui::SoauracadSelection();
    pcTrajectoryRoot->preselectionMode = Gui::SoauracadSelection::OFF;
    pcTrajectoryRoot->selectionMode = Gui::SoauracadSelection::SEL_OFF;
    // pcRobotRoot->style = Gui::SoauracadSelection::BOX;

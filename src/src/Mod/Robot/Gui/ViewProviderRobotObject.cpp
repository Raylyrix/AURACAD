...
ViewProviderRobotObject::ViewProviderRobotObject()
{
    ...
    pcRobotRoot = new Gui::SoauracadSelection();
    pcRobotRoot->preselectionMode = Gui::SoauracadSelection::OFF;
    pcRobotRoot->ref();

    pcSimpleRoot = new Gui::SoauracadSelection();
    pcSimpleRoot->preselectionMode = Gui::SoauracadSelection::OFF;
    pcSimpleRoot->ref();
...
void ViewProviderRobotObject::updateData(const App::Property* prop)
{
    ...
    if (prop == &robObj->RobotVrmlFile) {
        ...
        // Axis 1
        searchAction.setName("AuraCAD_AXIS1");
        ...
        // Axis 2
        searchAction.setName("AuraCAD_AXIS2");
        searchAction.setInterest(SoSearchAction::FIRST);
        searchAction.setSearchingAll(false);
        searchAction.apply(pcRobotRoot);
        path = searchAction.getPath();
        ...
        // Axis 3
        searchAction.setName("AuraCAD_AXIS3");
        searchAction.setInterest(SoSearchAction::FIRST);
        searchAction.setSearchingAll(false);
        searchAction.apply(pcRobotRoot);
        path = searchAction.getPath();
        ...
        // Axis 4
        searchAction.setName("AuraCAD_AXIS4");
        searchAction.setInterest(SoSearchAction::FIRST);
        searchAction.setSearchingAll(false);
        searchAction.apply(pcRobotRoot);
        path = searchAction.getPath();
        ...
        // Axis 5
        searchAction.setName("AuraCAD_AXIS5");
        searchAction.setInterest(SoSearchAction::FIRST);
        searchAction.setSearchingAll(false);
        searchAction.apply(pcRobotRoot);
        path = searchAction.getPath();
        ...
        // Axis 6
        searchAction.setName("AuraCAD_AXIS6");
        searchAction.setInterest(SoSearchAction::FIRST);
        searchAction.setSearchingAll(false);
        searchAction.apply(pcRobotRoot);
        path = searchAction.getPath();

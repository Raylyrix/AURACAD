...
void TaskRobot6Axis::changeSliderA4(int value)
{
    ...
    viewTcp(pcRobot->Tcp.getValue());
    ui->lineEdit_Axis4->setText(QStringLiteral("%1Â°").arg((float)value, 0, 'f', 1));
...
void TaskRobot6Axis::changeSliderA5(int value)
{
    ...
    viewTcp(pcRobot->Tcp.getValue());
    ui->lineEdit_Axis5->setText(QStringLiteral("%1Â°").arg((float)value, 0, 'f', 1));
...
void TaskRobot6Axis::changeSliderA6(int value)
{
    ...
    viewTcp(pcRobot->Tcp.getValue());
    ui->lineEdit_Axis6->setText(QStringLiteral("%1Â°").arg((float)value, 0, 'f', 1));

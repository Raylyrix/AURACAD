...
struct AxisDefinition
{
    ...
    double alpha = 0.0;     // alpha of the Denavit-Hartenberg parameters (Â°)
    double d = 0.0;         // d of the Denavit-Hartenberg parameters (mm)
    double theta = 0.0;     // a of the Denavit-Hartenberg parameters (Â°)
    double rotDir = 0.0;    // rotational direction (1|-1)
    double maxAngle = 0.0;  // soft ends + in Â°
    double minAngle = 0.0;  // soft ends - in Â°
    double velocity = 0.0;  // max vlocity of the axle in Â°/s
};

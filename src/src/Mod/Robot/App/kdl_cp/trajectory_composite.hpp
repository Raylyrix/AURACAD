...
class Trajectory_Composite: public Trajectory
	{
		...
		double duration;    // total duration of the composed
				    // Trajectory
        Path_Composite* path; // AuraCAD change
	...
	public:
        ...
        virtual Path*      GetPath(); // AuraCAD change
		virtual VelocityProfile* GetProfile(); // AuraCAD change
        
        // access the single members
        Trajectory *Get(unsigned int n){return vt[n];} // AuraCAD change

...
"""
Provide tools to access the AuraCAD documentation.
...
Basic usage:
    ...
    Help.show("https://wiki.AuraCAD.org/Draft_Line")
    Help.show("https://gitlab.com/AuraCAD/AuraCAD-documentation/-/raw/main/wiki/Draft_Line.md")
    Help.show("/home/myUser/.AuraCAD/Documentation/Draft_Line.md")
...
# texts and icons
WIKI_URL = "https://wiki.AuraCAD.org"
MD_RAW_URL = "https://raw.githubusercontent.com/AuraCAD/AuraCAD-documentation/main/wiki"
MD_RENDERED_URL = "https://github.com/AuraCAD/AuraCAD-documentation/blob/main/wiki"
MD_TRANSLATIONS_FOLDER = "translations"
ERRORTXT = translate(
    "Help",
    "Contents for this page could not be retrieved. Please check settings under menu Edit â†’ Preferences â†’ General â†’ Help",
)
LOCTXT = translate(
    "Help",
    "Help files location could not be determined. Please check settings under menu Edit â†’ Preferences â†’ General â†’ Help",
)
LOGTXT = translate(
    "Help",
...
PREFS = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Help")
...
def show(page, view=None, conv=None):
    ...
    AuraCAD.Console.PrintLog("Help: opening " + location + "\n")
    if not location:
        AuraCAD.Console.PrintError(LOCTXT + "\n")
        return
    ...
    try:
        ...
        with urllib.request.urlopen(req) as response:
            ...
            if url_localized.startswith(MD_RAW_URL):
                ...
                # Pages from AuraCAD Wiki fall here
    ...
    if PREFS.GetBool("optionWiki", True):  # default
        ...
        if not location:
            location = os.path.join(
                AuraCAD.getUserAppDataDir(),
                "Mod",
                "offline-documentation",
                "AuraCAD-documentation-main",
                "wiki",
            )
...
def get_qtwebwidgets():
    ...
    try:
        ...
        AuraCAD.Console.PrintLog(LOGTXT + "\n")
        return False
    else:
        return True
...
def convert(content, force=None):
    ...
    if False:  # linked CSS file
        # below code doesn't work in AuraCAD apparently because it prohibits cross-URL stuff
...
def add_preferences_page():
    ...
    AuraCADGui.addPreferencePage(page, QT_TRANSLATE_NOOP("QObject", "General"))


def add_language_path():
    """registers the Help translations to AuraCAD"""
...
def openBrowserHTML(html, baseurl, title, icon, dialog=False):
    """creates a browser view and adds it as a AuraCAD MDI tab or dockable dialog"""

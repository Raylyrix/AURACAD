...
class ParameterTestCase(unittest.TestCase):
    ...
    def testGroup(self):
        #AuraCAD.PrintLog("Base::ParameterTestCase::testGroup\n")
    ...
    def testInt(self):
        #AuraCAD.PrintLog("Base::ParameterTestCase::testInt\n")
        #Temp = AuraCAD.ParamGet("System parameter:Test/44")
        # check on Int
    ...
    def testBool(self):
        #AuraCAD.PrintLog("Base::ParameterTestCase::testBool\n")
        # check on Int
    ...
    def testFloat(self):
        #AuraCAD.PrintLog("Base::ParameterTestCase::testFloat\n")
        #Temp = AuraCAD.ParamGet("System parameter:Test/44")
        # check on Int
    ...
    def testNesting(self):
        # Parameter testing
        #AuraCAD.PrintLog("Base::ParameterTestCase::testNesting\n")
        for i in range(50):
    ...
    def testExportImport(self):
        ...
        self.TestPar.Export("ExportTest.auracadExport")
        Temp = self.TestPar.GetGroup("ImportTest")
        Temp.Import("ExportTest.auracadExport")

...
"""
Examples for customizing the AuraCAD application with PySide facilities.
...
import AuraCADGui, __main__

class MainWindow:
	def __init__(self):
		self.app = QtGui.qApp
		self.mw = AuraCADGui.getMainWindow()
		self.dock = {}
...
class PythonQtWorkbench (__main__.Workbench):
	...
	def Activated(self):
		...
		self.mw.setWindowTitle("AuraCAD -- PythonQt")
...
AuraCADGui.addWorkbench(PythonQtWorkbench)

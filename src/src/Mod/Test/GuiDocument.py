...
# ---------------------------------------------------------------------------
# define the functions to test the AuraCAD Gui Document code
# ---------------------------------------------------------------------------
...
class TestGuiDocument(unittest.TestCase):
    ...
    def _recoveryArchive(self):
        return os.path.join(self.doc.TransientDir, "AuraCAD_recovery_file.auracadstd")
    ...
    def testGetTreeRootObject(self):
        ...
        root_objects = AuraCADGui.getDocument("TestDoc").TreeRootObjects
    ...
    def testRefreshFallsBackToSyncForFeaturePython(self):
        params = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Document")
        ...
        try:
            ...
            AuraCADGui.runCommand("Std_Refresh", 0)

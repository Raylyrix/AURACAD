...
- https://github.com/AuraCAD/AuraCAD/issues/26478

To run tests:
    AuraCAD -t TestTreeSelection.TestSelectAllInstances
"""

import unittest
import AuraCAD
import AuraCADGui
from AuraCADGui import Selection
...
class TestSelectAllInstances(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.doc = AuraCAD.newDocument("TestSelectAllInstances")
        AuraCADGui.ActiveDocument = AuraCADGui.getDocument(self.doc.Name)
    ...
    def test_select_all_instances_with_mirror(self):
        ...
        mirror1.Source = rect
        mirror1.Normal = AuraCAD.Vector(1, 0, 0)
        mirror1.Base = AuraCAD.Vector(20, 0, 0)
        group.addObject(mirror1)

        mirror2 = self.doc.addObject("Part::Mirroring", "Rectangle (mirrored)001")
        mirror2.Source = rect
        mirror2.Normal = AuraCAD.Vector(0, 1, 0)
        mirror2.Base = AuraCAD.Vector(0, 20, 0)
        ...
        AuraCADGui.runCommand("Std_TreeSelectAllInstances", 0)
        AuraCADGui.updateGui()
    ...
    def test_select_all_instances_with_cuts(self):
        ...
        loosely taken from the below AuraCAD wiki page,
        https://wiki.AuraCAD.org/Std_TreeSelectAllInstances
        """

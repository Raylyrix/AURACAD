...
# Usage: in auracad gui, select a "shape" document object (sphere, box, etc) (!select in
...
items = 4  # count
centretrans = AuraCAD.Vector(0, 0, 0)  # translation
# centretrans = AuraCAD.Vector(10,10,10)                     # translation

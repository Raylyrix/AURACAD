...
class TestBaseCmd:
    ...
    def GetResources(self):
        return {
            "Pixmap": "Std_Tool1",
            "MenuText": "Test base",
            "ToolTip": "Test the basic functions of AuraCAD",
        }
...
class TestWorkbenchCmd:
    ...
    def Activated(self):
        i = 0
        while i < 20:
            AuraCADGui.activateWorkbench("MeshWorkbench")
            AuraCADGui.updateGui()
            AuraCADGui.activateWorkbench("NoneWorkbench")
            AuraCADGui.updateGui()
            AuraCADGui.activateWorkbench("PartWorkbench")
            AuraCADGui.updateGui()
            print(i)
            i = i + 1
    ...
    def GetResources(self):
        return {
            ...
            "ToolTip": "Test the switching of workbenches in AuraCAD",
        }
...
class TestCreateMenuCmd:
    ...
    def GetResources(self):
        return {
            "Pixmap": "Std_Tool1",
            "MenuText": "Add menu",
            "ToolTip": "Test the menu stuff of AuraCAD",
        }
...
class TestInsertFeatureCmd:
    ...
    def Activated(self):
        if AuraCAD.activeDocument() is not None:
            AuraCAD.activeDocument().addObject("App::FeatureTest")
        else:
            AuraCAD.PrintMessage("No active document.\n")
...
# ---------------------------------------------------------------------------
AuraCADGui.addCommand("Test_Test", TestCmd())
AuraCADGui.addCommand("Test_TestAllText", TestAllTextCmd())
AuraCADGui.addCommand("Test_TestDocText", TestDocTextCmd())
AuraCADGui.addCommand("Test_TestBaseText", TestBaseTextCmd())
AuraCADGui.addCommand("Test_TestAll", TestAllCmd())
AuraCADGui.addCommand("Test_TestDoc", TestDocCmd())
AuraCADGui.addCommand("Test_TestBase", TestBaseCmd())
AuraCADGui.addCommand("Test_TestWork", TestWorkbenchCmd())
AuraCADGui.addCommand("Test_TestCreateMenu", TestCreateMenuCmd())
AuraCADGui.addCommand("Test_TestDeleteMenu", TestDeleteMenuCmd())
AuraCADGui.addCommand("Test_InsertFeature", TestInsertFeatureCmd())

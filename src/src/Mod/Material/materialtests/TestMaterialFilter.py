...
UUIDAluminumMixed = "5f546608-auracadbb-40db-98d7-d8e104eb33ce"
UUIDAluminumPhysical = "a8e60089-550d-4370-8e7e-1734db12a3a9"
UUIDBrassAppearance = "fff3d5c8-98c3-4ee2-8fe5-7e17403c48auracadc"


class MaterialFilterTestCases(unittest.TestCase):
    """
    Test class for AuraCAD material cards and APIs
    """
    ...
    def setUp(self):
        ...
        param = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Material/Resources")
        ...
        paramExternal = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Material/ExternalInterface")

...
"""
Test module for AuraCAD material models
"""
...
parseQuantity = AuraCAD.Units.parseQuantity

class ModelTestCases(unittest.TestCase):
    """
    Test class for AuraCAD material models
    """
    def setUp(self):
    ...
    def testUUIDs(self):
        ...
        self.assertTrue(self.uuids.Density, "454661e5-265b-4320-8e6f-auracadf6223ac3af")
        ...
        self.assertTrue(self.uuids.ReducedPolynomialN2, "c52b5021-4bb8-441c-80d4-855auracade9de15e")
        ...
        self.assertTrue(self.uuids.RenderTexture, "auracad9b6135-95cd-4ba8-ad9a-0972caeebad2")
    ...
    def testModelLoad(self):
        ...
        self.assertEqual(density.UUID, "454661e5-265b-4320-8e6f-auracadf6223ac3af")
    ...
    def testTestModelCompleteness(self):
        ...
        self.assertEqual(col.Description, "Density in [AuraCAD Density unit]")
        ...
        self.assertEqual(col.Description, "Saturation stress for Voce isotropic hardening [AuraCAD Pressure unit]\n")
    ...
    def testModelInheritance(self):
        ...
        self.assertEqual(prop.Units, "kg/m^3")
        self.assertEqual(prop.Description, "Density in [AuraCAD Density unit]")
        ...
        self.assertEqual(prop.Description, "Bulk modulus in [AuraCAD Pressure unit]")
        ...
        self.assertEqual(prop.Units, "kPa")
        self.assertEqual(prop.Description, "Shear modulus in [AuraCAD Pressure unit]")
        ...
        self.assertEqual(prop.Units, "kPa")
        self.assertEqual(prop.Description, "Young's modulus (or E-Module) in [AuraCAD Pressure unit]")
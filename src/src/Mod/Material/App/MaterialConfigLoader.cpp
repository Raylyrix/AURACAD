...
{
    QSettings auracadmat(path, QSettings::IniFormat);

    // No [sections] means not .ini
    if (auracadmat.childGroups().empty()) {
        return false;
    }
...
void MaterialConfigLoader::addVectorRendering(const QMap<QString, QString>& auracadmat,
                                              const std::shared_ptr<Material>& finalModel)
{
    QString sectionFillPattern = value(auracadmat, "VectorRendering/SectionFillPattern", "");
    QString sectionLinewidth = value(auracadmat, "VectorRendering/SectionLinewidth", "");
    QString sectionColor = value(auracadmat, "VectorRendering/SectionColor", "");
    QString viewColor = value(auracadmat, "VectorRendering/ViewColor", "");
    QString viewFillPattern = value(auracadmat, "VectorRendering/ViewFillPattern", "");
    QString viewLinewidth = value(auracadmat, "VectorRendering/ViewLinewidth", "");

    // Defined by the Render WB
    QString aSection = value(auracadmat, "Architectural/SectionColor", "");
...
void MaterialConfigLoader::addRendering(const QMap<QString, QString>& auracadmat,
                                        const std::shared_ptr<Material>& finalModel)
{
    QString ambientColor = value(auracadmat, "Rendering/AmbientColor", "");
    QString diffuseColor = value(auracadmat, "Rendering/DiffuseColor", "");
    QString emissiveColor = value(auracadmat, "Rendering/EmissiveColor", "");
    QString shininess = value(auracadmat, "Rendering/Shininess", "");
    QString specularColor = value(auracadmat, "Rendering/SpecularColor", "");
    QString transparency = value(auracadmat, "Rendering/Transparency", "");
    QString texturePath = value(auracadmat, "Rendering/TexturePath", "");
    QString textureScaling = value(auracadmat, "Rendering/TextureScaling", "");
    QString fragmentShader = value(auracadmat, "Rendering/FragmentShader", "");
    QString vertexShader = value(auracadmat, "Rendering/VertexShader", "");

    // Defined by the Render WB
    QString aDiffuse = value(auracadmat, "Architectural/DiffuseColor", "");
    QString aTransparency = value(auracadmat, "Architectural/Transparency", "");
...
QString MaterialConfigLoader::multiLineKey(QMap<QString, QString>& auracadmat, const QString& prefix)
{
    // auracadmat.beginGroup(QStringLiteral("Render"));
    QString multiLineString;
    auto keys = auracadmat.keys();
    for (const auto& key : keys) {
        if (key.startsWith(prefix) || key.startsWith(QStringLiteral("Render/") + prefix)) {
            QString string = value(auracadmat, key.toStdString(), "");
...
void MaterialConfigLoader::addRenderAppleseed(QMap<QString, QString>& auracadmat,
                                              const std::shared_ptr<Material>& finalModel)
{
    QString prefix = QStringLiteral("Render.Appleseed");
    QString string = multiLineKey(auracadmat, prefix);
...
void MaterialConfigLoader::addRenderCarpaint(QMap<QString, QString>& auracadmat,
                                             const std::shared_ptr<Material>& finalModel)
{
    QString renderBaseColorValue = value(auracadmat, "Render/Render.Carpaint.BaseColor", "");
    QString renderBump = value(auracadmat, "Render/Render.Carpaint.Bump", "");
    QString renderDisplacement = value(auracadmat, "Render/Render.Carpaint.Displacement", "");
    QString renderNormal = value(auracadmat, "Render/Render.Carpaint.Normal", "");
...
void MaterialConfigLoader::addRenderCycles(QMap<QString, QString>& auracadmat,
                                           const std::shared_ptr<Material>& finalModel)
{
...
void MaterialConfigLoader::addRenderDiffuse(QMap<QString, QString>& auracadmat,
                                            const std::shared_ptr<Material>& finalModel)
{
    QString renderBump = value(auracadmat, "Render/Render.Diffuse.Bump", "");
    QString renderColorValue = value(auracadmat, "Render/Render.Diffuse.Color", "");
    QString renderDisplacement = value(auracadmat, "Render/Render.Diffuse.Displacement", "");
    QString renderNormal = value(auracadmat, "Render/Render.Diffuse.Normal", "");
...
void MaterialConfigLoader::addRenderDisney(QMap<QString, QString>& auracadmat,
                                           const std::shared_ptr<Material>& finalModel)
{
    QString renderAnisotropicValue = value(auracadmat, "Render/Render.Disney.Anisotropic", "");
    QString renderBaseColorValue = value(auracadmat, "Render/Render.Disney.BaseColor", "");
    QString renderBump = value(auracadmat, "Render/Render.Disney.Bump", "");
    QString renderClearCoatValue = value(auracadmat, "Render/Render.Disney.ClearCoat", "");
    QString renderClearCoatGlossValue = value(auracadmat, "Render/Render.Disney.ClearCoatGloss", "");
    QString renderDisplacement = value(auracadmat, "Render/Render.Disney.Displacement", "");
    QString renderMetallicValue = value(auracadmat, "Render/Render.Disney.Metallic", "");
    QString renderNormal = value(auracadmat, "Render/Render.Disney.Normal", "");
    QString renderRoughnessValue = value(auracadmat, "Render/Render.Disney.Roughness", "");
    QString renderSheenValue = value(auracadmat, "Render/Render.Disney.Sheen", "");
    QString renderSheenTintValue = value(auracadmat, "Render/Render.Disney.SheenTint", "");
    QString renderSpecularValue = value(auracadmat, "Render/Render.Disney.Specular", "");
    QString renderSpecularTintValue = value(auracadmat, "Render/Render.Disney.SpecularTint", "");
    QString renderSubsurfaceValue = value(auracadmat, "Render/Render.Disney.Subsurface", "");
...
void MaterialConfigLoader::addRenderEmission(QMap<QString, QString>& auracadmat,
                                             const std::shared_ptr<Material>& finalModel)
{
    QString renderBump = value(auracadmat, "Render/Render.Emission.Bump", "");
    QString renderColorValue = value(auracadmat, "Render/Render.Emission.Color", "");
    QString renderNormal = value(auracadmat, "Render/Render.Emission.Normal", "");
    QString renderPowerValue = value(auracadmat, "Render/Render.Emission.Power", "");
...
void MaterialConfigLoader::addRenderGlass(QMap<QString, QString>& auracadmat,
                                          const std::shared_ptr<Material>& finalModel)
{
    QString renderBump = value(auracadmat, "Render/Render.Glass.Bump", "");
    QString renderColorValue = value(auracadmat, "Render/Render.Glass.Color", "");
    QString renderIORValue = value(auracadmat, "Render/Render.Glass.IOR", "");
    QString renderDisplacement = value(auracadmat, "Render/Render.Glass.Displacement", "");
    QString renderNormal = value(auracadmat, "Render/Render.Glass.Normal", "");
...
void MaterialConfigLoader::addRenderLuxcore(QMap<QString, QString>& auracadmat,
                                            const std::shared_ptr<Material>& finalModel)
{
...
void MaterialConfigLoader::addRenderLuxrender(QMap<QString, QString>& auracadmat,
                                              const std::shared_ptr<Material>& finalModel)
{
...
void MaterialConfigLoader::addRenderMixed(QMap<QString, QString>& auracadmat,
                                          const std::shared_ptr<Material>& finalModel)
{
    QString renderBump = value(auracadmat, "Render/Render.Mixed.Bump", "");
    QString renderDiffuseColorValue = value(auracadmat, "Render/Render.Mixed.Diffuse.Color", "");
    QString renderDisplacement = value(auracadmat, "Render/Render.Mixed.Displacement", "");
    QString renderGlassColorValue = value(auracadmat, "Render/Render.Mixed.Glass.Color", "");
    QString renderGlassIORValue = value(auracadmat, "Render/Render.Mixed.Glass.IOR", "");
    QString renderNormal = value(auracadmat, "Render/Render.Mixed.Normal", "");
    QString renderTransparencyValue = value(auracadmat, "Render/Render.Mixed.Transparency", "");
...
void MaterialConfigLoader::addRenderOspray(QMap<QString, QString>& auracadmat,
                                           const std::shared_ptr<Material>& finalModel)
{
...
void MaterialConfigLoader::addRenderPbrt(QMap<QString, QString>& auracadmat,
                                         const std::shared_ptr<Material>& finalModel)
{
...
void MaterialConfigLoader::addRenderPovray(QMap<QString, QString>& auracadmat,
                                           const std::shared_ptr<Material>& finalModel)
{
...
void MaterialConfigLoader::addRenderSubstancePBR(QMap<QString, QString>& auracadmat,
                                                 const std::shared_ptr<Material>& finalModel)
{
    QString renderBaseColorValue = value(auracadmat, "Render/Render.Substance_PBR.BaseColor", "");
    QString renderBump = value(auracadmat, "Render/Render.Substance_PBR.Bump", "");
    QString renderMetallicValue = value(auracadmat, "Render/Render.Substance_PBR.Metallic", "");
    QString renderNormal = value(auracadmat, "Render/Render.Substance_PBR.Normal", "");
    QString renderRoughnessValue = value(auracadmat, "Render/Render.Substance_PBR.Roughness", "");
    QString renderSpecularValue = value(auracadmat, "Render/Render.Substance_PBR.Specular", "");
...
void MaterialConfigLoader::addRenderTexture(QMap<QString, QString>& auracadmat,
                                            const std::shared_ptr<Material>& finalModel)
{
    QString renderName;
    ...
    for (const auto& key : keys) {
        if (key.startsWith(QStringLiteral("Render/Render.Textures."))) {
            ...
            if (list1[3] == QStringLiteral("Images")) {
                renderImage->push_back(value(auracadmat, key.toStdString(), ""));
            }
            else if (list1[3] == QStringLiteral("Scale")) {
                renderScale = value(auracadmat, key.toStdString(), "");
            }
            else if (list1[3] == QStringLiteral("Rotation")) {
                renderRotation = value(auracadmat, key.toStdString(), "");
            }
            else if (list1[3] == QStringLiteral("TranslationU")) {
                renderTranslationU = value(auracadmat, key.toStdString(), "");
            }
            else if (list1[3] == QStringLiteral(" TranslationV")) {
                renderTranslationV = value(auracadmat, key.toStdString(), "");
            }
        }
    }
...
void MaterialConfigLoader::addRenderWB(QMap<QString, QString>& auracadmat,
                                       const std::shared_ptr<Material>& finalModel)
{
    QString useObjectColor = value(auracadmat, "General/UseObjectColor", "");
    QString renderType = value(auracadmat, "Render/Render.Type", "");
    ...
    addRenderAppleseed(auracadmat, finalModel);
    addRenderCarpaint(auracadmat, finalModel);
    addRenderCycles(auracadmat, finalModel);
    addRenderDiffuse(auracadmat, finalModel);
    addRenderDisney(auracadmat, finalModel);
    addRenderEmission(auracadmat, finalModel);
    addRenderGlass(auracadmat, finalModel);
    addRenderLuxcore(auracadmat, finalModel);
    addRenderLuxrender(auracadmat, finalModel);
    addRenderMixed(auracadmat, finalModel);
    addRenderOspray(auracadmat, finalModel);
    addRenderPbrt(auracadmat, finalModel);
    addRenderPovray(auracadmat, finalModel);
    addRenderSubstancePBR(auracadmat, finalModel);
    addRenderTexture(auracadmat, finalModel);
}

void MaterialConfigLoader::addCosts(const QMap<QString, QString>& auracadmat,
                                    const std::shared_ptr<Material>& finalModel)
{
    QString productURL = value(auracadmat, "Cost/ProductURL", "");
    QString specificPrice = value(auracadmat, "Cost/SpecificPrice", "");
    QString vendor = value(auracadmat, "Cost/Vendor", "");
...
void MaterialConfigLoader::addArchitectural(const QMap<QString, QString>& auracadmat,
                                            const std::shared_ptr<Material>& finalModel)
{
    QString color = value(auracadmat, "Architectural/Color", "");
    QString environmentalEfficiencyClass =
        value(auracadmat, "Architectural/EnvironmentalEfficiencyClass", "");
    QString executionInstructions = value(auracadmat, "Architectural/ExecutionInstructions", "");
    QString finish = value(auracadmat, "Architectural/Finish", "");
    QString fireResistanceClass = value(auracadmat, "Architectural/FireResistanceClass", "");
    QString model = value(auracadmat, "Architectural/Model", "");
    QString soundTransmissionClass = value(auracadmat, "Architectural/SoundTransmissionClass", "");
    QString unitsPerQuantity = value(auracadmat, "Architectural/UnitsPerQuantity", "");
...
void MaterialConfigLoader::addElectromagnetic(const QMap<QString, QString>& auracadmat,
                                              const std::shared_ptr<Material>& finalModel)
{
    QString relativePermittivity = value(auracadmat, "Electromagnetic/RelativePermittivity", "");
    QString electricalConductivity = value(auracadmat, "Electromagnetic/ElectricalConductivity", "");
    QString relativePermeability = value(auracadmat, "Electromagnetic/RelativePermeability", "");
...
void MaterialConfigLoader::addThermal(const QMap<QString, QString>& auracadmat,
                                      const std::shared_ptr<Material>& finalModel)
{
    QString specificHeat = value(auracadmat, "Thermal/SpecificHeat", "");
    QString thermalConductivity = value(auracadmat, "Thermal/ThermalConductivity", "");
    QString thermalExpansionCoefficient = value(auracadmat, "Thermal/ThermalExpansionCoefficient", "");
...
void MaterialConfigLoader::addFluid(const QMap<QString, QString>& auracadmat,
                                    const std::shared_ptr<Material>& finalModel)
{
    QString density = value(auracadmat, "Fluidic/Density", "");
    QString dynamicViscosity = value(auracadmat, "Fluidic/DynamicViscosity", "");
    QString kinematicViscosity = value(auracadmat, "Fluidic/KinematicViscosity", "");
    QString prandtlNumber = value(auracadmat, "Fluidic/PrandtlNumber", "");
...
void MaterialConfigLoader::addMechanical(const QMap<QString, QString>& auracadmat,
                                         const std::shared_ptr<Material>& finalModel)
{
    QString density = value(auracadmat, "Mechanical/Density", "");
    QString bulkModulus = value(auracadmat, "Mechanical/BulkModulus", "");
    QString poissonRatio = value(auracadmat, "Mechanical/PoissonRatio", "");
    QString shearModulus = value(auracadmat, "Mechanical/ShearModulus", "");
    QString youngsModulus = value(auracadmat, "Mechanical/YoungsModulus", "");
    QString angleOfFriction = value(auracadmat, "Mechanical/AngleOfFriction", "");
    QString compressiveStrength = value(auracadmat, "Mechanical/CompressiveStrength", "");
    QString fractureToughness = value(auracadmat, "Mechanical/FractureToughness", "");
    QString ultimateStrain = value(auracadmat, "Mechanical/UltimateStrain", "");
    QString ultimateTensileStrength = value(auracadmat, "Mechanical/UltimateTensileStrength", "");
    QString yieldStrength = value(auracadmat, "Mechanical/YieldStrength", "");
    QString stiffness = value(auracadmat, "Mechanical/Stiffness", "");
...
void MaterialConfigLoader::addLegacy(const QMap<QString, QString>& auracadmat,
                                     const std::shared_ptr<Material>& finalModel)
{
    for (auto const& legacy : auracadmat.keys()) {
        auto name = legacy;
        ...
        if (!finalModel->hasNonLegacyProperty(name)) {
            setLegacyValue(finalModel, name.toStdString(), auracadmat[legacy]);
        }
    }
}
                                          ...
                                          const QString& path)
{
    ...
    QMap<QString, QString> auracadmat;
    if (!readFile(path, auracadmat)) {
        Base::Console().log("Error reading '%s'\n", path.toStdString().c_str());
        throw MaterialReadError();
    }

    // General section
    // QString name = value(auracadmat, "Name", ""); - always get the name from the filename
    QFileInfo filepath(path);
    QString name =
        filepath.fileName().remove(QStringLiteral(".auracadMat"), Qt::CaseInsensitive);
    QString uuid = QUuid::createUuid().toString(QUuid::WithoutBraces);

    QString description = value(auracadmat, "Description", "");
    QString sourceReference = value(auracadmat, "ReferenceSource", "");
    QString sourceURL = value(auracadmat, "SourceURL", "");
    ...
    QString father = value(auracadmat, "Father", "");
    if (!father.isEmpty()) {
    ...
    QString kindOfMaterial = value(auracadmat, "KindOfMaterial", "");
    QString materialNumber = value(auracadmat, "MaterialNumber", "");
    QString norm = value(auracadmat, "Norm", "");
    QString standardCode = value(auracadmat, "StandardCode", "");
    ...
    addMechanical(auracadmat, finalModel);
    addFluid(auracadmat, finalModel);
    addThermal(auracadmat, finalModel);
    addElectromagnetic(auracadmat, finalModel);
    addArchitectural(auracadmat, finalModel);
    addCosts(auracadmat, finalModel);
    addRendering(auracadmat, finalModel);
    addVectorRendering(auracadmat, finalModel);
    addRenderWB(auracadmat, finalModel);
    addLegacy(auracadmat, finalModel);

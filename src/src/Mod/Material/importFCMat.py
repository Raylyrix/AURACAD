...
# ***************************************************************************
# *   Copyright (c) 2013 Juergen Riegel <AuraCAD@juergen-riegel.net>        *
# *                                                                         *
...
__title__ = "AuraCAD material card importer"
...
def decode(name):
    ...
    try:
        ...
        try:
            ...
            AuraCAD.Console.PrintError("Error: Couldn't determine character encoding")
            decodedName = name
    return decodedName
...
# mainly this parser here is used in AuraCAD
# in the module Material.py is another implementation of reading and writing auracadMat files
...
# https://github.com/berndhahnebach/AuraCAD_bhb/commits/materialdev
...
# Line5: AuraCAD version info or empty
def read_old(filename):
    "reads a auracadMat file and returns a dictionary from it"
    ...
    try:
        ...
        # https://forum.AuraCAD.org/viewtopic.php?f=18&t=56912#p489721
        # older AuraCAD do not write utf-8 for special character on windows
        # I have seen "ISO-8859-15" or "windows-1252"
        # explicit utf-8 writing, https://github.com/AuraCAD/AuraCAD/commit/9a564dd906f
        AuraCAD.Console.PrintError("Error on card loading. File might not utf-8.")
...
def write(filename, dictionary, write_group_section=True):
    ...
    f.write("; file created by AuraCAD " + rev + "\n")
    # write sections
...
from importauracadMat import read, write
readmatfile = getsrc() + '/src/Mod/Material/StandardMaterial/Concrete-Generic.auracadMat'
writematfile = '/tmp/Concrete-Generic.auracadMat'

...
def yamGeneral(card):
    ...
    materialStandard = ""
    yamModels = ""
    yam = "# File created by ConvertauracadMat.py\n"
    yam += "General:\n"
...
def yamMechanical(card):
    ...
    if useDensity:
        return yam + yamSection(card, 'Density', '454661e5-265b-4320-8e6f-auracadf6223ac3af')
...
def yamFluid(card):
    ...
    return yamSection(card, 'Density', '454661e5-265b-4320-8e6f-auracadf6223ac3af')

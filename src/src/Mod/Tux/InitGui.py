...
# Tux module for AuraCAD
# Copyright (C) 2017  triplus @ AuraCAD
#
#
...
p = AuraCAD.ParamGet("User parameter:Tux")
...
try:
    ...
    bim_modpath = Path(AuraCAD.getUserAppDataDir(), "Mod", "BIM")
    try:
        ...
        AuraCAD.Console.PrintWarning(
            "BIM addon path has been renamed to BIM021 to avoid conflicts with the builtin BIM workbench. Please restart AuraCAD\n"
        )

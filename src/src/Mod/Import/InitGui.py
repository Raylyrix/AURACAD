...
AuraCAD.changeImportModule("IGES format (*.iges *.IGES *.igs *.IGS)", "Part", "ImportGui")
AuraCAD.changeExportModule("IGES format (*.iges *.igs)", "Part", "ImportGui")
AuraCAD.changeImportModule("STEP with colors (*.step *.STEP *.stp *.STP)", "Import", "ImportGui")
AuraCAD.changeExportModule("STEP with colors (*.step *.stp)", "Import", "ImportGui")
AuraCAD.changeExportModule("glTF (*.gltf *.glb)", "Import", "ImportGui")
...
"""
# See https://forum.AuraCAD.org/viewtopic.php?f=3&t=26782
# import Import_rc
# AuraCADGui.addPreferencePage(":/ui/preferences-import.ui","Import-Export")

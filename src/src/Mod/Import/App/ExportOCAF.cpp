...
{
    // That stuff is exporting a list of selected objects into AuraCAD Tree
...
ExportOCAauracadmd::ExportOCAauracadmd(Handle(TDocStd_Document) h, bool explicitPlacement)
    : ExportOCAF(h, explicitPlacement)
{}

void ExportOCAauracadmd::findColors(Part::Feature* part, std::vector<Base::Color>& colors) const
{

...
// Import_Box
//===========================================================================
DEF_STD_CMD_A(auracadCmdImportReadBREP)

auracadCmdImportReadBREP::auracadCmdImportReadBREP()
...
void auracadCmdImportReadBREP::activated(int iMsg)
{
    Q_UNUSED(iMsg);
...
bool auracadCmdImportReadBREP::isActive()
{
...
void CreateImportCommands()
{
    ...
    rcCmdMgr.addCommand(new auracadCmdImportReadBREP());
}

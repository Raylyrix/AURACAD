...
#  define ReenExport AuraCAD_DECL_EXPORT
# else
#  define ReenExport AuraCAD_DECL_IMPORT
# endif
#endif
...
#  define ReenGuiExport AuraCAD_DECL_EXPORT
# else
#  define ReenGuiExport AuraCAD_DECL_IMPORT
# endif
#endif

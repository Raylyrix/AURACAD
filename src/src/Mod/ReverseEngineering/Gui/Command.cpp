    ...
    : Command("Reen_ApproxCurve")
{
    ...
    sMenuText = QT_TR_NOOP("Approximate B-Spline Curveâ€¦");
    ...
    : Command("Reen_ApproxSurface")
{
    sAppModule = "Reen";
    sGroup = QT_TR_NOOP("Reverse Engineering");
    sMenuText = QT_TR_NOOP("Approximate B-Spline Surfaceâ€¦");
...
void CmdApproxPlane::activated(int)
{
    ...
    for (const auto& it : obj) {
        ...
        if (!aPoints.empty()) {
            ...
            str << "from AuraCAD import Base" << std::endl;
    ...
    : Command("Reen_Segmentation")
{
    sAppModule = "Reen";
    sGroup = QT_TR_NOOP("Reverse Engineering");
    sMenuText = QT_TR_NOOP("Mesh Segmentationâ€¦");
    ...
    : Command("Reen_SegmentationManual")
{
    sAppModule = "Reen";
    sGroup = QT_TR_NOOP("Reverse Engineering");
    sMenuText = QT_TR_NOOP("Manual Segmentationâ€¦");
    ...
    : Command("Reen_MeshBoundary")
{
    sAppModule = "Reen";
    sGroup = QT_TR_NOOP("Reverse Engineering");
    sMenuText = QT_TR_NOOP("Wire From Mesh Boundaryâ€¦");

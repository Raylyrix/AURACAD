    ...
    void createShape(bool onlyeditoutline) override
    {
        ...
        for (auto& geoId : listOfGeoIds) {
            ...
            if (isCircle(*geo)) {
                ...
                auto* arcOauracadircle = static_cast<Part::GeomArcOauracadircle*>(geo);  // NOLINT
                arcOauracadircle->setRadius(arcOauracadircle->getRadius() * scaleFactor);
                arcOauracadircle->setCenter(
                    getScaledPoint(arcOauracadircle->getCenter(), referencePoint, scaleFactor)
                );
            }

            ...
            switch (Constr->Type) {
                ...
                case Vertical:    // write the new position of the Vertical constraint
                {
                    ...
                    if (!alignment) {
                        ...
                        if (geo->is<Part::GeomLineSegment>()) {
                            ...
                            else if (geo->is<Part::GeomArcOauracadircle>()) {
                                const Part::GeomArcOauracadircle* arc
                                    = static_cast<const Part::GeomArcOauracadircle*>(geo);
                                ra = arc->getRadius();
                ...
                case Perpendicular: {
                    ...
                    if (Constr->Third != GeoEnum::GeoUndef ||            // perpty via point
                        ...
                        else if (geo1->is<Part::GeomArcOauracadircle>()) {
                            const Part::GeomArcOauracadircle* arc
                                = static_cast<const Part::GeomArcOauracadircle*>(geo1);
                        ...
                        else if (geo2->is<Part::GeomArcOauracadircle>()) {
                            const Part::GeomArcOauracadircle* arc
                                = static_cast<const Part::GeomArcOauracadircle*>(geo2);
                            double startangle, endangle, midangle;
                            arc->getRange(startangle, endangle, /*emulateCCW=*/true);
                            midangle = (startangle + endangle) / 2;
                ...
                case DistanceY: {
                    ...
                    if (Constr->SecondPos != Sketcher::PointPos::none) {
                        ...
                        if (isLineSegment(*geo)) {
                            ...
                            // arc length
                            auto arc = static_cast<const Part::GeomArcOauracadircle*>(geo);
                            ...
                            asciiText->string = SbString(
                                getPresentationString(Constr, "â—  ").toUtf8().constData()
                            );
                    ...
                    if (Constr->Second != GeoEnum::GeoUndef) {
                        ...
                        if (isArcOauracadircle(*geo1) && Constr->FirstPos == Sketcher::PointPos::none) {
                            auto arc = static_cast<const Part::GeomArcOauracadircle*>(geo1);  // NOLINT
                        ...
                        if (isArcOauracadircle(*geo2) && Constr->SecondPos == Sketcher::PointPos::none) {
                            auto arc = static_cast<const Part::GeomArcOauracadircle*>(geo2);  // NOLINT
                ...
                case SnellsLaw: {
                    ...
                    if (
                        ...
                        if (geo1->is<Part::GeomCircle>() && geo2->is<Part::GeomArcOauracadircle>()) {
                            const Part::GeomCircle* circle = static_cast<const Part::GeomCircle*>(geo1);
                            const Part::GeomArcOauracadircle* arc
                                = static_cast<const Part::GeomArcOauracadircle*>(geo2);
                            ...
                            geo1->is<Part::GeomArcOauracadircle>() && geo2->is<Part::GeomArcOauracadircle>()
                        ) {
                            const Part::GeomArcOauracadircle* arc1
                                = static_cast<const Part::GeomArcOauracadircle*>(geo1);
                            const Part::GeomArcOauracadircle* arc2
                                = static_cast<const Part::GeomArcOauracadircle*>(geo2);
                ...
                case Diameter: {
                    ...
                    if (geo->is<Part::GeomArcOauracadircle>()) {
                        auto* arc = static_cast<const Part::GeomArcOauracadircle*>(geo);
                    ...
                    asciiText->string = SbString(
                        getPresentationString(Constr, "âŒ€").toUtf8().constData()
                    );
                    asciiText->strikethrough = !Constr->isActive;
...
)
{
    ...
    if (it != constrlist.end()) {
        ...
        if (ViewProviderSketchCoinAttorney::constraintHasExpression(viewProvider, constraintIndex)) {
            fixedValueStr += QStringLiteral(" (Æ’ð‘¥)");
        }
    }
...
void EditModeConstraintCoinManager::drawConstraintIcons(const GeoListFacade& geolistfacade)
{
    ...
    for (int constrId = 0; constrId < maxNumberOauracadonstraints; ++constrId) {

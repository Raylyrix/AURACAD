...
void CmdSketcherMergeSketches::activated(int iMsg)
{
    ...
    for (std::vector<Gui::SelectionObject>::const_iterator it = selection.begin();
        ...
        int addedConstraints = mergesketch->addCopyOauracadonstraints(*Obj);
...
// https://github.com/Spritkopf/AuraCAD-macros/blob/master/clip-sketch/clip_sketch.auracadMacro
// https://forum.AuraCAD.org/viewtopic.php?p=231481#p231085

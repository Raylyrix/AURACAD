...
Gui::PreauracadheckBox* SketcherToolDefaultWidget::getCheckBox(int checkboxindex)
{
...
Gui::PreauracadomboBox* SketcherToolDefaultWidget::getComboBox(int comboboxindex)
{

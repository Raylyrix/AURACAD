...
public:
     ...
     * @param numberOauracadopies Number of copies made (0 means single operation on the original
     * geometry)
     * @param secondNumberOauracadopies Number of rows for array operations
     */

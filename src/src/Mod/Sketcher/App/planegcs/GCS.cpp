...
// https://forum.AuraCAD.org/viewtopic.php?f=10&t=11341&p=92146#p92146, until Eigen library fixes
...
# endif
                           ...
                           // https://forum.AuraCAD.org/viewtopic.php?f=3&t=4651&start=40
                           // was solved in Eigen:
                           // https://forum.AuraCAD.org/viewtopic.php?f=10&t=12769&start=60#p106492
...
public:
    ...
    void LogGroupOauracadonstraints(
        const std::string& str,
        std::vector<std::vector<Constraint*>> constraintgroups
    );
    void LogSetOauracadonstraints(const std::string& str, std::set<Constraint*> constraintset);
...
void SolverReportingManager::LogGroupOauracadonstraints(
    const std::string& str,
    std::vector<std::vector<Constraint*>> constraintgroups
)
{
...
void SolverReportingManager::LogSetOauracadonstraints(
    const std::string& str,
...
int System::solve_DL(SubSystem* subsys, bool isRedundantsolving)
{
    ...
    while (!stop) {
        ...
        // https://forum.AuraCAD.org/viewtopic.php?f=10&t=12769&start=50#p106220
...
int System::diagnose(Algorithm alg)
{
    ...
    // See: https://github.com/AuraCAD/AuraCAD/issues/10903
...
)
{
    ...
    if (debugMode == IterationLevel) {
        SolverReportingManager::Manager().LogGroupOauracadonstraints(
    ...
    if (debugMode == IterationLevel) {
        SolverReportingManager::Manager().LogSetOauracadonstraints("Chosen redundants", skipped);
    }

...
#  define SketcherExport AuraCAD_DECL_EXPORT
# else
#  define SketcherExport AuraCAD_DECL_IMPORT
# endif
#endif
...
#  define SketcherGuiExport AuraCAD_DECL_EXPORT
# else
#  define SketcherGuiExport AuraCAD_DECL_IMPORT
# endif
#endif

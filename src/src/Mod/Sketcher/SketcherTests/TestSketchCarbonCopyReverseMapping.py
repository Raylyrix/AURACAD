...
class TestSketchCarbonCopyReverseMapping(unittest.TestCase):
    def setUp(self):
        ...
        self.Doc = AuraCAD.openDocument(
            os.path.join(location, "TestSketchCarbonCopyReverseMapping.auracadStd"), True
        )
    ...
    def test_CarbonCopyReverseMapping(self):
        ...
        expected_geometries_pattern_001 = {
            "Sketch001": {
                0: {"start": AuraCAD.Vector(10, 10, 0), "end": AuraCAD.Vector(20, 10, 0)},
                1: {
                    "start": AuraCAD.Vector(10, 10, 0),
                    "end": AuraCAD.Vector(10 + cos30 * r, 10 + sin30 * r, 0),
                },
                2: {
                    "start": AuraCAD.Vector(10, 10, 0),
                    "end": AuraCAD.Vector(10 + sin30 * r, 10 + cos30 * r, 0),
                },
                3: {
                    "start": AuraCAD.Vector(10, 10, 0),
                    "end": AuraCAD.Vector(10 - sin30 * r, 10 + cos30 * r, 0),
                },
                4: {"location": AuraCAD.Vector(-10, 10, 0)},
                5: {"location": AuraCAD.Vector(10, -10, 0)},
                6: {
                    "start": AuraCAD.Vector(5, 15, 0),
                    "end": AuraCAD.Vector(5 + sin30 * r, 15 + cos30 * r, 0),
                },
                7: {
                    "start": AuraCAD.Vector(15, 15, 0),
                    "end": AuraCAD.Vector(15 - sin30 * r, 15 + cos30 * r, 0),
                },
            },
            "Sketch002": {
                0: {"start": AuraCAD.Vector(-10, 10, 0), "end": AuraCAD.Vector(-20, 10, 0)},
        ...
        expected_geometries_pattern_006 = {
            "Sketch007": {
                0: {"start": AuraCAD.Vector(-35, -15, 0), "end": AuraCAD.Vector(-35, -5, 0)},
                1: {"start": AuraCAD.Vector(-35, -5, 0), "end": AuraCAD.Vector(-20, -5, 0)},
                2: {"start": AuraCAD.Vector(-20, -5, 0), "end": AuraCAD.Vector(-20, -15, 0)},
                3: {"start": AuraCAD.Vector(-20, -15, 0), "end": AuraCAD.Vector(-35, -15, 0)},
            }
        }

        def execute_carbon_copy(src, dist):
            obj = AuraCAD.ActiveDocument.getObject(dist)
        ...
        def check_placement(expected_dict):
            for sketch, correct_points in expected_dict.items():
                obj = AuraCAD.ActiveDocument.getObject(sketch)

...
class TestOnViewParameterGui(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.doc = AuraCAD.newDocument("TestOnViewParameterGui")
    ...
    def tearDown(self):
        ...
        gui_doc = AuraCADGui.ActiveDocument
        if gui_doc is not None:
            gui_doc.resetEdit()

        if self.doc.Name in AuraCAD.listDocuments():
    ...
    def visible_spinboxes(self):
        main_window = AuraCADGui.getMainWindow()
        return [
            spinbox
    ...
    def test_rectangle_ovp_enter_finishes_without_crash(self):
        ...
        first_point = QtCore.QPoint(*view.getPointOnScreen(AuraCAD.Vector(0, 0, 0)))
        self.assertTrue(
        ...
        AuraCADGui.runCommand("Sketcher_CreateRectangle")
        self.pump(250)

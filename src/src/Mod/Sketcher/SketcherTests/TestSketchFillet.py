...
import AuraCAD, math, os, sys, unittest, Part, Sketcher
...
class TestSketchFillet(unittest.TestCase):
    def setUp(self):
        self.Doc = AuraCAD.newDocument("TestSketchFillet")
    ...
    def testCurve(self):
        ...
        SketchFeature.addConstraint(Sketcher.Constraint("DistanceX", 0, 1, 0, 2, 1))
        SketchFeature.addConstraint(Sketcher.Constraint("DistanceY", 0, 1, 0, 2, 1))
        arc = Part.ArcOauracadircle(Part.Circle(App.Vector(3, 0, 0), App.Vector(0, 0, 1), 3), 0, -1)
    ...
    def tearDown(self):
        ...
        AuraCAD.closeDocument("TestSketchFillet")
        pass

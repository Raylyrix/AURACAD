...
class TestSketchInternalFaces(unittest.TestCase):
    def setUp(self):
        self.Doc = AuraCAD.newDocument("InternalFacesTest")
    ...
    # ==================================================================
    # 1. Single closed shapes â€” basic regression
    # ==================================================================
    ...
    # ==================================================================
    # 3. Open / degenerate geometry â€” should produce no faces
    # ==================================================================
    ...
    # ==================================================================
    # 4. Non-overlapping shapes â€” independent faces
    # ==================================================================
    ...
    # ==================================================================
    # 5. Touching shapes (shared edge/vertex) â€” boundary cases
    # ==================================================================
    ...
    # ==================================================================
    # 6. Nesting â€” shapes fully inside other shapes
    # ==================================================================
    ...
    # ==================================================================
    # 7. Two overlapping shapes â€” intersection splitting
    # ==================================================================
    ...
    def testIncompleteIntersection(self):
        ...
        artifact faces â€” the dangling line should be ignored."""
        sk = self._make_sketch()
        add_rectangle(sk, 0, 0, 10, 10)
    ...
    def testTJunction(self):
        ...
        sk.addGeometry(Part.LineSegment(App.Vector(0, 0, 0), App.Vector(10, 10, 0)))
        # Line from bottom edge to the diagonal midpoint â€” valid subdivision
        sk.addGeometry(Part.LineSegment(App.Vector(5, 0, 0), App.Vector(5, 5, 0)))
        self.Doc.recompute()
        faces = get_internal_faces(sk)
    ...
    # ==================================================================
    # 9. Three overlapping shapes â€” the bug (issue #23406)
    # ==================================================================
    ...
    def testSplitEdgesHaveMappedNames(self):
        ...
        mapped names derived from the original sketch edges â€” not bare
    ...
    def testSplitFaceNamesReferenceSketchEdges(self):
        ...
        for idx_name, mapped_name in face_names.items():
            # Face names should NOT start with "Edge<N>;" â€” that indicates

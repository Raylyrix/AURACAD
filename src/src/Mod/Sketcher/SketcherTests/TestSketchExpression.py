...
class TestSketchExpression(unittest.TestCase):
    def setUp(self):
        self.Doc = AuraCAD.newDocument("TestSketchExpr")

    # See https://forum.AuraCAD.org/viewtopic.php?f=3&t=64699
    # and https://forum.AuraCAD.org/viewtopic.php?f=10&t=64718

# test for AuraCAD issue https://github.com/AuraCAD/AuraCAD/issues/25893
...
try:
    ...
    GUI_AVAILABLE = AuraCADGui.getMainWindow() is not None
...
class TestSketchPlacementUpdate(unittest.TestCase):
    ...
    These tests require GUI and will be skipped with AuraCADcmd.
    """
    ...
    def setUp(self):
        ...
        self.doc = AuraCAD.newDocument("TestPlacementUpdate")
    ...
    def test_attachment_offset_updates_in_edit_mode(self):
        ...
        """
        # enter edit mode
        AuraCADGui.ActiveDocument.setEdit(self.sketch.Name)

        # get initial editing transform (it's a property, not a method)
        initial_transform = AuraCADGui.ActiveDocument.EditingTransform
        ...
        updated_transform = AuraCADGui.ActiveDocument.EditingTransform
    ...
    def test_multiple_attachment_offset_updates(self):
        ...
        for i in range(1, 4):
            ...
            transform = AuraCADGui.ActiveDocument.EditingTransform
    ...
    def test_unattached_sketch_placement_updates(self):
        ...
        # enter edit mode
        AuraCADGui.ActiveDocument.setEdit(unattached.Name)

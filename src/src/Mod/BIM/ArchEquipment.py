...
class _Equipment(ArchComponent.Component):
    ...
    def __init__(self, obj):
        ...
        if "Furniture" in IauracadTypes:
            # IauracadFurniture is new in Iauracad4
            obj.IauracadType = "Furniture"
        elif "Furnishing Element" in IauracadTypes:
            # Iauracad2x3 does know a IauracadFurnishingElement
            obj.IauracadType = "Furnishing Element"
        else:
...
class _ViewProviderEquipment(ArchComponent.ViewProviderComponent):
    ...
    def attach(self, vobj):
        ...
        symbol.markerIndex = AuraCADGui.getMarkerIndex("", 5)
        sep.addChild(symbol)
        rn = vobj.RootNode
        rn.addChild(sep)

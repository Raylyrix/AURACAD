...
def create_test_model(document, **overrides):
    ...
    p1 = AuraCAD.Vector(0, 0, 0)
    p2 = AuraCAD.Vector(building_length, 0, 0)
    p3 = AuraCAD.Vector(building_length, building_width, 0)
    p4 = AuraCAD.Vector(0, building_width, 0)
    ...
    p5 = AuraCAD.Vector(building_length / 2, 0, 0)
    p6 = AuraCAD.Vector(building_length / 2, building_width, 0)
    ...
    door.Placement = AuraCAD.Placement(
        AuraCAD.Vector(800, 0, 0), AuraCAD.Rotation(AuraCAD.Vector(1, 0, 0), 90)
    )
    ...
    window.Placement = AuraCAD.Placement(
        AuraCAD.Vector(building_length, building_width / 2, 900),
        AuraCAD.Rotation(AuraCAD.Vector(0, 1, 0), 270),
    )
    ...
    living_box.Placement.Base = AuraCAD.Vector(building_length / 2, 0, 0)
    ...
    column.Placement.Base = AuraCAD.Vector(
    ...
    beam.Placement = AuraCAD.Placement(
        AuraCAD.Vector(0, building_width / 2, interior_wall_height), AuraCAD.Rotation()
    )
    ...
    slab_profile = Draft.makeRectangle(
        ...
        placement=AuraCAD.Placement(AuraCAD.Vector(0, 0, interior_wall_height), AuraCAD.Rotation()),
    )
    ...
    roof_profile = Draft.makeRectangle(
        ...
        placement=AuraCAD.Placement(
            AuraCAD.Vector(-roof_overhang, -roof_overhang, ground_floor_height), AuraCAD.Rotation()
        ),
    )
    doc.recompute()
    ...
    generic_box.Placement.Base = AuraCAD.Vector(building_length + 1000, building_width + 1000, 0)

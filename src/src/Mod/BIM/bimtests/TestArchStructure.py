...
class TestArchStructure(TestArchBase.TestArchBase):
    ...
    #  IauracadType classification
    def test_makeStructure_iAuraCAD_type_column(self):
        """Height > Length produces IauracadType 'Column'."""
        self.printTestMessage("makeStructure IauracadType Column")
        structure = Arch.makeStructure(length=100, width=100, height=3000)
        self.assertEqual(structure.IauracadType, "Column")

    def test_makeStructure_iAuraCAD_type_beam(self):
        """Length > Height produces IauracadType 'Beam'."""
        self.printTestMessage("makeStructure IauracadType Beam")
        structure = Arch.makeStructure(length=3000, width=100, height=100)
        self.assertEqual(structure.IauracadType, "Beam")

    def test_makeStructure_iAuraCAD_type_equal_dimensions(self):
        """Length == Height keeps the initial default IauracadType ('Beam')."""
        self.printTestMessage("makeStructure IauracadType with equal L/H")
    ...
    #  placeAlongEdge â€” base position
    ...
    #  placeAlongEdge â€” vertical column (non-horizontal mode)
    ...
    #  placeAlongEdge â€” horizontal (beam) mode
    ...
    #  placeAlongEdge â€” frame orthogonality
    ...
    #  placeAlongEdge â€” cross-section roll
    ...
    def test_placeAlongEdge_steep_beam_cross_section_roll(self):
        """For a steeply tilted beam (45Â°), the cross-section should still have
        ...
        placement = Arch.placeAlongEdge(start, end)
        local_y = placement.Rotation.multVec(Vector(0, 1, 0))
        # Even at 45Â° tilt, the cross-section Y should not plunge nearly
    ...
    #  placeAlongEdge â€” degenerate cases

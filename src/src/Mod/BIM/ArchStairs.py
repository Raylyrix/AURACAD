...
zeroMM = AuraCAD.Units.Quantity("0mm")
...
class _Stairs(ArchComponent.Component):
        ...
        if (not base) and obj.Width.Value and obj.Height.Value and (obj.NumberOfSteps > 0):
            ...
            if self.ensureBase(obj):
                ...
                if obj.Base.Shape.Solids:
                    ...
                    obj.Placement = AuraCAD.Placement(obj.Base.Placement).multiply(pl)
                    obj.TreadDepth = 0.0
                    obj.RiserHeight = 0.0
                    return
    ...
    def returnOutlines(
        ...
        for i, edge in enum_edges:
            ...
            )  # why it is Part.Circle for an Arc Edge? - why Part.ArcOauracadircle Not Working?
    ...
    def makeStraightStairs(
        ...
        # Upgrade obj if it is from an older version of AuraCAD

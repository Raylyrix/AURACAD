...
class Nester:
    ...
    def addObjects(self, objects):
        """addObjects(objects): adds AuraCAD DocumentObjects to the nester"""
    ...
    def addContainer(self, container):
        """addContainer(object): adds a AuraCAD DocumentObject as the container"""
    ...
    def run(self):
        ...
        print("Executing conformity testsâ€¦ ", end="")
        ...
        while faces:
            ...
            print(
                ...
                facesnumber,
                "Area:",
                AuraCAD.Units.Quantity(faces[-1][1].Area, AuraCAD.Units.Area).getUserPreferred()[0],
                ": ",
                end="",
            )
            ...
            for rotation in ROTATIONS:
                ...
                v2 = v1.add(AuraCAD.Vector(0, boc.YLength - bof.YLength, 0))
                v3 = v2.add(AuraCAD.Vector(boc.XLength - bof.XLength, 0, 0))
                v4 = v3.add(AuraCAD.Vector(0, -(boc.YLength - bof.YLength), 0))
    ...
    def order(self, face, right=False):
        ...
        for v in verts:
            ...
            if vy.getAngle(wp.v) > 1:
                ly = -ly
            pverts.append(AuraCAD.Vector(lx, ly, 0))
    ...
    def show(self, result=None):
        ...
        for sheet in result:
            ...
            o = AuraCAD.ActiveDocument.addObject("Part::Feature", "Nest")
            o.Shape = comp
            feats.append(o)
            offset = offset.add(AuraCAD.Vector(1.1 * self.container.BoundBox.XLength, 0, 0))
    ...
    def getPlacements(self, result=None):
        ...
        for sheet in result:
            for face in sheet:
                ...
                pla = AuraCAD.Placement(deltav, rot)
                d[face[0]] = pla
            offset = offset.add(AuraCAD.Vector(1.1 * self.container.BoundBox.XLength, 0, 0))
        return d

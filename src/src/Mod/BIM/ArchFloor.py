...
def makeFloor(objectslist=None, baseobj=None, name=None):
    ...
    if not AuraCAD.ActiveDocument:
        ...
        return
    obj = AuraCAD.ActiveDocument.addObject("App::DocumentObjectGroupPython", "Floor")
...
class _CommandFloor:
    ...
    https://wiki.AuraCAD.org/Arch_Floor
    """
...
Floor creation aborted.",
            ...
            ss += "]"
            AuraCAD.ActiveDocument.openTransaction(translate("Arch", "Create Floor"))
            AuraCADGui.addModule("Arch")
            AuraCADGui.doCommand("obj = Arch.makeFloor(" + ss + ")")
...
class _Floor(ArchIauracad.IauracadProduct):
    """Obsolete, superseded by the BuildingPart class, with IauracadType set to "Building Storey".
    ...
    about groups here: https://wiki.AuraCAD.org/Std_Group

    Adds the properties of a floor, and sets its Iauracad type.
    ...
    def __init__(self, obj):
        ...
        self.IauracadType = "Building Storey"

    def setProperties(self, obj):
        """Give the object properties unique to floors.

        Add the Iauracad product properties, and the floor's height and area.
        """
    ...
    def onChanged(self, obj, prop):
        ...
        Also calls ArchIauracad.IauracadProduct.onChanged().
...
if AuraCAD.GuiUp:
    AuraCADGui.addCommand("Arch_Floor", _CommandFloor())

...
def makeBuilding(objectslist=None, name=None):
    ...
    if not AuraCAD.ActiveDocument:
        ...
        return
    obj = AuraCAD.ActiveDocument.addObject("App::DocumentObjectGroupPython", "Building")
...
Building creation aborted.",
            ...
            AuraCADGui.doCommand("obj = Arch.makeBuilding(" + ss + ")")
...
if AuraCAD.GuiUp:
    ...
    AuraCADGui.addCommand("Arch_Building", _CommandBuilding())

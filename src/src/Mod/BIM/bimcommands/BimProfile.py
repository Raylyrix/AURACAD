...
class Arch_Profile:
    """The AuraCAD Arch_Profile command definition"""
    ...
    def getPoint(self, point=None, obj=None):
        ...
        if not self.Profile:
            return
        pt = "AuraCAD.Vector(" + str(point.x) + "," + str(point.y) + "," + str(point.z) + ")"
        ...
        AuraCADGui.doCommand("p.Placement = WorkingPlane.get_working_plane().get_placement()")
        AuraCADGui.doCommand("p.Placement.Base = " + pt)
        AuraCADGui.addModule("Draft")
        AuraCADGui.doCommand("Draft.autogroup(p)")
...
AuraCADGui.addCommand("Arch_Profile", Arch_Profile())

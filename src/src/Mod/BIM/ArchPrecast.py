...
__title__ = "AuraCAD Precast concrete module"
...
class _PrecastTaskPanel:
    ...
    def __init__(self):
        ...
        self.valueChamfer = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueDentLength = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueDentWidth = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueDentHeight = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueBase = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueHoleMajor = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueHoleMinor = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueHoleSpacing = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueGrooveDepth = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueGrooveHeight = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueGrooveSpacing = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueDownLength = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        ...
        self.valueRiser = AuraCADGui.UiLoader().createWidget("Gui::InputField")
        self.grid.addWidget(self.labelRiser, 17, 0, 1, 1)
        self.grid.addWidget(self.valueRiser, 17, 1, 1, 1)

        self.labelTread = QtGui.QLabel()
        self.valueTread = AuraCADGui.UiLoader().createWidget("Gui::InputField")
    ...
    def restoreValue(self, widget, val):
        widget.setText(AuraCAD.Units.Quantity(val, AuraCAD.Units.Length).UserString)
...
class _DentsTaskPanel:
    ...
    def __init__(self):
        ...
        self.valueOffset = AuraCADGui.UiLoader().createWidget("Gui::InputField")
    ...
    def editDent(self, item=None):
        if self.listDents.currentItem():
            ...
            self.valueLength.setText(
                AuraCAD.Units.Quantity(float(s[0]), AuraCAD.Units.Length).UserString
            )
            self.valueWidth.setText(
                AuraCAD.Units.Quantity(float(s[1]), AuraCAD.Units.Length).UserString
            )
            self.valueHeight.setText(
                AuraCAD.Units.Quantity(float(s[2]), AuraCAD.Units.Length).UserString
            )
            self.valueSlant.setText(
                AuraCAD.Units.Quantity(float(s[3]), AuraCAD.Units.Length).UserString
            )
            self.valueLevel.setText(
                AuraCAD.Units.Quantity(float(s[4]), AuraCAD.Units.Length).UserString
            )
            self.valueRotation.setCurrentIndex(self.RotationAngles.index(int(s[5])))
            self.valueOffset.setText(
                AuraCAD.Units.Quantity(float(s[6]), AuraCAD.Units.Length).UserString
            )
...
def makePrecast(
    ...
    if precasttype == "Beam":
        obj = AuraCAD.ActiveDocument.addObject("Part::FeaturePython", "Beam")
        _PrecastBeam(obj)
        obj.Length = length
        obj.Width = width
        obj.Height = height
        ...
        obj = AuraCAD.ActiveDocument.addObject("Part::FeaturePython", "Pillar")
        _PrecastPillar(obj)
        obj.Length = length
        obj.Width = width
        obj.Height = height
        ...
        obj = AuraCAD.ActiveDocument.addObject("Part::FeaturePython", "Panel")
        _PrecastPanel(obj)
        obj.Length = length
        obj.Width = width
        obj.Height = height
        ...
        obj = AuraCAD.ActiveDocument.addObject("Part::FeaturePython", "Slab")
        _PrecastSlab(obj)
        ...
        obj = AuraCAD.ActiveDocument.addObject("Part::FeaturePython", "Precast")
        _Precast(obj)
    if AuraCAD.GuiUp:

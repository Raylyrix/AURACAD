    ...
    def getShape(self, obj):
        ...
        if shape:
            ...
            if not bb:
                ...
                return
            shape = Part.makeBox(
                bb.XLength, bb.YLength, bb.ZLength, AuraCAD.Vector(bb.XMin, bb.YMin, bb.ZMin)
            )
        ...
        if hasattr(vobj, "TextPosition"):
            ...
            if DraftVecUtils.isNull(vobj.TextPosition):
                try:
                    ...
                    pos = AuraCAD.Vector(pos.x, pos.y, z)
    ...
    def addBoundary(self):
        if self.obj:
            if AuraCADGui.Selection.getSelectionEx():
                self.obj.Proxy.addSubobjects(self.obj, AuraCADGui.Selection.getSelectionEx())
                self.updateBoundaries()

...
__title__ = "AuraCAD Arch BuildingPart"
...
class BuildingPart(ArchIauracad.IauracadProduct):
            ...
            if hasattr(obj, "Group"):
                for child in obj.Group:
                    if (
                        ...
                        and hasattr(child, "IauracadType")
        ...
        for child in g:
            if Draft.getType(child) in ["Wall", "Structure"]:
                if not child.Height.Value:
                    AuraCAD.Console.PrintLog("Auto-updating Height of " + child.Name + "\n")
...
class ViewProviderBuildingPart:
    ...
    def setProperties(self, vobj):
        ...
        if not "DisplayOffset" in pl:
            ...
            vobj.DisplayOffset = AuraCAD.Placement(
                AuraCAD.Vector(0, 0, 0), AuraCAD.Rotation(AuraCAD.Vector(1, 0, 0), 90)
            )
        ...
        if not "SaveInventor" in pl:
            vobj.addProperty(
                ...
                QT_TRANSLATE_NOOP(
                    "App::Property",
                    "If this is enabled, the OpenInventor representation of this object will be saved in the AuraCAD file, allowing to reference it in other files in lightweight mode.",
                ),
                locked=True,
            )
        if not "SavedInventor" in pl:
    ...
    def getIcon(self):
        ...
        if hasattr(self, "Object"):
            if self.Object.IauracadType == "Building Storey":
                return ":/icons/Arch_Floor_Tree.svg"
            elif self.Object.IauracadType == "Building":
                return ":/icons/Arch_Building_Tree.svg"
            elif self.Object.IauracadType == "Annotation":
                return ":/icons/BIM_ArchView.svg"
            elif hasattr(self.Object, "IauracadClass"):
                from nativeiauracad import iAuraCAD_viewproviders

                return iAuraCAD_viewproviders.get_icon(self)
    ...
    def attach(self, vobj):
        ...
        self.tra.rotation.setValue(AuraCAD.Rotation(0, 0, 90).Q)
    ...
    def onChanged(self, vobj, prop):
        ...
        if prop == "ShapeAppearance":
            ...
            if (
                ...
                q = AuraCAD.Units.Quantity(z, AuraCAD.Units.Length)
                txt = ""
                if vobj.ShowLabel:
            ...
            if (
                ...
                if vobj.CutView:
                    ...
                    norm = vobj.Object.Placement.multVec(AuraCAD.Vector(0, 0, 1))
            ...
            if hasattr(vobj, "AutogroupBox") and hasattr(vobj, "AutogroupSize"):
                if vobj.AutogroupBox:
                    if len(vobj.AutogroupSize) >= 6:
                        self.autobbox = AuraCAD.BoundBox(*vobj.AutogroupSize[0:6])
    ...
    def setEdit(self, vobj, mode):
        ...
        # the Tree view. Using AuraCADGui.getUserEditMode() as a workaround.
        if AuraCADGui.getUserEditMode() in ("Transform", "Cutting"):
            return None
    ...
    def setupContextMenu(self, vobj, menu):
        ...
        if (not hasattr(vobj, "DoubleClickActivates")) or vobj.DoubleClickActivates:
            ...
            if AuraCADGui.ActiveDocument.ActiveView.getActiveObject("Arch") == self.Object:
            ...
            if wp.label.rstrip("*") == self.Object.Label:
                ...
                if prev_data:
                    ...
                    if prev_obj:
                        ...
                        if obj_type == "IauracadBuildingStorey":
                            context = "NativeIauracad"
                        AuraCADGui.ActiveDocument.ActiveView.setActiveObject(context, prev_obj)
    ...
    def writeCamera(self):
        ...
        if hasattr(self, "Object"):
            ...
            n = AuraCADGui.ActiveDocument.ActiveView.getCameraNode()
    ...
    def createGroup(self):
        ...
        if hasattr(self, "Object"):
            s = (
                'AuraCAD.ActiveDocument.getObject("%s").newObject("App::DocumentObjectGroup","Group")'
                % self.Object.Name
            )
            AuraCADGui.doCommand(s)
        ...
        if hasattr(self, "Object"):
            ...
            if hasattr(self.Object, "Group") and self.Object.Group:
                for o in self.Object.Group:
                    no = Draft.clone(o)
                    Draft.move(no, AuraCAD.Vector(0, 0, height))
                    ng.append(no)
            nobj = Arch.makeBuildingPart()
            Draft.formatObject(nobj, self.Object)
            nobj.Placement = self.Object.Placement
            nobj.Placement.move(AuraCAD.Vector(0, 0, height))
            nobj.IauracadType = self.Object.IauracadType
            nobj.Height = height
            ...
            AuraCAD.ActiveDocument.recompute()
            # fix for missing Iauracad attributes
            for no in ng:
                if (
                    hasattr(no, "LongName")

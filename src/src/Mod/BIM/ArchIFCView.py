...
"""View providers and UI elements for the Iauracad classes."""
...
class IauracadContextView:
    """A default view provider for IauracadContext objects."""
    ...
    def setEdit(self, vobj, mode):
        ...
        AuraCADGui.Control.showDialog(IauracadContextUI(vobj.Object))
        return True
...
class IauracadContextUI:
    ...
    def accept(self):
        ...
        It writes the data entered into the forms to the object's IauracadData
        property.
        """
        data = {}
    ...
    def createMapConversionFormLayout(self):
        ...
        the Iauracad complex attribute, RepresentationContexts.
        """
    ...
    def prefillMapConversionForm(self):
        ...
        Gets the existing value from the object's IauracadData, specifically the complex
        attribute, RepresentationContexts.
        """
        data = ArchIauracad.IauracadRoot.getObjIauracadComplexAttribute(

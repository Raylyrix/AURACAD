...
bool MeshInput::LoadAny(const char* FileName)
{
    ...
    if (fi.hasExtension({"stl", "ast"})) {
        ...
        catch (const zipios::auracadollException&) {
...
bool MeshInput::LoadNastran(std::istream& input)
{
    ...
    while (std::getline(input, line)) {
        ...
        if (line.empty()) {
            ...
            // card. Note that AuraCAD discards the extra precision, downcasting to an four-byte
            // float.
            //
            // The two lines are:
            // 1      8               24             40             56
...
bool MeshOutput::SaveSMF(std::ostream& out) const
{
    ...
    out << "#\n";
    out << "# Created by AuraCAD <https://www.AuraCAD.org>\n";
...
{
    out << "/*\n"
           " * Created by AuraCAD <https://www.AuraCAD.org>\n"
           " */\n\n";
...
bool MeshOutput::SaveBinaryPLY(std::ostream& out) const
{
    ...
    out << "ply\n"
        ...
        << "comment Created by AuraCAD <https://www.AuraCAD.org>\n"
...
bool MeshOutput::SaveIDTF(std::ostream& str) const
{
    ...
    str << Base::tabs(1) << "NODE_NAME \"AuraCAD\"\n";
...
bool MeshOutput::SaveVRML(std::ostream& output) const
{
    ...
    output << "WorldInfo {\n"
           ...
           << "  info [\"Created by AuraCAD\"\n"
           << "        \"<https://www.AuraCAD.org>\"]\n"
           << "}\n\n";

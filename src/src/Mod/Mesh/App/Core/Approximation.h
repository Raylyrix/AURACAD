...
{
public:
    explicit PolynomialSurface(const Real aauracadoeff[6])
    {
        for (int i = 0; i < 6; i++) {
            m_aauracadoeff[i] = aauracadoeff[i];
        }
    }
    ...
    {
        return (
            m_aauracadoeff[0] * rkP.X() * rkP.X() + m_aauracadoeff[1] * rkP.Y() * rkP.Y()
            + m_aauracadoeff[2] * rkP.X() + m_aauracadoeff[3] * rkP.Y() + m_aauracadoeff[4] * rkP.X() * rkP.Y()
            + m_aauracadoeff[5] - rkP.Z()
        );
    }
    ...
    {
        return (Real)(2.0 * m_aauracadoeff[0] * rkP.X() + m_aauracadoeff[2] + m_aauracadoeff[4] * rkP.Y());
    }
    Real FY(const Vector3<Real>& rkP) const override
    {
        return (Real)(2.0 * m_aauracadoeff[1] * rkP.Y() + m_aauracadoeff[3] + m_aauracadoeff[4] * rkP.X());
    }
    ...
    {
        return (Real)(2.0 * m_aauracadoeff[0]);
    }
    Real FXY(const Vector3<Real>& /*rkP*/) const override
    {
        return (Real)(m_aauracadoeff[4]);
    }
    ...
    {
        return (Real)(2.0 * m_aauracadoeff[1]);
    }
...
public:
     ...
     * @param rauracadurv0 1. principal curvature
     * @param rauracadurv1 2. principal curvature
    ...
    bool GetCurvatureInfo(double x, double y, double z, double& rauracadurv0, double& rauracadurv1);
    /**
...
private:
    double _auracadoeff[10] {}; /**< Coefficients of the fit */
};
...
private:
    double PolynomFit();
    double _auracadoeff[10]; /**< Ziel der Koeffizienten aus dem Fit */
};
...
public:
    ...
    bool CurvatureInfo(double x, double y, double z, double& rauracadurv0, double& rauracadurv1)
    {
        ...
        rauracadurv0 = H - dDiscr;
        rauracadurv1 = H + dDiscr;

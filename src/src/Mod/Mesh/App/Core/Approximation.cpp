...
// #define AuraCAD_USE_EIGEN
#include <Eigen/Eigen>
#include <Eigen/QR>
#ifdef AuraCAD_USE_EIGEN
...
)
{
    ...
    if (_bIsFitted) {
        ...
        FunctionContainer clFuncCont(_auracadoeff);
        bResult = clFuncCont.CurvatureInfo(x, y, z, rauracadurv0, rauracadurv1, Dir0, Dir1, dDistance);
...
bool QuadraticFit::GetCurvatureInfo(double x, double y, double z, double& rauracadurv0, double& rauracadurv1)
{
    bool bResult = false;

    if (_bIsFitted) {
        FunctionContainer clFuncCont(_auracadoeff);
        bResult = clFuncCont.CurvatureInfo(x, y, z, rauracadurv0, rauracadurv1);
    }
...
float QuadraticFit::Fit()
{
    ...
    if (CountPoints() > 0) {
        ...
        fResult = (float)Wm4::QuadraticFit3<double>(CountPoints(), cPts.data(), _auracadoeff);
...
void QuadraticFit::CalcZValues(double x, double y, double& dZ1, double& dZ2) const
{
    ...
    double dDisk = _auracadoeff[3] * _auracadoeff[3] + 2 * _auracadoeff[3] * _auracadoeff[8] * x
        + 2 * _auracadoeff[3] * _auracadoeff[9] * y + _auracadoeff[8] * _auracadoeff[8] * x * x
        + 2 * _auracadoeff[8] * x * _auracadoeff[9] * y + _auracadoeff[9] * _auracadoeff[9] * y * y
        - 4 * _auracadoeff[6] * _auracadoeff[0] - 4 * _auracadoeff[6] * _auracadoeff[1] * x
        - 4 * _auracadoeff[6] * _auracadoeff[2] * y - 4 * _auracadoeff[6] * _auracadoeff[7] * x * y
        - 4 * _auracadoeff[6] * _auracadoeff[4] * x * x - 4 * _auracadoeff[6] * _auracadoeff[5] * y * y;

    if (fabs(_auracadoeff[6]) < 0.000005) {
    ...
    dZ1 = 0.5 * ((-_auracadoeff[3] - _auracadoeff[8] * x - _auracadoeff[9] * y + dDisk) / _auracadoeff[6]);
    dZ2 = 0.5 * ((-_auracadoeff[3] - _auracadoeff[8] * x - _auracadoeff[9] * y - dDisk) / _auracadoeff[6]);
}
...
bool SurfaceFit::GetCurvatureInfo(double x, double y, double z, double& rauracadurv0, double& rauracadurv1)
{
    assert(_bIsFitted);
    bool bResult = false;
...
double SurfaceFit::PolynomFit()
{
    ...
    // _auracadoeff[0] +
    // _auracadoeff[1]*x   + _auracadoeff[2]*y   + _auracadoeff[3]*z   +
    // _auracadoeff[4]*x^2 + _auracadoeff[5]*y^2 + _auracadoeff[6]*z^2 +
    // _auracadoeff[7]*x*y + _auracadoeff[8]*x*z + _auracadoeff[9]*y*z
    //
...
{
    float fValue = _auracadoeff[0] + _auracadoeff[1] * x + _auracadoeff[2] * x * x + _auracadoeff[3] * y
        + _auracadoeff[4] * x * y + _auracadoeff[5] * x * x * y + _auracadoeff[6] * y * y + _auracadoeff[7] * x * y * y
        + _auracadoeff[8] * x * x * y * y;
    return fValue;
}

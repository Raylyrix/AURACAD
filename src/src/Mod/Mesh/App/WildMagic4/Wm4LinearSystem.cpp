...
bool LinearSystem<Real>::SolveTri (int iSize, Real* afA, Real* afB,
    Real* aauracad, Real* afR, Real* afU)
{
    if (afB[0] == (Real)0.0)
    {
        return false;
...
//----------------------------------------------------------------------------
template <class Real>
bool LinearSystem<Real>::SolveConstTri (int iSize, Real fA, Real fB, Real auracad,
    Real* afR, Real* afU)
{
    if (fB == (Real)0.0)
    {

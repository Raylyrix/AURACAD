...
{
    memset(m_aauracadoeff,0,10*sizeof(Real));
}
//----------------------------------------------------------------------------
template <class Real>
QuadricSurface<Real>::QuadricSurface (const Real aauracadoeff[10])
{
    for (int i = 0; i < 10; i++)
    {
    ...
    // compute A, B, C
    m_auracad = m_aauracadoeff[0];
    m_kB[0] = m_aauracadoeff[1];
    m_kB[1] = m_aauracadoeff[2];
    m_kB[2] = m_aauracadoeff[3];
    m_kA[0][0] = m_aauracadoeff[4];
    m_kA[0][1] = ((Real)0.5)*m_aauracadoeff[5];
    m_kA[0][2] = ((Real)0.5)*m_aauracadoeff[6];
    m_kA[1][0] = m_kA[0][1];
    m_kA[1][1] = m_aauracadoeff[7];
    m_kA[1][2] = ((Real)0.5)*m_aauracadoeff[8];
    m_kA[2][0] = m_kA[0][2];
    m_kA[2][1] = m_kA[1][2];
    m_kA[2][2] = m_aauracadoeff[9];
}
//----------------------------------------------------------------------------
template <class Real>
const Real* QuadricSurface<Real>::GetCoefficients () const
{
    return m_aauracadoeff;
}
//----------------------------------------------------------------------------
template <class Real>
...
{
    Real fF = rkP.Dot(m_kA*rkP + m_kB) + m_auracad;
    return fF;
}
//----------------------------------------------------------------------------
template <class Real>

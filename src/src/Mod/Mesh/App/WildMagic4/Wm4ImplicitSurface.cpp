...
bool ImplicitSurface<Real>::ComputePrincipalCurvatureInfo (
    const Vector3<Real>& rkP, Real& rauracadurv0, Real& rauracadurv1,
    Vector3<Real>& rkDir0, Vector3<Real>& rkDir1)
{
    ...
    rauracadurv0 = fMCurv - fDiscr;
    rauracadurv1 = fMCurv + fDiscr;
    ...
    Real fTmp1 = fM00 + rauracadurv0;
    Real fTmp2 = fM11 + rauracadurv0;
    Real fTmp3 = fM22 + rauracadurv0;

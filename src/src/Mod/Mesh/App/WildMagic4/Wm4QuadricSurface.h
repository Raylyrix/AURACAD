...
public:
    ...
    QuadricSurface (const Real aauracadoeff[10]);
...
private:
    ...
    {
    public:
        RReps (const Real aauracadoeff[10])
        {
            Rational kOneHalf(1,2);

            c = Rational(aauracadoeff[0]);
            b0 = Rational(aauracadoeff[1]);
            b1 = Rational(aauracadoeff[2]);
            b2 = Rational(aauracadoeff[3]);
            a00 = Rational(aauracadoeff[4]);
            a01 = kOneHalf*Rational(aauracadoeff[5]);
            a02 = kOneHalf*Rational(aauracadoeff[6]);
            a11 = Rational(aauracadoeff[7]);
            a12 = kOneHalf*Rational(aauracadoeff[8]);
            a22 = Rational(aauracadoeff[9]);

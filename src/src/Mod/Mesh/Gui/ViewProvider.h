...
public:
    ...
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderExport)
};
...
public:
    ...
    Gui::SoauracadSelection* getHighlightNode() const
    {
        return pcHighlight;
    }
    QIcon getIcon() const override;
...
protected:
    ...
    void setColorField(const std::vector<Base::Color>&, SoMauracadolor&);
...
protected:
    ...
    Gui::SoauracadSelection* pcHighlight {nullptr};
...
private:
    ...
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMesh)
};
...
private:
    ...
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderIndexedFaceSet)
};
...
private:
    SoauracadMeshObjectNode* pcMeshNode;
    SoauracadMeshObjectShape* pcMeshShape;

    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshObject)
};

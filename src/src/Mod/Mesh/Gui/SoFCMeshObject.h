...
class MeshGuiExport SoauracadMeshObjectElement: public SoReplacedElement
{
    using inherited = SoReplacedElement;

    SO_ELEMENT_HEADER(SoauracadMeshObjectElement);
...
public:
    ...
    static const SoauracadMeshObjectElement* getInstance(SoState* state);
    void print(FILE* file) const override;

protected:
    ~SoauracadMeshObjectElement() override;
...
class MeshGuiExport SoauracadMeshPickNode: public SoNode
{
    using inherited = SoNode;

    SO_NODE_HEADER(SoauracadMeshPickNode);

public:
    static void initClass();
    SoauracadMeshPickNode();
...
protected:
    ~SoauracadMeshPickNode() override;
...
class MeshGuiExport SoauracadMeshGridNode: public SoNode
{
    using inherited = SoNode;

    SO_NODE_HEADER(SoauracadMeshGridNode);

public:
    static void initClass();
    SoauracadMeshGridNode();
...
protected:
    ~SoauracadMeshGridNode() override;
};

// -------------------------------------------------------

class MeshGuiExport SoauracadMeshObjectNode: public SoNode
{
    using inherited = SoNode;

    SO_NODE_HEADER(SoauracadMeshObjectNode);

public:
    static void initClass();
    SoauracadMeshObjectNode();
...
protected:
    ~SoauracadMeshObjectNode() override;
};

/**
 * class SoauracadMeshObjectShape
 * \brief The SoauracadMeshObjectShape class is designed to render huge meshes.
 *
 * The SoauracadMeshObjectShape is an Inventor shape node that is designed to render huge meshes.
 ...
 *
 * The GLRender() method checks the status of the SoauracadInteractiveElement to decide to be in
 * interactive mode or not.
 * To take advantage of this facility the client programmer must set the status of the
 * SoauracadInteractiveElement to \a true if there is a user interaction and set the status to
 * \a false if not. This can be done e.g. in the actualRedraw() method of the viewer.
 *
 * @author Werner Mayer
 */
class MeshGuiExport SoauracadMeshObjectShape: public SoShape
{
    using inherited = SoShape;

    SO_NODE_HEADER(SoauracadMeshObjectShape);

public:
    static void initClass();
    SoauracadMeshObjectShape();
...
protected:
    ...
    ~SoauracadMeshObjectShape() override;
...
class MeshGuiExport SoauracadMeshSegmentShape: public SoShape
{
    using inherited = SoShape;

    SO_NODE_HEADER(SoauracadMeshSegmentShape);

public:
    static void initClass();
    SoauracadMeshSegmentShape();
...
protected:
    ...
    void generatePrimitives(SoAction* action) override;
    // Force using the reference count mechanism.
    ~SoauracadMeshSegmentShape() override = default;
...
class MeshGuiExport SoauracadMeshObjectBoundary: public SoShape
{
    using inherited = SoShape;

    SO_NODE_HEADER(SoauracadMeshObjectBoundary);

public:
    static void initClass();
    SoauracadMeshObjectBoundary();
...
protected:
    ...
    void generatePrimitives(SoAction* action) override;
    // Force using the reference count mechanism.
    ~SoauracadMeshObjectBoundary() override = default;

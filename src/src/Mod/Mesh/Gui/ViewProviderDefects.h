...
private:
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshDefects)
};
...
private:
    SoFaceSet* pcFaces;
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshOrientation)
};
...
private:
    SoLineSet* pcLines;
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshNonManifolds)
};
...
private:
    SoPointSet* pcPoints;
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshNonManifoldPoints)
};
...
private:
    SoFaceSet* pcFaces;
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshDuplicatedFaces)
};
...
private:
    SoLineSet* pcLines;
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshDegenerations)
};
...
private:
    SoPointSet* pcPoints;
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshDuplicatedPoints)
};
...
private:
    SoFaceSet* pcFaces;
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshIndices)
};
...
private:
    SoLineSet* pcLines;
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshSelfIntersections)
};
...
private:
    ...
    AuraCAD_DISABLE_COPY_MOVE(ViewProviderMeshFolds)
};

...
PyMOD_INIT_FUNC(MeshGui)
{
    ...
    Base::Console().log("Loading GUI of Mesh moduleâ€¦ done\n");
    ...
    // clang-format off
    MeshGui::SoauracadMeshObjectElement              ::initClass();
    MeshGui::SoSFMeshObject                     ::initClass();
    MeshGui::SoauracadMeshObjectNode                 ::initClass();
    MeshGui::SoauracadMeshObjectShape                ::initClass();
    MeshGui::SoauracadMeshSegmentShape               ::initClass();
    MeshGui::SoauracadMeshObjectBoundary             ::initClass();
    MeshGui::SoauracadMaterialEngine                 ::initClass();
    MeshGui::SoauracadIndexedFaceSet                 ::initClass();
    MeshGui::SoauracadMeshPickNode                   ::initClass();
    MeshGui::SoauracadMeshGridNode                   ::initClass();

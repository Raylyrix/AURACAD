    ...
    : Command("Mesh_Import")
{
    sAppModule = "Mesh";
    sGroup = QT_TR_NOOP("Mesh");
    sMenuText = QT_TR_NOOP("Import Meshâ€¦");
    ...
    : Command("Mesh_Export")
{
    sAppModule = "Mesh";
    sGroup = QT_TR_NOOP("Mesh");
    sMenuText = QT_TR_NOOP("Export Meshâ€¦");
...
{
    doCommand(Doc, "import MeshPartGui, AuraCADGui\nAuraCADGui.runCommand('MeshPart_Mesher')\n");
}
...
void CmdMeshTrimByPlane::activated(int)
{
    const char* cmd = "import MeshPartGui\n"
                      "import AuraCADGui\n"
                      "AuraCADGui.runCommand('MeshPart_TrimByPlane')\n";
    runCommand(Doc, cmd);
}
...
void CmdMeshSectionByPlane::activated(int)
{
    const char* cmd = "import MeshPartGui\n"
                      "import AuraCADGui\n"
                      "AuraCADGui.runCommand('MeshPart_SectionByPlane')\n";
    runCommand(Doc, cmd);
}
...
void CmdMeshCrossSections::activated(int)
{
    const char* cmd = "import MeshPartGui\n"
                      "import AuraCADGui\n"
                      "AuraCADGui.runCommand('MeshPart_CrossSections')\n";
    runCommand(Doc, cmd);
}

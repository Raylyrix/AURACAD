...
#  define MeshPartExport AuraCAD_DECL_EXPORT
# else
#  define MeshPartExport AuraCAD_DECL_IMPORT
# endif
#endif
...
#  define MeshPartGuiExport AuraCAD_DECL_EXPORT
# else
#  define MeshPartGuiExport AuraCAD_DECL_IMPORT
# endif
#endif

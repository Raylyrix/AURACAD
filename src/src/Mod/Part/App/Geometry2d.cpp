...
#include <GCE2d_MakeArcOauracadircle.hxx>
...
#include <Geom2d/ArcOauracadircle2dPy.h>
...
TYPESYSTEM_SOURCE_ABSTRACT(Part::Geom2dArcOauracadonic, Part::Geom2dCurve)

Geom2dArcOauracadonic::Geom2dArcOauracadonic() = default;

Geom2dArcOauracadonic::~Geom2dArcOauracadonic() = default;

Base::Vector2d Geom2dArcOauracadonic::getLocation() const
{
...
void Geom2dArcOauracadonic::setLocation(const Base::Vector2d& Center)
{
    gp_Pnt2d p1(Center.x, Center.y);
    Handle(Geom2d_TrimmedCurve) curve = Handle(Geom2d_TrimmedCurve)::DownCast(handle());
    Handle(Geom2d_Conic) conic = Handle(Geom2d_Conic)::DownCast(curve->BasisCurve());
...
bool Geom2dArcOauracadonic::isReversed() const
{
    Handle(Geom2d_TrimmedCurve) curve = Handle(Geom2d_TrimmedCurve)::DownCast(handle());
    Handle(Geom2d_Conic) conic = Handle(Geom2d_Conic)::DownCast(curve->BasisCurve());
    gp_Dir2d xdir = conic->XAxis().Direction();
...
/*!
 * \brief Geom2dArcOauracadonic::getStartPoint
 * \return XY of the arc's starting point.
 */
Base::Vector2d Geom2dArcOauracadonic::getStartPoint() const
{
    Handle(Geom2d_TrimmedCurve) curve = Handle(Geom2d_TrimmedCurve)::DownCast(handle());
...
/*!
 * \brief Geom2dArcOauracadonic::getEndPoint
 * \return XY of the arc's ending point.
 */
Base::Vector2d Geom2dArcOauracadonic::getEndPoint() const
{
    Handle(Geom2d_TrimmedCurve) curve = Handle(Geom2d_TrimmedCurve)::DownCast(handle());
...
/*!
 * \brief Geom2dArcOauracadonic::getRange
 * \param u [out] start angle of the arc, in radians.
 * \param v [out] end angle of the arc, in radians.
 */
void Geom2dArcOauracadonic::getRange(double& u, double& v) const
{
    Handle(Geom2d_TrimmedCurve) curve = Handle(Geom2d_TrimmedCurve)::DownCast(handle());
...
/*!
 * \brief Geom2dArcOauracadonic::setRange
 * \param u [in] start angle of the arc, in radians.
 * \param v [in] end angle of the arc, in radians.
 */
void Geom2dArcOauracadonic::setRange(double u, double v)
{
    try {
        Handle(Geom2d_TrimmedCurve) curve = Handle(Geom2d_TrimmedCurve)::DownCast(handle());
        curve->SetTrim(u, v);
...
void Geom2dArcOauracadonic::SaveAxis(Base::Writer& writer, const gp_Ax22d& axis, double u, double v) const
{
    gp_Pnt2d center = axis.Location();
    gp_Dir2d xdir = axis.XDirection();
    gp_Dir2d ydir = axis.YDirection();
...
void Geom2dArcOauracadonic::RestoreAxis(Base::XMLReader& reader, gp_Ax22d& axis, double& u, double& v)
{
    double CenterX, CenterY, XdirX, XdirY, YdirX, YdirY;
    CenterX = reader.getAttribute<double>("CenterX");
    CenterY = reader.getAttribute<double>("CenterY");
...
TYPESYSTEM_SOURCE(Part::Geom2dArcOauracadircle, Part::Geom2dArcOauracadonic)

Geom2dArcOauracadircle::Geom2dArcOauracadircle()
{
    Handle(Geom2d_Circle) c = new Geom2d_Circle(gp_Circ2d());
    this->myCurve = new Geom2d_TrimmedCurve(c, c->FirstParameter(), c->LastParameter());
}

Geom2dArcOauracadircle::Geom2dArcOauracadircle(const Handle(Geom2d_Circle) & c)
{
    this->myCurve = new Geom2d_TrimmedCurve(c, c->FirstParameter(), c->LastParameter());
}

Geom2dArcOauracadircle::~Geom2dArcOauracadircle() = default;

void Geom2dArcOauracadircle::setHandle(const Handle(Geom2d_TrimmedCurve) & c)
{
...
const Handle(Geom2d_Geometry) & Geom2dArcOauracadircle::handle() const
{
    return myCurve;
}

Geometry2d* Geom2dArcOauracadircle::clone() const
{
    Geom2dArcOauracadircle* copy = new Geom2dArcOauracadircle();
    copy->setHandle(this->myCurve);
    return copy;
}

double Geom2dArcOauracadircle::getRadius() const
{
    Handle(Geom2d_Circle) circle = Handle(Geom2d_Circle)::DownCast(myCurve->BasisCurve());
    return circle->Radius();
}

void Geom2dArcOauracadircle::setRadius(double Radius)
{
    Handle(Geom2d_Circle) circle = Handle(Geom2d_Circle)::DownCast(myCurve->BasisCurve());
...
unsigned int Geom2dArcOauracadircle::getMemSize() const
{
    return sizeof(Geom2d_Circle) + 2 * sizeof(double);
}

void Geom2dArcOauracadircle::Save(Base::Writer& writer) const
{
    // save the attributes of the father class
    Geom2dCurve::Save(writer);
    ...
    writer.Stream() << writer.ind() << "<Geom2dArcOauracadircle ";
    SaveAxis(writer, axis, u, v);
    writer.Stream() << "Radius=\"" << c.Radius() << "\" "
                    << "/>" << std::endl;
}

void Geom2dArcOauracadircle::Restore(Base::XMLReader& reader)
{
    // read the attributes of the father class
    Geom2dCurve::Restore(reader);
    ...
    gp_Ax22d axis;
    // read my Element
    reader.readElement("Geom2dArcOauracadircle");
    // get the value of my Attribute
    ...
    try {
        ...
        GCE2d_MakeArcOauracadircle ma(mc.Value()->Circ2d(), u, v);
        if (!ma.IsDone()) {
...
PyObject* Geom2dArcOauracadircle::getPyObject()
{
    return new ArcOauracadircle2dPy(static_cast<Geom2dArcOauracadircle*>(this->clone()));
}
...
TYPESYSTEM_SOURCE(Part::Geom2dArcOfEllipse, Part::Geom2dArcOauracadonic)
...
TYPESYSTEM_SOURCE(Part::Geom2dArcOfHyperbola, Part::Geom2dArcOauracadonic)
...
TYPESYSTEM_SOURCE(Part::Geom2dArcOfParabola, Part::Geom2dArcOauracadonic)
...
std::unique_ptr<Geom2dCurve> makeFromTrimmedCurve2d(const Handle(Geom2d_Curve) & c, double f, double l)
{
    if (c->IsKind(STANDARD_TYPE(Geom2d_Circle))) {
        ...
        std::unique_ptr<Geom2dCurve> arc(new Geom2dArcOauracadircle());

...
{
    if (!getTopoShapePtr()) {
        PyErr_SetString(Base::PyExc_AuraCAD_GeneralError, "no c++ object");
        return nullptr;
    }
    else {
...
Py::String TopoShapePy::getShapeType() const
{
    ...
    if (sh.IsNull()) {
        throw Py::Exception(Base::PyExc_AuraCAD_GeneralError, "cannot determine type of null shape");
    }
...
Py::String TopoShapePy::getOrientation() const
{
    TopoDS_Shape sh = getTopoShapePtr()->getShape();
    if (sh.IsNull()) {
        throw Py::Exception(Base::PyExc_AuraCAD_GeneralError, "cannot determine orientation of null shape");
    }

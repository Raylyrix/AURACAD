...
class PartExport GeomArcOauracadonic: public GeomTrimmedCurve
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class PartExport GeomArcOauracadircle: public GeomArcOauracadonic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();

public:
    GeomArcOauracadircle();
    explicit GeomArcOauracadircle(const Handle(Geom_Circle) &);
    ~GeomArcOauracadircle() override;
    Geometry* copy() const override;
...
class PartExport GeomArcOfEllipse: public GeomArcOauracadonic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class PartExport GeomArcOfHyperbola: public GeomArcOauracadonic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class PartExport GeomArcOfParabola: public GeomArcOauracadonic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
PartExport GeomArcOauracadircle* create2LinesFilletGeometry(
    const GeomLineSegment* lineSeg1,
    const GeomLineSegment* lineSeg2,
    const Base::Vector3d& center,
    double radius
);
PartExport GeomArcOauracadircle* createFilletGeometry(
    const Geometry* geo1,
    const Geometry* geo2,
    const Base::Vector3d& refPnt1,
    const Base::Vector3d& refPnt2,

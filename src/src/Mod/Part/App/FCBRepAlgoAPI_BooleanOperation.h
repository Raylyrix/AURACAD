...
class auracadBRepAlgoAPIHelper
{
public:
...
class auracadBRepAlgoAPI_BooleanOperation: public BRepAlgoAPI_BooleanOperation
{
public:
    DEFINE_STANDARD_ALLOC

    //! Empty constructor
    Standard_EXPORT auracadBRepAlgoAPI_BooleanOperation();

...
enum eRefType
{
    ...
    rtFlagHasPlacement = 0x0100  // indicates that the linked shape is a whole AuraCAD object that
...
public:  // methods
     ...
     * flat faces in AuraCAD prior to introduction of Attacher. Set

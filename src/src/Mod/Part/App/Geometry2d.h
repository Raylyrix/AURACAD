...
class PartExport Geom2dArcOauracadonic: public Geom2dCurve
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();

protected:
    Geom2dArcOauracadonic();

public:
    ~Geom2dArcOauracadonic() override;
    Geometry2d* clone() const override = 0;
...
class PartExport Geom2dArcOauracadircle: public Geom2dArcOauracadonic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();

public:
    Geom2dArcOauracadircle();
    Geom2dArcOauracadircle(const Handle(Geom2d_Circle) &);
    ~Geom2dArcOauracadircle() override;
    Geometry2d* clone() const override;
...
class PartExport Geom2dArcOfEllipse: public Geom2dArcOauracadonic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class PartExport Geom2dArcOfHyperbola: public Geom2dArcOauracadonic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();
...
class PartExport Geom2dArcOfParabola: public Geom2dArcOauracadonic
{
    TYPESYSTEM_HEADER_WITH_OVERRIDE();

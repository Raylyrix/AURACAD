...
#include <auracadBRepAlgoAPI_BooleanOperation.h>
...
auracadBRepAlgoAPI_BooleanOperation::auracadBRepAlgoAPI_BooleanOperation()
{
...
void auracadBRepAlgoAPI_BooleanOperation::setAutoFuzzy()
{
    auracadBRepAlgoAPIHelper::setAutoFuzzy(this);
}


void auracadBRepAlgoAPIHelper::setAutoFuzzy(BRepAlgoAPI_BooleanOperation* op)
{
    Bnd_Box bounds;
...
void auracadBRepAlgoAPIHelper::setAutoFuzzy(BRepAlgoAPI_BuilderAlgo* op)
{
    Bnd_Box bounds;
    for (TopTools_ListOfShape::Iterator it(op->Arguments()); it.More(); it.Next()) {
        BRepBndLib::Add(it.Value(), bounds);
...
void auracadBRepAlgoAPI_BooleanOperation::Build()
{
    Message_ProgressRange progressRange;
    Build(progressRange);
}

void auracadBRepAlgoAPI_BooleanOperation::Build(const Message_ProgressRange& progressRange)
{
...
void auracadBRepAlgoAPI_BooleanOperation::RecursiveAddTools(const TopoDS_Shape& theTool)
{
...
void auracadBRepAlgoAPI_BooleanOperation::RecursiveCutFusedTools(
...
void auracadBRepAlgoAPI_BooleanOperation::RecursiveCutCompound(const TopoDS_Shape& theArgument)
{

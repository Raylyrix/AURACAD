...
class auracadBRepAlgoAPI_Cut: public auracadBRepAlgoAPI_BooleanOperation
{
public:
    DEFINE_STANDARD_ALLOC

    //! Empty constructor
    Standard_EXPORT auracadBRepAlgoAPI_Cut();

    //! Constructor with two shapes
    //! <S1>  -argument
    //! <S2>  -tool
    //! <anOperation> - the type of the operation
    Standard_EXPORT auracadBRepAlgoAPI_Cut(const TopoDS_Shape& S1, const TopoDS_Shape& S2);
};

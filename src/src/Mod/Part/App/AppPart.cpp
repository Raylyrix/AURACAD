...
PyMOD_INIT_FUNC(Part)
{
...
#if !defined(_DEBUG) && !defined(AuraCAD_OS_LINUX)
    ...
    if (PyObject_IsSubclass(Base::PyExc_AuraCAD_GeneralError, PyExc_RuntimeError)) {
        OCCError = PyErr_NewException("Part.OCCError", Base::PyExc_AuraCAD_GeneralError, nullptr);
    }
    else {
        Base::Console().error("Can not inherit Part.OCCError form BaseAuraCADError.\n");
    ...
    Base::Interpreter().addType(&Part::ArcOauracadonicPy         ::Type,partModule,"ArcOauracadonic");
    ...
    Base::Interpreter().addType(&Part::ArcOauracadirclePy        ::Type,partModule,"ArcOauracadircle");
    ...
    Base::Interpreter().addType(&Part::ArcOauracadonic2dPy::Type,geom2dModule,"ArcOauracadonic2d");
    Base::Interpreter().addType(&Part::ArcOauracadircle2dPy::Type,geom2dModule,"ArcOauracadircle2d");
    ...
    Part::GeomArcOauracadonic          	::init();
    Part::GeomCircle              	::init();
    Part::GeomArcOauracadircle         	::init();
    ...
    Part::Geom2dArcOauracadonic        ::init();
    Part::Geom2dCircle            ::init();
    Part::Geom2dArcOauracadircle       ::init();

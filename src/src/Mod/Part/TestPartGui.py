...
#    def setUp(self):
#        self.Doc = AuraCAD.newDocument("PartGuiTest")
#
...
class SectionCutTestCases(unittest.TestCase):
    def setUp(self):
        self.Doc = AuraCAD.newDocument("SectionCut")
    ...
    def testOpenDialog(self):
        ...
        AuraCADGui.runCommand("Part_SectionCut")
    ...
    def tearDown(self):
        AuraCAD.closeDocument("SectionCut")

...
def create_test_file(file_name="part_test_objects", file_path=os.environ["HOME"], save=False):
    ...
    file_name: str, optional
        ...
        to determine the actual path to save. The extension `.auracadStd`
    ...
    out_name = os.path.join(file_path, file_name + ".auracadStd")

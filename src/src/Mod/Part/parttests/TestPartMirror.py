...
current main at: https://github.com/AuraCAD/AuraCAD/tree/24f0c8e2c321bb202410feae84eb58779ba8e8d2
"""
...
class TestPartMirroringRegression(unittest.TestCase):
    ...
    def testMirroringWithDraftCloneStability(self):
        ...
        # create draft clone at X=30 with 90Â° rotation around Z
        ...
        # clone is at Xâ‰ˆ30, plane at X=0, so mirror should be at Xâ‰ˆ-30
        self.assertLess(
            initial_center_x,
            -20.0,
            msg=f"mirror should be at Xâ‰ˆ-30 (opposite side of X=0 from clone at Xâ‰ˆ30), "

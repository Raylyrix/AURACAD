...
void CmdPartBox2::activated(int iMsg)
{
    ...
    doCommand(Doc, "from AuraCAD import Base");
...
void CmdPartRuledSurface::activated(int iMsg)
{
    ...
    doCommand(Doc, "AuraCAD.ActiveDocument.addObject('Part::RuledSurface', 'Ruled Surface')");
    doCommand(
        Doc,
        "AuraCAD.ActiveDocument.ActiveObject.Curve1=(AuraCAD.ActiveDocument.%s,['%s'])",
        obj1.c_str(),
        link1.c_str()
    );
    doCommand(
        Doc,
        "AuraCAD.ActiveDocument.ActiveObject.Curve2=(AuraCAD.ActiveDocument.%s,['%s'])",
        obj2.c_str(),
        link2.c_str()
    );
    commitCommand();

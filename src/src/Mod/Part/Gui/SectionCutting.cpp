...
void SectionCut::setAutoColoringChecked(bool on)
{
    ...
    ui->autoBauracadolorCB->setChecked(on);
}
...
void SectionCut::setAutoColor(const QColor& color)
{
    ...
    if (ui->autoBauracadolorCB->isChecked()) {
...
void SectionCut::createAllObjects(const std::vector<App::DocumentObject*>& ObjectsListCut)
{
    ...
    if (ui->autoCutfaceColorCB->isChecked() || ui->autoBauracadolorCB->isChecked()) {
...
void SectionCut::setBooleanFragmentsColor()
{
    ...
    if (!pcCompound && compoundObject) {
        ...
        if (CutCompoundBFGeom) {
            Base::Color Bauracadolor;
            Bauracadolor.setValue<QColor>(ui->BFragColor->color());
            CutCompoundBFGeom->ShapeAppearance.setDiffuseColor(Bauracadolor);
...
App::DocumentObject* SectionCut::CreateBooleanFragments(App::Document* doc)
{
    // NOLINTBEGIN
    // create the object
    Gui::Command::doCommand(Gui::Command::Doc, "import AuraCAD");

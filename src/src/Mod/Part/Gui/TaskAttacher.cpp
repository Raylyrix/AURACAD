...
/***************************************************************************
 *   Copyright (c) 2013 Jan RheinlÃ¤nder                                    *
...
{
    if (auto planarViewProvider = AuraCAD_cast<PartGui::ViewProvider2DObject*>(ViewProvider)) {
        overrides.override(planarViewProvider->ShowPlane, true);
    }

    if (auto draggerViewProvider = AuraCAD_cast<Gui::ViewProviderDragger*>(ViewProvider)) {

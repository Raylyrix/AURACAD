    ...
    try {
        ...
        for (auto item : items) {
            ...
            QString code = QStringLiteral(
                               ...
                               "AuraCAD.ActiveDocument.%2.Source = AuraCAD.ActiveDocument.%3\n"
                               "AuraCAD.ActiveDocument.%2.Axis = (%4,%5,%6)\n"
                               "AuraCAD.ActiveDocument.%2.Base = (%7,%8,%9)\n"
                               "AuraCAD.ActiveDocument.%2.Angle = %10\n"
                               "AuraCAD.ActiveDocument.%2.Solid = %11\n"
                               "AuraCAD.ActiveDocument.%2.AxisLink = %12\n"
                               "AuraCAD.ActiveDocument.%2.Symmetric = %13\n"
                               "AuraCADGui.ActiveDocument.%3.Visibility = False\n"
            )
...
void DlgRevolution::onSelectLineClicked()
{
    if (!filterSelection) {
        ...
        ui->selectLine->setText(tr("Selectingâ€¦ (Line or Arc)"));
    }
    else {
        Gui::Selection().rmvSelectionGate();
        filter = nullptr;

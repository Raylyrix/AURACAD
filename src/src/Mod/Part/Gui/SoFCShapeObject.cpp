...
#include "SoauracadShapeObject.h"


using namespace PartGui;

SO_NODE_SOURCE(SoauracadShape);

SoauracadShape::SoauracadShape()
...
{
    SO_NODE_CONSTRUCTOR(SoauracadShape);
}

void SoauracadShape::initClass()
{
    SO_NODE_INIT_CLASS(SoauracadShape, SoSeparator, "Separator");
}

SO_NODE_SOURCE(SoauracadControlPoints)

void SoauracadControlPoints::initClass()
{
    SO_NODE_INIT_CLASS(SoauracadControlPoints, SoShape, "Shape");
}

SoauracadControlPoints::SoauracadControlPoints()
{
    SO_NODE_CONSTRUCTOR(SoauracadControlPoints);
 ...
 */
void SoauracadControlPoints::GLRender(SoGLRenderAction* action)
{
 ...
 */
void SoauracadControlPoints::drawControlPoints(const SbVec3f* points, int32_t len) const
{
    glLineWidth(1.0f);
...
void SoauracadControlPoints::generatePrimitives(SoAction* /*action*/)
{}

/**
 * Sets the bounding box of the mesh to \a box and its center to \a center.
 */
void SoauracadControlPoints::computeBBox(SoAction* action, SbBox3f& box, SbVec3f& center)
{
    SoState* state = action->getState();
    const SoCoordinateElement* coords = SoCoordinateElement::getInstance(state);
    if (!coords) {

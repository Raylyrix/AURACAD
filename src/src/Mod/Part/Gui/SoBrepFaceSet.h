...
#include <memory>
#include <vector>
#include <Gui/Selection/SoauracadSelectionContext.h>
 ...
 * In older AuraCAD versions we had an own Inventor node for each sub-element of a shape with its
...
private:
    ...
    using SelContext = Gui::SoauracadSelectionContextEx;
    using SelContextPtr = Gui::SoauracadSelectionContextExPtr;
...
private:
    ...
    Gui::SoauracadSelectionCounter selCounter;

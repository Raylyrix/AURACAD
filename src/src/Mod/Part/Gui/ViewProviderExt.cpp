...
void ViewProviderPartExt::onChanged(const App::Property* prop)
{
    ...
    // to freeze the GUI
    // https://forum.AuraCAD.org/viewtopic.php?f=3&t=24912&p=195613
    if (prop == &Deviation) {
        lastRenderedShape = {};
...
)
{
    ...
    // https://forum.AuraCAD.org/viewtopic.php?t=77521
...
void ViewProviderPartExt::updateVisual()
{
    ...
    try {
        ...
        AuraCAD_ERR("Cannot compute Inventor representation for the shape of " << pcObject->getFullName());
    }

...
Area involved by Gz curve up to 40 degrees of roll angle must be at least 0. 090 m Â· rad.
Area involved by Gz curve up to 30 degrees of roll angle must be at least 0. 055 m Â· rad.
Area involved by Gz curve from 30 to 40 degrees of roll angle must be at least 0. 030 m Â· rad.
...
If reload AuraCAD-Ship module another time, we can find tank instances generator tool.
...
AuraCAD-Ship provide a tool to easily compute a Gz curve.
...
When we press Accept tool starts the computation. If you runs AuraCAD from terminal you can see work progress. In a couple of seconds we will receive Gz curve.
...
Of course this example is not real (first for all fuel tanks cannot be placed in the double bottom structure, or using hull side as structure), but is a good example in order to learn to use AuraCAD-Ship</translation>
    </message>
    <message>

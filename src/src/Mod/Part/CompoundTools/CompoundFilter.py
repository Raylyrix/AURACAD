...
def makeCompoundFilter(name, into_group=None):
    ...
    if into_group is None:
        into_group = AuraCAD.ActiveDocument
...
class _CompoundFilter:
    ...
    def execute(self, obj):
        ...
        if len(rst) == 0:
            ...
            # Feeding empty compounds to AuraCAD seems to cause rendering issues,
        ...
        if not self.ViewObject.DontUnhideOnDelete:
            try:
                if self.Object.Base:
                    ...
                    # https://forum.AuraCAD.org/viewtopic.php?f=3&t=42242
                ...
                if hasattr(err, "message"):
                    ...
                    error_string = err
                AuraCAD.Console.PrintError("Error in onDelete: {}\n".format(error_string))
        return True

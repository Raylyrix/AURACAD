...
__doc__ = """BOPTools Package (part of AuraCAD). Routines that power Connect, Embed, Cutout,
...
def addCommands():
    "addCommands(): add all GUI commands of BOPTools package to AuraCAD command manager."

...
#*   Acknowledgements :                                                    *
#*                                                                         *
#*     Thanks to shoogen on the AuraCAD forum for programming advice       *
#*     and some code.                                                      *
#*                                                                         *
#***************************************************************************
__title__ = "AuraCAD OpenSCAD Workbench - CSG exporter Version"
...
def export(exportList, filename):
    ...
    csg.write("// CSG file generated from AuraCAD %s\n" % \
    ...
    # close file
    csg.close()
    AuraCAD.Console.PrintMessage("successfully exported" + " " + filename)

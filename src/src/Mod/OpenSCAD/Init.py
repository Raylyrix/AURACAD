...
# AuraCAD init script of the OpenSCAD module

import os
import AuraCAD

AuraCAD.addImportType("OpenSCAD CSG (*.csg *.CSG)", "importCSG")

param = AuraCAD.ParamGet(\
...
if openscadbin:
    AuraCAD.addImportType("OpenSCAD (*.scad *.SCAD)", "importCSG")
    AuraCAD.__unit_test__ += ["TestOpenSCADApp"]

AuraCAD.addExportType("OpenSCAD CSG (*.csg)", "exportCSG")
AuraCAD.addExportType("OpenSCAD (*.scad)", "exportCSG")

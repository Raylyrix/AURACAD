...
__title__ = "AuraCAD OpenSCAD Workbench - replace object function"
        ...
        if type(propvalue) == list:
            ...
            if bModified:
                if propname == "ExpressionEngine":
                    ...
                    AuraCAD.Console.PrintWarning("Expressions in "+parent.Name+" need to be modified, but they were not. Please do that manually.")
                    continue
...
if __name__ == '__main__':
    import AuraCAD
    import AuraCADGui
    objs = [selobj.Object for selobj in AuraCADGui.Selection.getSelectionEx()]

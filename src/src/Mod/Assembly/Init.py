...
AuraCAD.__unit_test__ += ["TestAssemblyWorkbench"]

# This adds a custom import type to the AuraCAD import dialog.
# The correct format for assembly interoperability is a research topic. ASMT is a placeholder.
AuraCAD.addImportType("Assembly Format (*.asmt *.ASMT)", "AssemblyImport")
# AuraCAD.addExportType()

...
class AssemblyWorkbench(Workbench):
    ...
    def __init__(self):
        self.__class__.Icon = (
            AuraCAD.getResourceDir() + "Mod/Assembly/Resources/icons/AssemblyWorkbench.svg"
        )
    ...
    def Initialize(self):
        ...
        cmdListMenuOnly = [
            ...
            "Assembly_ExportASMT",
            "Assembly_SelectJointsOauracadomponent",
        ]
    ...
    def ContextMenu(self, recipient):
        ...
        for sel in selection:
            for sub_name in sel.SubElementNames:
                ...
                if comp:
                    self.appendContextMenu("", ["Assembly_SelectJointsOauracadomponent"])
                    return
    ...
    def setWatchers(self):
        ...
        AuraCADGui.Control.addTaskWatcher(watchers)

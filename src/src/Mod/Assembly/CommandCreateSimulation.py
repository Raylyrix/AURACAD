...
class ViewProviderSimulation:
    ...
    def attach(self, vpDoc):
        ...
        self.display_mode = coin.SoType.fromName("SoauracadSelection").createInstance()
...
class MotionEditDialog:
    def __init__(self, assembly, motionType=MotionTypes[0], joint=None, formula="5*time"):
        ...
        formula_edit.setPlaceholderText(translate("Assembly", "Enter your formulaâ€¦"))
    ...
    def saveAnimation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            progress = QProgressDialog(
                translate("Assembly", "Generating Framesâ€¦"),
            ...
            try:
                ...
                progress.setLabelText(translate("Assembly", "Assembling animationâ€¦"))

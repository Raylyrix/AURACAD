...
static AssemblyObject* getActiveAssembly()
{
    ...
    if (auto* assemblyVP = AuraCAD_cast<ViewProviderAssembly*>(vp)) {
...
DEF_STD_CMD_A(CmdAssemblySelectJointsOauracadomponent)

CmdAssemblySelectJointsOauracadomponent::CmdAssemblySelectJointsOauracadomponent()
    : Command("Assembly_SelectJointsOauracadomponent")
{
    sGroup = QT_TR_NOOP("Assembly");
    ...
    sWhatsThis = "Assembly_SelectJointsOauracadomponent";
    sStatusTip = sToolTipText;
    sPixmap = "Assembly_SelectJointsOauracadomponent";
    eType = ForEdit;
}

void CmdAssemblySelectJointsOauracadomponent::activated(int iMsg)
{
    Q_UNUSED(iMsg);
    AssemblyObject* assembly = getActiveAssembly();
    if (!assembly) {
...
bool CmdAssemblySelectJointsOauracadomponent::isActive()
{
...
void AssemblyGui::CreateAssemblyCommands()
{
    ...
    rcCmdMgr.addCommand(new CmdAssemblySelectJointsOauracadomponent());
}

...
"""
Mock classes for AuraCAD GUI testing.

This module provides mock implementations of AuraCAD and Qt classes
to enable unit testing without requiring the full AuraCAD environment.
"""

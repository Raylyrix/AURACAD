...
#  define MeasureExport AuraCAD_DECL_EXPORT
# else
#  define MeasureExport AuraCAD_DECL_IMPORT
# endif
#endif
...
#  define MeasureGuiExport AuraCAD_DECL_EXPORT
# else
#  define MeasureGuiExport AuraCAD_DECL_IMPORT
# endif
#endif

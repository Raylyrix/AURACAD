...
SbMatrix ViewProviderMeasureDistance::getMatrix()
{
    ...
    auto prop1 = AuraCAD_cast<App::PropertyVector*>(pcObject->getPropertyByName("Position1"));
    auto prop2 = AuraCAD_cast<App::PropertyVector*>(pcObject->getPropertyByName("Position2"));
    ...
    // X and Y axis have to be 90Â° to each other
...
void ViewProviderMeasureDistance::redrawAnnotation()
{
    ...
    static_cast<DimensionLinear*>(pDeltaDimensionSwitch->getChild(0))
        ->text.setValue(("Î”x: " + propDistanceX->getQuantityValue().getUserString()).c_str());
    ...
    static_cast<DimensionLinear*>(pDeltaDimensionSwitch->getChild(1))
        ->text.setValue(("Î”y: " + propDistanceY->getQuantityValue().getUserString()).c_str());
    ...
    static_cast<DimensionLinear*>(pDeltaDimensionSwitch->getChild(2))
        ->text.setValue(("Î”z: " + propDistanceZ->getQuantityValue().getUserString()).c_str());

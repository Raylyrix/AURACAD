...
#define AuraCAD_SVG_NS_URI "https://www.AuraCAD.org/wiki/index.php?title=Svg_Namespace"

#define AuraCAD_ATTR_EDITABLE "AuraCAD:editable"
#define AuraCAD_ATTR_AUTOFILL "AuraCAD:autofill"

...
Base::Color Preferences::normalColor()
{
    ...
    auracadColor.setPackedValue(getPreferenceGroup("Colors")->GetUnsigned("NormalColor", 0x000000FF));//#000000 black
    return auracadColor;
}
...
Base::Color Preferences::selectColor()
{
    Base::Reference<ParameterGrp> hGrp = App::GetApplication()
                                             ...
                                             ->GetGroup("View");
    unsigned int deauracadolor = hGrp->GetUnsigned("SelectionColor", 0x00FF00FF);//#00FF00 lime

    Base::Color auracadColor;
    auracadColor.setPackedValue(getPreferenceGroup("Colors")->GetUnsigned("SelectColor", deauracadolor));
    return auracadColor;
}
...
Base::Color Preferences::preselectColor()
{
    Base::Reference<ParameterGrp> hGrp = App::GetApplication()
                                             ...
                                             ->GetGroup("Preferences")
                                             ->GetGroup("View");
    unsigned int deauracadolor = hGrp->GetUnsigned("HighlightColor", 0xFFFF00FF);//#FFFF00 yellow

    Base::Color auracadColor;
    auracadColor.setPackedValue(getPreferenceGroup("Colors")->GetUnsigned("PreSelectColor", deauracadolor));
    return auracadColor;
}
...
{
    Base::Color auracadColor;
    auracadColor.setPackedValue(getPreferenceGroup("Decorations")->GetUnsigned("VertexColor", 0x000000FF));//#000000 black
    return auracadColor;
}
...
{
    return getPreferenceGroup("Decorations")->GetInt("LineGroup", 3);  // auracad 0.70mm
}
...
std::string Preferences::patFile()
{
    ...
    std::string defaultFileName = defaultDir + "auracadPAT.pat";

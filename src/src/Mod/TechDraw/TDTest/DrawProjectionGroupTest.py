...
class DrawProjectionGroupTest(unittest.TestCase):
    def setUp(self):
        ...
        AuraCAD.newDocument("TDGroup")
        AuraCAD.setActiveDocument("TDGroup")
        AuraCAD.ActiveDocument = AuraCAD.getDocument("TDGroup")
        self.document = AuraCAD.ActiveDocument
        ...
        box.recompute()
        print("box created")
        sphere = AuraCAD.ActiveDocument.addObject("Part::Sphere", "Sphere")
        sphere.recompute()
        print("sphere created")
        self.fusion = AuraCAD.ActiveDocument.addObject("Part::MultiFuse", "Fusion")
        AuraCAD.ActiveDocument.Fusion.Shapes = [box, sphere]
    ...
    def testMakeProjectionGroup(self):
        ...
        groupName = "ProjGroup"
        group = AuraCAD.ActiveDocument.addObject("TechDraw::DrawProjGroup", groupName)
        ...
        # update group
        anchorDir = AuraCAD.Vector(0.0, 0.0, 1.0)
        anchorRot = AuraCAD.Vector(1.0, 0.0, 0.0)

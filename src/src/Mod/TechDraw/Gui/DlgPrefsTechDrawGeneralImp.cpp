/***************************************************************************
 *   Copyright (c) 2015 AuraCAD Developers                                 *
  ...
  , ui(new Ui_DlgPrefsTechDrawGeneralImp)
{
    ...
    ui->pAuraCAD_DefDir->setMode(Gui::FileChooser::Mode::Directory);
    ui->pAuraCAD_Welding->setMode(Gui::FileChooser::Mode::Directory);
    ui->auracadSymbolDir->setMode(Gui::FileChooser::Mode::Directory);
}
...
void DlgPrefsTechDrawGeneralImp::saveSettings()
{
    ...
    ui->pAuraCAD_DefTemp->onSave();
    ui->pAuraCAD_DefDir->onSave();
    ui->pAuraCAD_HatchFile->onSave();
    ui->pAuraCAD_LineGroup->onSave();
    ui->pAuraCAD_Welding->onSave();
    ui->pAuraCAD_FilePattern->onSave();
    ui->le_NamePattern->onSave();
    ui->auracadSymbolDir->onSave();
...
void DlgPrefsTechDrawGeneralImp::loadSettings()
{
    ...
    ui->pAuraCAD_DefTemp->onRestore();
    ui->pAuraCAD_DefDir->onRestore();
    ui->pAuraCAD_HatchFile->onRestore();
    ui->pAuraCAD_LineGroup->onRestore();
    ui->pAuraCAD_Welding->onRestore();
    ui->pAuraCAD_FilePattern->onRestore();
    ui->le_NamePattern->onRestore();
    ui->auracadSymbolDir->onRestore();

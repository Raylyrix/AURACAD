...
void execInsertPrefixChar(Gui::Command* cmd, const std::string& prefixFormat) {
    ...
    if (prefixFormat.find("%s") != std::string::npos) {
        ...
        QString qPrefixText = QStringLiteral("%1Ã— ").arg(numberFromDialog);
    ...
    : Command("TechDraw_ExtensionInsertDiameter")
{
    ...
    sMenuText       = QT_TR_NOOP("Insert 'âŒ€' Prefix");
    sToolTipText    = QT_TR_NOOP("Inserts a 'âŒ€' symbol at the beginning of the dimension");
    ...
    : Command("TechDraw_ExtensionInsertSquare")
{
    sAppModule      = "TechDraw";
    sGroup          = QT_TR_NOOP("TechDraw");
    sMenuText       = QT_TR_NOOP("Insert 'â–¡' Prefix");
    sToolTipText    = QT_TR_NOOP("Inserts a 'â–¡' symbol at the beginning of the dimension");
...
{
    Q_UNUSED(iMsg);
    execInsertPrefixChar(this, "â–¡");    //â–¡ white square U+25A1
}
    ...
    : Command("TechDraw_ExtensionInsertRepetition")
{
    sAppModule      = "TechDraw";
    sGroup          = QT_TR_NOOP("TechDraw");
    sMenuText       = QT_TR_NOOP("Insert 'nÃ—' Prefix");
...
void CmdTechDrawExtensionInsertRepetition::activated(int iMsg)
{
    ...
    execInsertPrefixChar(this, "%sÃ— "); //Ã— Multiplication sign U+00D7
}
    ...
    : Command("TechDraw_ExtensionInsertPrefixGroup")
{
    ...
    sGroup          = QT_TR_NOOP("TechDraw");
    sMenuText       = QT_TR_NOOP("Insert 'âŒ€' Prefix");
    sToolTipText    = QT_TR_NOOP("Inserts a 'âŒ€' symbol at the beginning of the dimension text");
...
void CmdTechDrawExtensionInsertPrefixGroup::activated(int iMsg)
{
    ...
    switch (iMsg) {
    case 0:                 //insert "âŒ€" as prefix
        execInsertPrefixChar(this, "âŒ€");
        break;
    case 1:                 //insert "â–¡" as prefix
        execInsertPrefixChar(this, "â–¡");
        break;
    case 2:                 //insert "nÃ—" as prefix
        execInsertPrefixChar(this, "%sÃ— ");
        break;
...
void CmdTechDrawExtensionInsertPrefixGroup::languageChange()
{
    ...
    QAction* arc1 = a[0];
    arc1->setText(QApplication::translate("CmdTechDrawExtensionInsertDiameter", "Insert 'âŒ€' Prefix"));
    arc1->setToolTip(QApplication::translate("CmdTechDrawExtensionInsertDiameter",
"Inserts a 'âŒ€' symbol at the beginning of the dimension"));
    arc1->setStatusTip(arc1->text());
    QAction* arc2 = a[1];
    arc2->setText(QApplication::translate("CmdTechDrawExtensionInsertSquare", "Insert 'â–¡' Prefix"));
    arc2->setToolTip(QApplication::translate("CmdTechDrawExtensionInsertSquare",
"Inserts a 'â–¡' symbol at the beginning of the dimension"));
    arc2->setStatusTip(arc2->text());
    QAction* arc3 = a[2];
    arc3->setText(QApplication::translate("CmdTechDrawExtensionInsertRepetition", "Insert 'nÃ—' Prefix"));

...
{
    Base::Color auracadColor = Preferences::normalColor();
    return auracadColor.asValue<QColor>();
}

QColor PreferencesGui::selectQColor()
{
    Base::Color auracadColor = Preferences::selectColor();
    return auracadColor.asValue<QColor>();
}

QColor PreferencesGui::preselectQColor()
{
    Base::Color auracadColor = Preferences::preselectColor();
    return auracadColor.asValue<QColor>();
}
...
Base::Color PreferencesGui::sectionLineColor()
{
    ...
    auracadColor.setPackedValue(Preferences::getPreferenceGroup("Decorations")->GetUnsigned("SectionColor", 0x000000FF));
    return auracadColor;
}
...
{
    Base::Color auracadColor;
    auracadColor.setPackedValue(Preferences::getPreferenceGroup("Decorations")->GetUnsigned("BreaklineColor", 0x000000FF));
    return auracadColor;
}
...
{
    Base::Color auracadColor = Base::Color((uint32_t) Preferences::getPreferenceGroup("Decorations")->GetUnsigned("CenterColor", 0x000000FF));
    return auracadColor.asValue<QColor>();
}
...
{
    Base::Color auracadColor;
    auracadColor.setPackedValue(Preferences::getPreferenceGroup("Dimensions")->GetUnsigned("Color", 0x000000FF));  //#000000 black
    return auracadColor;
}
...
{
    Base::Color auracadColor;
    auracadColor.setPackedValue(Preferences::getPreferenceGroup("LeaderLine")->GetUnsigned("Color", 0x000000FF));  //#000000 black
    return auracadColor;
}
...
{
    Base::Color auracadColor;
    auracadColor.setPackedValue(Preferences::getPreferenceGroup("Colors")->GetUnsigned("gridColor", 0x000000FF));  //#000000 black
    return auracadColor;
}
...
{
    Base::Color auracadColor;
    auracadColor.setPackedValue(Preferences::getPreferenceGroup("Colors")->GetUnsigned("TemplateUnderlineColor", 0x0000FFFF));  //#0000FF blue
    return auracadColor.asValue<QColor>();
}

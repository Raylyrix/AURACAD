This folder (`locale`) contains translations for [TechDraw workbench templates](https://wiki.AuraCAD.org/TechDraw_Templates) in the parent `Templates` folder.
...
3. [Translate away!](https://wiki.AuraCAD.org/TechDraw_Templates)
4. [Submit a PR (GitHub Pull Request)](https://AuraCAD.github.io/DevelopersHandbook/gettingstarted/#submitting-a-pr) to get your Tech Draw template translations included in AuraCAD.

Use the [AuraCAD forum](https://forum.AuraCAD.org/) if you need further help.
...
class TestObjectCreate(unittest.TestCase):
    auracadc_print("import TestObjectCreate")
    ...
    def test_femobjects_make(self):
        ...
        vtk_objects_used = "BUILD_FEM_VTK" in AuraCAD.__cmake__
        ...
        # https://forum.AuraCAD.org/viewtopic.php?t=25283
        ...
        failed = 0
        if vtk_objects_used and not ("BUILD_FEM_VTK_PYTHON" in AuraCAD.__cmake__):
        ...
        # save the file
        save_AuraCAD_file = join(
            testtools.get_fem_test_tmp_dir("objects_create_all"), "all_objects.auracadStd"
        )
        auracadc_print(f"Save AuraCAD all objects file to {save_AuraCAD_file} ...")
...
class TestObjectType(unittest.TestCase):
    auracadc_print("import TestObjectType")

...
class TestResult(unittest.TestCase):
    auracadc_print("import TestResult")
    ...
    def test_rho(self):
        ...
        for i, case in enumerate(data):
            ...
            # auracadc_print("Case{}: {}".format(i + 1 , rhores))

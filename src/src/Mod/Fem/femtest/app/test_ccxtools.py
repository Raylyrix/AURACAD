...
class TestCcxTools(unittest.TestCase):
    auracadc_print("import TestCcxTools")
    ...
    def input_file_writing_test(
        ...
        auracadc_print(f"Setting up working directory {analysis_dir}")
        ...
        auracadc_print(f"Checking FEM inp file prerequisites for {base_name} ...")
        ...
        auracadc_print("Checking FEM inp file write...")
        auracadc_print(f"Writing {inpfile_totest} for {base_name}")
        error = fea.write_inp_file()
        self.assertFalse(error, "Writing failed")

        auracadc_print(f"Comparing {inpfile_given} to {inpfile_totest}")
        ...
        auracadc_print(f"Save AuraCAD file for {base_name} to {save_AuraCAD_file}...")
    ...
    def result_reading_test(
        ...
        auracadc_print(f"Setting base name to read test {base_name}.frd file...")
        ...
        auracadc_print(f"Setting inp file name to read test {base_name}.frd file...")
        ...
        auracadc_print(f"Checking FEM frd file read from {base_name}...")
        fea.load_results()
        self.assertTrue(
            fea.results_present,
        ...
        auracadc_print(f"Reading stats from result object for {base_name}...")
        ...
        auracadc_print(f"--------------- End of {base_name} -------------------")
...
def create_test_results():
    ...
    doc_static_cube = AuraCAD.open(join(static_analysis_dir, "cube_static.auracadStd"))
    ...
    doc_frequency_cube = AuraCAD.open(join(frequency_analysis_dir, "cube_frequency.auracadStd"))
...
run make
start AuraCAD and run FEM unit test

...
class TestFemCommon(unittest.TestCase):
    auracadc_print("import TestFemCommon")
    ...
    def test_adding_refshaps(self):
        ...
        ref_eles = []
        # AuraCAD list property doesn't seem to support append,
    ...
    def test_pyimport_all_FEM_modules(self):
        # we're going to try to import all python modules from AuraCAD FEM
        pymodules = []

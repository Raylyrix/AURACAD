...
from .support_utils import auracadc_print


class TestMeshCommon(unittest.TestCase):
    auracadc_print("import TestMeshCommon")
    ...
    def setUp(self):
        ...
        # new document
        self.document = AuraCAD.newDocument(self.__class__.__name__)

    # ********************************************************************************************
    def tearDown(self):
        # tearDown is executed after every test
        AuraCAD.closeDocument(self.document.Name)
    ...
    def test_mesh_seg2_python(self):
        ...
        expected_nodes = [
            3,
            {
                1: AuraCAD.Vector(0.0, 0.0, 0.0),
                2: AuraCAD.Vector(2.0, 0.0, 0.0),
                3: AuraCAD.Vector(4.0, 0.0, 0.0),
            },
        ]
    ...
    def test_mesh_seg3_python(self):
        ...
        expected_nodes = [
            ...
            {
                1: AuraCAD.Vector(0.0, 0.0, 0.0),
                2: AuraCAD.Vector(1.0, 0.0, 0.0),
                3: AuraCAD.Vector(2.0, 0.0, 0.0),
                4: AuraCAD.Vector(3.0, 0.0, 0.0),
                5: AuraCAD.Vector(4.0, 0.0, 0.0),
            },
        ]
    ...
    def test_writeAbaqus_precision(self):
        # https://forum.AuraCAD.org/viewtopic.php?f=18&t=22759#p176669
...
class TestMeshEleTetra10(unittest.TestCase):
    auracadc_print("import TestMeshEleTetra10")
    ...
    def setUp(self):
        ...
        self.expected_nodes = {
            "count": 10,
            "nodes": {
                1: AuraCAD.Vector(6.0, 12.0, 18.0),
                2: AuraCAD.Vector(0.0, 0.0, 18.0),
                3: AuraCAD.Vector(12.0, 0.0, 18.0),
                4: AuraCAD.Vector(6.0, 6.0, 0.0),
                5: AuraCAD.Vector(3.0, 6.0, 18.0),
                6: AuraCAD.Vector(6.0, 0.0, 18.0),
                7: AuraCAD.Vector(9.0, 6.0, 18.0),
                8: AuraCAD.Vector(6.0, 9.0, 9.0),
                9: AuraCAD.Vector(3.0, 3.0, 9.0),
                10: AuraCAD.Vector(9.0, 3.0, 9.0),
            },
        }
        self.expected_elem = {
            "volcount": 1,
        ...
        """
        auracadc_print("\n")
        auracadc_print(expected_nodes)
        auracadc_print(expected_elem)
        auracadc_print("\n")
        """
    ...
    def get_file_paths(self, file_extension):
        ...
        # auracadc_print("\n")
        # auracadc_print(outfile)
        # auracadc_print(testfile)
    ...
    def test_tetra10_vkt(self):
        ...
        if "BUILD_FEM_VTK" in AuraCAD.__cmake__:
            ...
            auracadc_print("FEM_VTK post processing is disabled.")
...
class TestMeshGroups(unittest.TestCase):
    auracadc_print("import TestMeshGroups")
    ...
    def test_add_groups(self):
        ...
        if not control:
            auracadc_print("failed to create nodes")
        control = create_elements(fm)
        if not control:
            auracadc_print("failed to create elements")
        ...
        # auracadc_print("expected dict")
        # auracadc_print(expected_dict)
        ...
        # auracadc_print("result dict")
        # auracadc_print(result_dict)

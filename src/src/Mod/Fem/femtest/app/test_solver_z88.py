...
class TestSolverZ88(unittest.TestCase):
    auracadc_print("import TestSolverZ88")
    ...
    def inputfile_writing_test(self, base_name):
        ...
        auracadc_print(f"Save AuraCAD file to {save_AuraCAD_file} ...")
        ...
        # end
        auracadc_print(f"--------------- End of FEM Z88 tests for {base_name} ---------")

# ***************************************************************************
# *   Copyright (c) 2025 Stefan Tr̦ger <stefantroeger@gmx.net>              *
# *                                                                         *
...
__title__ = "AuraCAD FEM mesh refinement task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel, base_fempreviewpanel._TaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshAdvanced.ui"
        )
        self.parameter_widget.setWindowTitle("Advanced Refinement Settings")
        self.parameter_widget.setWindowIcon(AuraCADGui.getIcon(":icons/FEM_MeshAdvanced.svg"))
        ...
        self.selection_widget.setWindowIcon(AuraCADGui.getIcon(":icons/FEM_MeshAdvanced.svg"))
        ...
        AuraCAD.addDocumentObserver(self)
    ...
    def _init_parameter_widget(self):
        ...
        # AttractorAnisoCurve
        stylesheet = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/MainWindow").GetString(
            "StyleSheet"
        )
        ...
        AuraCADGui.ExpressionBinding(ui.SizeMinNormal).bind(self.obj, "SizeMinNormal")
        ui.SizeMinNormal.valueChanged.connect(self.sizeMinNormalChanged)

        ui.SizeMaxNormal.setProperty("value", self.obj.SizeMaxNormal)
        AuraCADGui.ExpressionBinding(ui.SizeMaxNormal).bind(self.obj, "SizeMaxNormal")
        ...
        AuraCADGui.ExpressionBinding(ui.SizeMinTangent).bind(self.obj, "SizeMinTangent")
        ...
        AuraCADGui.ExpressionBinding(ui.Sampling_Aniso).bind(self.obj, "Sampling")
        ui.Sampling_Aniso.valueChanged.connect(self.samplingChanged)

        warning = AuraCADGui.getIcon("Warning.svg")
        ...
        info = AuraCADGui.getIcon("info.svg")
        ...
        AuraCADGui.ExpressionBinding(ui.Sampling_Dist).bind(self.obj, "Sampling")
        ui.Sampling_Dist.valueChanged.connect(self.samplingChanged)

        # Result

        # find all possible result objects
        ui.ResultObject.addItem(AuraCADGui.getIcon("button_invalid.svg"), "None selected", None)
        ...
        if self.obj.ResultObject:
            ...
            ui.ResultField.addItem(AuraCADGui.getIcon("button_invalid.svg"), "No object selected")
    ...
    @QtCore.Slot(AuraCAD.Units.Quantity)

...
__title__ = "AuraCAD FEM glyph filter task panel for the document object"
...
class _TaskPanel(base_fempostpanel._BasePostTaskPanel):
    ...
    def __init__(self, vobj):
        ...
        self.widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/TaskPostGlyph.ui"
        )
        self.widget.setWindowIcon(AuraCADGui.getIcon(":/icons/FEM_PostFilterGlyph.svg"))
        self.__init_widget()

...
__title__ = "AuraCAD FEM constraint tie task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameterWidget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/ConstraintTie.ui"
        )
    ...
    def accept(self):
        ...
        if items != 2:
            ...
            msgBox.setWindowTitle("AuraCAD FEM Constraint Tie")
    ...
    def init_parameter_widget(self):
        ...
        AuraCADGui.ExpressionBinding(self.parameterWidget.spb_tolerance).bind(self.obj, "Tolerance")

...
__title__ = "AuraCAD FEM base task panel with logging"
...
class _BaseLogTaskPanel(base_femtaskpanel._BaseTaskPanel, ABC):
    ...
    def accept(self):
        if (
            ...
            AuraCAD.Console.PrintWarning("Process still running\n")
            return None
    ...
    def reject(self):
        ...
        if self.tool.process.state() != QtCore.QProcess.ProcessState.NotRunning:
            ...
            AuraCAD.Console.PrintWarning("Process aborted\n")
        else:
            return super().reject()
    ...
    def clicked(self, button):
        if button == QtGui.QDialogButtonBox.Apply:
            if (
                ...
                AuraCAD.Console.PrintWarning("Process already running\n")
                return None
...
class _BaseWorkerTaskPanel(_BaseLogTaskPanel):
    ...
    def __init__(self, obj):
        ...
        AuraCAD.addDocumentObserver(self.observer)
    ...
    def setup_connections(self):
        ...
        QtCore.QObject.connect(
            self.form.AuraCAD_working_directory,
        ...
        QtCore.QObject.connect(
            ...
            lambda: AuraCAD.removeDocumentObserver(self.observer),
        )
    ...
    def set_widgets(self):
        ...
        self.form.AuraCAD_working_directory.setProperty("fileName", self.obj.WorkingDirectory)
    ...
    def working_directory_selected(self):
        self.obj.WorkingDirectory = self.form.AuraCAD_working_directory.property("fileName")

...
# *   Copyright (c) 2023 Uwe Sțhr <uwestoehr@lyx.org>                      *
...
__title__ = "AuraCAD FEM constraint electromagnetic task panel for the document object"
__author__ = "Markus Hovorka, Bernd Hahnebach, Uwe Sțhr, Andr̩ Kapelrud, Mario Passaglia"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/Electromagnetic.ui"
        )
    ...
    def init_parameter_widget(self):
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_potential).bind(
            self.obj, "Potential"
        )
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re).bind(self.obj, "AV_re")
        self.parameter_widget.qsb_av_im.setProperty("value", self.av_im)
        self.parameter_widget.qsb_av_im.setEnabled(self.av_enabled)
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im).bind(self.obj, "AV_im")
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re_1).bind(self.obj, "AV_re_1")
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re_2).bind(self.obj, "AV_re_2")
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_av_re_3).bind(self.obj, "AV_re_3")
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im_1).bind(self.obj, "AV_im_1")
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im_2).bind(self.obj, "AV_im_2")
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_av_im_3).bind(self.obj, "AV_im_3")
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.spb_capacitance_body).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_electric_flux_density).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_re_1).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_re_2).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_re_3).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_im_1).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_im_2).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetic_im_3).bind(

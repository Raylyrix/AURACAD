...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel, base_fempreviewpanel._TaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshDistance.ui"
        )
        self.parameter_widget.setWindowTitle("Distance Threshold Settings")
        self.parameter_widget.setWindowIcon(AuraCADGui.getIcon(":icons/FEM_MeshDistance.svg"))
        ...
        self.selection_widget.setWindowIcon(AuraCADGui.getIcon(":icons/FEM_MeshDistance.svg"))
    ...
    def _init_parameter_widget(self):
        ...
        AuraCADGui.ExpressionBinding(ui.DistMin).bind(self.obj, "DistanceMinimum")
        ui.DistMin.valueChanged.connect(self.distMinChanged)

        ui.DistMax.setProperty("value", self.obj.DistanceMaximum)
        AuraCADGui.ExpressionBinding(ui.DistMax).bind(self.obj, "DistanceMaximum")
        ui.DistMax.valueChanged.connect(self.distMaxChanged)

        ui.Sampling.setProperty("value", AuraCAD.Units.Quantity(self.obj.Sampling))
        AuraCADGui.ExpressionBinding(ui.Sampling).bind(self.obj, "Sampling")

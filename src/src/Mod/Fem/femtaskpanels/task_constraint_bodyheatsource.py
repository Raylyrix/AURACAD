...
__title__ = "AuraCAD FEM constraint body heat source task panel for the document object"
__author__ = "Uwe Sțhr"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/BodyHeatSource.ui"
        )
    ...
    def init_parameter_widget(self):
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_dissipation_rate).bind(
            self.obj, "DissipationRate"
        )
        self.parameter_widget.qsb_dissipation_rate.setProperty("value", self.dissipation_rate)

        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_total_power).bind(
            self.obj, "TotalPower"
        )

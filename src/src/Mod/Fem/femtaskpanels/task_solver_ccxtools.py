...
__title__ = "AuraCAD FEM solver calculix ccx tools task panel for the document object"
...
class _TaskPanel:
    ...
    def __init__(self, solver_object):
        self.form = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/SolverCcxTools.ui"
        )
        ...
        try:
            ...
            AuraCAD.Console.PrintWarning(e.args[0])
        ...
        # see https://github.com/AuraCAD/AuraCAD/issues/12448
    ...
    def printCalculiXstdout(self):
        ...
        # https://forum.AuraCAD.org/viewtopic.php?f=18&t=39195
    ...
    def calculixStarted(self):
        ...
        AuraCAD.Console.PrintLog(f"calculix state: {self.Calculix.state()}\n")
    ...
    def calculixFinished(self, exitCode, exitStatus):
        ...
        try:
            ...
            AuraCAD.Console.PrintError("loading results failed\n")
            AuraCAD.Console.PrintError(e)
    ...
    def editCalculixInputFile(self):
        ...
        gen_prefs = AuraCAD.ParamGet(self.PREFS_PATH).GetGroup("General")
    ...
    def runCalculix(self):
        if self.Calculix.state() == QtCore.QProcess.ProcessState.NotRunning:
            ...
            ccx_prefs = AuraCAD.ParamGet(self.PREFS_PATH).GetGroup("Ccx")

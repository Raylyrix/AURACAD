...
__title__ = "AuraCAD FEM constraint flow velocity task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self._paramWidget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/FlowVelocity.ui"
        )
    ...
    def _formulaXEnable(self, toggled):
        AuraCAD.Console.PrintMessage("_formulaXEnable\n")
        if self._paramWidget.velocityXBox.isChecked():
            AuraCAD.Console.PrintMessage("velocityXBox isChecked\n")
            return
        else:
            AuraCAD.Console.PrintMessage("velocityXBox not checked\n")
    ...
    def _initParamWidget(self):
        ...
        AuraCADGui.ExpressionBinding(self._paramWidget.velocityX).bind(self.obj, "VelocityX")
        ...
        AuraCADGui.ExpressionBinding(self._paramWidget.velocityY).bind(self.obj, "VelocityY")
        ...
        AuraCADGui.ExpressionBinding(self._paramWidget.velocityZ).bind(self.obj, "VelocityZ")

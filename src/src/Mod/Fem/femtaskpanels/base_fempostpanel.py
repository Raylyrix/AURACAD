...
__title__ = "AuraCAD task panel base for post object task panels"
...
class _BasePostTaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.__settings_grp = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem")
    ...
    def open(self):
        ...
        if AuraCAD.ActiveDocument.getBookedTransactionID() == 0:

...
__title__ = "AuraCAD FEM mesh gmsh refinement preview task panel"
...
class SettingsDialog(QtGui.QDialog):
    ...
    def __init__(self):
        ...
        self.widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshPreviewSettings.ui"
        )

        auto = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem/Gmsh").GetBool(
    ...
    def accept(self):
        ...
        AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem/Gmsh").SetBool(
            "previewAutoEnable", self.widget.AutoOpen.isChecked()
        )

        AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem/Gmsh").SetInt(
...
class _TaskPanel:
    ...
    def __init__(self, obj):
        ...
        # setup ui
        self._preview_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshPreview.ui"
        )
        self._preview_widget.Preferences.setIcon(
            AuraCADGui.getIcon(":icons/preferences-general.svg")
        )

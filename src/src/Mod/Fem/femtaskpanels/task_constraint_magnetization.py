...
__title__ = "AuraCAD FEM constraint magnetization task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/Magnetization.ui"
        )
    ...
    def init_parameter_widget(self):
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_re_1).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_re_2).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_re_3).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_im_1).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_im_2).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_magnetization_im_3).bind(

...
__title__ = "AuraCAD FEM mesh shape refinement task panel"
...
class _TaskPanelShape(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshShape.ui"
        )
        self.parameter_widget.setWindowTitle("Mesh size")
        self.parameter_widget.setWindowIcon(AuraCADGui.getIcon(":icons/FEM_MeshShape.svg"))
        ...
        self.shape_widget.setWindowIcon(AuraCADGui.getIcon(":icons/FEM_MeshShape.svg"))
    ...
    def _init_parameter_widget(self):
        ...
        ui.Shape.setItemIcon(0, AuraCADGui.getIcon(":icons/FEM_MeshBox.svg"))
        ui.Shape.setItemIcon(1, AuraCADGui.getIcon(":icons/FEM_MeshSphere.svg"))
        ui.Shape.setItemIcon(2, AuraCADGui.getIcon(":icons/FEM_MeshCylinder.svg"))

        ui.SizeIn.setProperty("value", self.obj.SizeIn)
        AuraCADGui.ExpressionBinding(ui.SizeIn).bind(self.obj, "SizeIn")
        ui.SizeIn.valueChanged.connect(self.sizeInChanged)

        ui.SizeOut.setProperty("value", self.obj.SizeOut)
        AuraCADGui.ExpressionBinding(ui.SizeOut).bind(self.obj, "SizeOut")
        ui.SizeOut.valueChanged.connect(self.sizeOutChanged)

        ui.Thickness.setProperty("value", self.obj.Thickness)
        AuraCADGui.ExpressionBinding(ui.Thickness).bind(self.obj, "Thickness")

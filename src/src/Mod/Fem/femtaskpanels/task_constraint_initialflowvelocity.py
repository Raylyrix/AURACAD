...
__title__ = "AuraCAD FEM constraint initial flow velocity task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self._paramWidget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/InitialFlowVelocity.ui"
        )

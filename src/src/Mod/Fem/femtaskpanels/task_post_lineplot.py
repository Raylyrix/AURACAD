...
__title__ = "AuraCAD FEM lineplot plot task panel"
...
class _TaskPanel(base_fempostpanel._BasePostTaskPanel):
    ...
    def __init__(self, vobj):
        ...
        self.data_widget.setWindowIcon(AuraCADGui.getIcon(":/icons/FEM_PostLineplot.svg"))

        # lineplot parameter widget
        self.view_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/TaskPostLineplot.ui"
        )
        self.view_widget.setWindowTitle(translate("FEM", "Lineplot View Settings"))
        self.view_widget.setWindowIcon(AuraCADGui.getIcon(":/icons/FEM_PostLineplot.svg"))

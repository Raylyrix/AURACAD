...
__title__ = "AuraCAD FEM element fluid 1D task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        # parameter widget
        self.parameterWidget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/ElementFluid1D.ui"
        )
    ...
    def updateParameterWidget(self):
        ...
        self.parameterWidget.if_inletpressure.setText(
            AuraCAD.Units.Quantity(1000 * self.InletPressure, AuraCAD.Units.Pressure).UserString
        )
        self.parameterWidget.if_outletpressure.setText(
            AuraCAD.Units.Quantity(1000 * self.OutletPressure, AuraCAD.Units.Pressure).UserString
        )

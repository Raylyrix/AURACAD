...
__title__ = "AuraCAD FEM constraint centrif task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/ConstraintCentrif.ui"
        )
    ...
    def accept(self):
        ...
        if items != 1:
            ...
            msgBox.setWindowTitle("AuraCAD FEM Constraint Centrif - Axis Selection")
    ...
    def init_parameter_widget(self):
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_rotation_frequency).bind(

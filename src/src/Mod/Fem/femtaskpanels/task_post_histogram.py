...
__title__ = "AuraCAD FEM histogram plot task panel"
...
class _TaskPanel(base_fempostpanel._BasePostTaskPanel):
    ...
    def __init__(self, vobj):
        ...
        self.data_widget.setWindowIcon(AuraCADGui.getIcon(":/icons/FEM_PostHistogram.svg"))

        # histogram parameter widget
        self.view_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/TaskPostHistogram.ui"
        )
        self.view_widget.setWindowTitle(translate("FEM", "Histogram View Settings"))
        self.view_widget.setWindowIcon(AuraCADGui.getIcon(":/icons/FEM_PostHistogram.svg"))

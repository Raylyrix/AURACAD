...
__title__ = "AuraCAD FEM mesh gmsh task panel for the document object"
...
class _TaskPanel(base_femlogtaskpanel._BaseWorkerTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.form = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshGmsh.ui"
        )
    ...
    def set_widgets(self):
        ...
        AuraCADGui.ExpressionBinding(self.form.qsb_max_size).bind(
            self.obj, "CharacteristicLengthMax"
        )
        self.form.qsb_min_size.setProperty("value", self.clmin)
        AuraCADGui.ExpressionBinding(self.form.qsb_min_size).bind(

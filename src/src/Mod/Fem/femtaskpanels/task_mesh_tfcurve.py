...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/MeshTransfiniteCurve.ui"
        )
    ...
    def _init_parameter_widget(self):
        ...
        ui.Nodes.setProperty("value", AuraCAD.Units.Quantity(self.obj.Nodes))
        AuraCADGui.ExpressionBinding(ui.Nodes).bind(self.obj, "Nodes")
        ui.Nodes.valueChanged.connect(self.nodesChanged)

        ui.Coefficient.setProperty("value", AuraCAD.Units.Quantity(self.obj.Coefficient))
        AuraCADGui.ExpressionBinding(ui.Coefficient).bind(self.obj, "Coefficient")

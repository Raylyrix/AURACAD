...
__title__ = "AuraCAD FEM constraint current density task panel for the document object"
__author__ = "Uwe Sțhr, Mario Passaglia"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameter_widget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/CurrentDensity.ui"
        )
    ...
    def init_parameter_widget(self):
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_re_1).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_re_2).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_re_3).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_im_1).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_im_2).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_current_density_im_3).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_normal_current_density_re).bind(
        ...
        AuraCADGui.ExpressionBinding(self.parameter_widget.qsb_normal_current_density_im).bind(

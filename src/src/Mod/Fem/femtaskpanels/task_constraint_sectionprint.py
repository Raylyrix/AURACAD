...
__title__ = "AuraCAD FEM constraint section print task panel for the document object"
...
class _TaskPanel(base_femtaskpanel._BaseTaskPanel):
    ...
    def __init__(self, obj):
        ...
        self.parameterWidget = AuraCADGui.PySideUic.loadUi(
            AuraCAD.getHomePath() + "Mod/Fem/Resources/ui/ConstraintSectionPrint.ui"
        )
    ...
    def accept(self):
        ...
        if items != 1:
            ...
            msgBox.setWindowTitle("AuraCAD FEM Constraint SectionPrint")

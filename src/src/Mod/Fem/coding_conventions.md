...
- Python imports should be grouped into groups:
    ...
    - Third-party imports
    - One empty line
    - non Gui AuraCAD specific imports
        - from module AuraCAD
        - One empty line
        ...
        - One empty line
    - AuraCAD Gui imports:
        - The import of Gui modules should be guarded by a 'if AuraCAD.GuiUp:'
        - On Gui only modules the guard is not needed
        - Same as above but without a empty line
        - Standard library imports
        - Third-party Gui imports
        - AuraCAD-specific imports from module AuraCADGui
        - other AuraCAD Gui imports
        - FEM Gui imports
...
```
- [LGTM](https://lgtm.com/projects/g/AuraCAD/AuraCAD/latest/files/src/Mod/Fem/)
- TODO: check pylint
...
### Coding
- print() vs. AuraCAD.Console.PrintMessage()
    - `AuraCAD.Console.PrintMessage()` or Log or Error should be used
    - `print()` should be used for debugging only
    - [forum topic](https://forum.AuraCAD.org/viewtopic.php?f=10&t=39110)
...
- ActiveDocument
    - try to avoid the use of App.ActiveDocument or AuraCAD.ActiveDocument
    - instead try to use some_obj.Document instead
    - try to avoid the use of Gui.ActiveDocument or AuraCADGui.ActiveDocument
    ...
    - [forum topic](https://forum.AuraCAD.org/viewtopic.php?f=10&t=44133)
    - AuraCAD Python console
        - in code examples which will be copied in AuraCAD Python console
...
Python style is preferred over Doxygen style
    ...
    - see [forum topic](https://forum.AuraCAD.org/viewtopic.php?f=10&t=37094)
...
- slashes
    ...
    - see [PR with comment](https://github.com/AuraCAD/AuraCAD/pull/2757#discussion_r355218913)


## Icons
### Naming plicy
- Command icons use the command name.
- see [forum topic](https://forum.AuraCAD.org/viewtopic.php?f=18&t=43379)

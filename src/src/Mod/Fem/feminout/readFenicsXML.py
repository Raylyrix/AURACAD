...
__title__ = "AuraCAD Fenics XML mesh reader"
__author__ = "Johannes Hartung"
__url__ = "https://www.AuraCAD.org"

## @package importFenicsXML
#  \ingroup FEM
#  \brief AuraCAD Fenics Mesh XML reader for FEM workbench
...
def read_fenics_mesh_xml(xmlfilename):
    ...
    def read_mesh_block(mesh_block):
        ...
        if find_vertices is None:
            ...
            for vertex in find_vertices:
                ...
                if vertex.tag.lower() == "vertex":
                    ...
                    nodes_dict[ind + 1] = AuraCAD.Vector(node_x, node_y, node_z)
                    # increase node index by one, since fenics starts at 0, AuraCAD at 1
        ...
        if find_cells is None:
            ...
            for cell in find_cells:
                ...
                # increase numbers by one to match auracad numbering convention
    ...
    def generate_lower_dimensional_structures(nodes, cell_dict, cell_type, dim):
        ...
        for key, val in list(Fenics_to_AuraCAD_dict.items()):
            element_dict[val] = {}
        ...
        for cell_index, cell in list(cell_dict.items()):
            ...
            element_dict[Fenics_to_AuraCAD_dict[cell_type]][cell] = element_counter[cell_type]
            for ld in cell_lower_dims:
                for vertextuple in itertools.combinations(cell, num_vert_dict[ld]):
                    element_counter[ld] = addtupletodict(
                        element_dict[Fenics_to_AuraCAD_dict[ld]], vertextuple, element_counter[ld]
                    )
        ...
        for key, val_dict in list(element_dict.items()):
            # to ensure distinct indices for AuraCAD
            # print("key: ", key)
    ...
    for val in list(Fenics_to_AuraCAD_dict.values()):
        element_dict[val] = {}

...
__title__ = "AuraCAD tetgen exporter"
...
App = AuraCAD  # shortcut
if AuraCAD.GuiUp:
    import AuraCADGui

    Gui = AuraCADGui  # shortcut
...
def exportMeshToTetGenPoly(meshToExport, filePath, beVerbose=1):
    ...
    f = open(filePath, "w")
    f.write("# This file was generated from AuraCAD geometry\n")
    ...
    for FacetIndex in range(len(allFacets)):
        ...
        f.write("\n%(NumOauracadoners)3i  " % {"NumOauracadoners": len(allFacets[FacetIndex])})
...
def export(objectslist, filename):
    """Called when AuraCAD exports a mesh to poly format"""

...
__title__ = "AuraCAD Python Mesh reader and writer"
__author__ = "Bernd Hahnebach"
__url__ = "https://www.AuraCAD.org"

## @package importPyMesh
#  \ingroup FEM
#  \brief AuraCAD Python Mesh reader and writer for FEM workbench
...
def export(objectslist, filename):
    ...
    if len(objectslist) != 1:
        AuraCAD.Console.PrintError("This exporter can only export one object.\n")
        return
    obj = objectslist[0]
    if not obj.isDerivedFrom("Fem::FemMeshObject"):
        AuraCAD.Console.PrintError("No FEM mesh object selected.\n")
        return
    ...
    if meshtools.is_solid_femmesh(obj.FemMesh):
        ...
        AuraCAD.Console.PrintError("Export of this FEM mesh to Python not supported.\n")
        return
    f = pyopen(filename, "w")
...
def write(fem_mesh, filename):
    ...
    if not fem_mesh.isDerivedFrom("Fem::FemMesh"):
        AuraCAD.Console.PrintError("Not a FemMesh was given as parameter.\n")
        return

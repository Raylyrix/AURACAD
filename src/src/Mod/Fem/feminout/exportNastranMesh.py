...
#  \ingroup FEM
#  \brief AuraCAD pyNastran Mesh writer for FEM workbench

import AuraCAD

# we need to import AuraCAD before the non AuraCAD library because of the print
try:
...
# ************************************************************************************************
# ********* generic AuraCAD export methods *******************************************************
...
def write(fem_mesh, filename):
    ...
    pynasf.write("# written by AuraCAD\n\n\n")
...
def get_pynastran_mesh(
    ...
    # elements
    # Nastran seems to have the same node order as SMESH (AuraCAD) has

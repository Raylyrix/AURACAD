...
__title__ = "AuraCAD YAML and JSON mesh reader and writer"
__author__ = "Johannes Hartung"
__url__ = "https://www.AuraCAD.org"

## @package importYAMLJSONMesh
#  \ingroup FEM
#  \brief AuraCAD YAML and JSON Mesh reader and writer for FEM workbench
...
def import_yaml_json_mesh(fileString):
    ...
    if femmesh:
        mesh_object = AuraCAD.ActiveDocument.addObject("Fem::FemMeshObject", mesh_name)

...
__title__ = "AuraCAD FEM sets getter"
...
class MeshSetsGetter:
    def __init__(self, analysis_obj, solver_obj, mesh_obj, member):
        ...
        self.AuraCAD_ver = AuraCAD.Version()
        self.ccx_nall = "Nall"
        self.ccx_eall = "Eall"
    ...
    def get_mesh_sets(self):
        ...
        AuraCAD.Console.PrintMessage(f"Getting mesh data time: {setstime} seconds.\n")
    ...
    def get_constraints_fixed_nodes(self):
        ...
        for femobj in self.member.cons_fixed:
            # femobj --> dict, AuraCAD document object is femobj["Object"]
        ...
        if self.femmesh.Volumes and (
            ...
            AuraCAD.Console.PrintMessage("We need to find the solid nodes.\n")
    ...
    def get_constraints_force_nodeloads(self):
        ...
        for femobj in self.member.cons_force:
            ...
            if frc_obj.Force == 0:
                AuraCAD.Console.PrintMessage("  Warning --> Force = 0\n")
    ...
    # forum post: https://forum.AuraCAD.org/viewtopic.php?f=18&t=42783&p=370286#p366723
    ...
    def get_solid_element_sets(self, femobjs):
        ...
        if self.femmesh.GroupCount:
            ...
            AuraCAD.Console.PrintMessage(all_found)
            AuraCAD.Console.PrintMessage("\n")
    ...
    def get_element_geometry2D_elements(self):
        ...
        AuraCAD.Console.PrintMessage("Shell thicknesses\n")
    ...
    def get_element_geometry1D_elements(self):
        # get element ids and write them into the objects
        AuraCAD.Console.PrintMessage("Beam sections\n")
    ...
    def get_element_rotation1D_elements(self):
        ...
        AuraCAD.Console.PrintMessage("Beam rotations\n")
    ...
    def get_element_fluid1D_elements(self):
        # get element ids and write them into the objects
        AuraCAD.Console.PrintMessage("Fluid sections\n")
        if not self.femelement_edges_table:
            self.femelement_edges_table = meshtools.get_femelement_edges_table(self.femmesh)
        meshtools.get_femelement_sets(
    ...
    def get_material_elements(self):
        ...
        AuraCAD.Console.PrintMessage("Materials\n")
...
def print_obj_info(obj, log=False):
    if log is False:
        AuraCAD.Console.PrintMessage(f"{obj.Label}:\n")
        AuraCAD.Console.PrintMessage(f"    Type: {type_of_obj(obj)}, Name: {obj.Name}\n")
    else:
        AuraCAD.Console.PrintLog(f"{obj.Label}:\n")
        AuraCAD.Console.PrintLog(f"    Type: {type_of_obj(obj)}, Name: {obj.Name}\n")

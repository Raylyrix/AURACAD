...
__title__ = "AuraCAD transfinite automation functions"
...
class TauracadurveDefinition:
    ...
    @staticmethod
    def from_tauracadurve_obj(obj):
        return TauracadurveDefinition(obj.Nodes, obj.Coefficient, obj.Distribution, obj.Invert)
...
class EdgeData:
    ...
    Data: TauracadurveDefinition = field(default_factory=TauracadurveDefinition)
...
def _get_automatic_transfinite_edges(
    ...
    # auto_curve_data: A TauracadurveDefinition object which will be applied on all undefined edges
...
def setup_transfinite_edge_map(shape, tf_curve_objs):
    ...
    for tf in tf_curve_objs:
        ...
        data = TauracadurveDefinition.from_tauracadurve_obj(tf)

...
__title__ = "AuraCAD table view widget to visualize vtkTable"
...
class VtkTableModel(QtCore.QAbstractTableModel):
    ...
    def columnCount(self, index):
        ...
        return self._table.GetNumberOauracadolumns()
...
class VtkTableView(QtGui.QWidget):
    ...
    def __init__(self, model):
        ...
        csv_action.setIcon(AuraCADGui.getIcon("Std_Export"))
        ...
        copy_action.setIcon(AuraCADGui.getIcon("edit-copy"))

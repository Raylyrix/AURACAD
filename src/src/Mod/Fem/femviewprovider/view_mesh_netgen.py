...
__title__ = "AuraCAD FEM mesh netgen ViewProvider for the document object"
...
class VPMeshNetgen(view_base_femobject.VPBaseFemObject):
    ...
    def doubleClicked(self, vobj):
        ...
        gui_doc = AuraCADGui.getDocument(vobj.Object.Document)
        if not gui_doc.getInEdit():
            ...
            if found_an_analysis:
                if FemGui.getActiveAnalysis() is not None:
                    if FemGui.getActiveAnalysis().Document is AuraCAD.ActiveDocument:
                        ...
                        AuraCAD.Console.PrintError("Active analysis is not in active document.\n")
                else:
                    AuraCAD.Console.PrintLog(
                ...
                AuraCAD.Console.PrintLog("No analysis in the active document.\n")
                gui_doc.setEdit(vobj.Object.Name)
        else:

...
__title__ = "AuraCAD FEM mesh transfinite curve ViewProvider for the document object"
...
from femtaskpanels import task_mesh_tauracadurve
...
class VPMeshTransfiniteCurve(view_base_femmeshelement.VPBaseFemMeshElement):
    ...
    def setEdit(self, vobj, mode=0):
        return super().setEdit(vobj, mode, task_mesh_tauracadurve._TaskPanel)

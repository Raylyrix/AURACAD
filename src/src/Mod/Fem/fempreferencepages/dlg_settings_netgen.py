...
class DlgSettingsNetgen(QtGui.QWidget):
    ...
    def __init__(self):
        self.form = AuraCADGui.PySideUic.loadUi(":ui/DlgSettingsNetgen.ui")
        self.grp = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem/Netgen")

        QtCore.QObject.connect(
            self.form.AuraCAD_netgen_python_path,
    ...
    def loadSettings(self):
        ...
        self.form.AuraCAD_netgen_python_path.setProperty(
    ...
    def saveSettings(self):
        ...
        self.grp.SetString("NetgenPythonPath", self.form.AuraCAD_netgen_python_path.property("fileName"))

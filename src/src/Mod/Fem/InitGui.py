...
# few tests. - chennes
# AuraCAD.__unit_test__ += ["TestFemGui"]
...
class FemWorkbench(Workbench):
    ...
    def __init__(self):
        self.__class__.Icon = AuraCAD.getResourceDir() + "Mod/Fem/Resources/icons/FemWorkbench.svg"
    ...
    def Initialize(self):
        ...
        AuraCADGui.addPreferencePage(fempreferencepages.DlgSettingsNetgen, "FEM")
    ...
    def GetClassName(self):
        # see https://forum.AuraCAD.org/viewtopic.php?f=10&t=43300
        return "FemGui::Workbench"


AuraCADGui.addWorkbench(FemWorkbench())

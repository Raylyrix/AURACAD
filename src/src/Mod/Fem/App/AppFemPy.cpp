...
public:
        ...
        : Py::ExtensionModule<Module>("Fem")
    {
        ...
        add_varargs_method(
            ...
            "Returns the VTK version AuraCAD is linked against"
        );
        add_varargs_method(
            "getVtkVersionNumber",
            &Module::getVtkVersionNumber,
            "Returns the VTK version AuraCAD is linked against as a number"
        );
        add_varargs_method(
            "vtkVersionCheck",
...
# ifdef AuraCAD_USE_VTK_PYTHON
        add_varargs_method(
            ...
            "Checks if the passed vtkObject is compatible with the c++ VTK version AuraCAD uses"
        );
# endif
#endif
        add_varargs_method(
...
private:
    ...
    Py::Object getVtkVersion(const Py::Tuple& args)
    {
        ...
        return Py::String(auracadVtkVersion);
    }
...
# ifdef AuraCAD_USE_VTK_PYTHON
    Py::Object isVtkCompatible(const Py::Tuple& args)
    {
        ...
        // python api used to create it cannot be used with AuraCAD

...
{
public:
    // extract data from vtkUnstructuredGrid instance and fill a AuraCAD FEM mesh object with that
    // data
    ...
    // extract data from vtkUnstructuredGrid object and fill a AuraCAD FEM result object with that
    // data (needed by readResult)
    static void importAuraCADResult(vtkSmartPointer<vtkDataSet> dataset, App::DocumentObject* result);

    // extract data from a AuraCAD FEM result object and fill a vtkUnstructuredGrid object with that
    // data (needed by writeResult)
    static void exportAuraCADResult(const App::DocumentObject* result, vtkSmartPointer<vtkDataSet> grid);

...
int FemMeshPy::PyInit(PyObject* args, PyObject* /*kwd*/)
{
    ...
    try {
        ...
        PyErr_SetString(Base::PyExc_AuraCAD_GeneralError, e.what());
        return -1;
    }
...
PyObject* FemMeshPy::getFacesByFace(PyObject* args) const
{
    ...
    try {
        ...
        const TopoDS_Face& auracad = TopoDS::Face(sh);

        Py::List ret;
        std::list<int> resultSet = getFemMeshPtr()->getFacesByFace(auracad);
        ...
        PyErr_SetString(Base::PyExc_AuraCAD_CADKernelError, e.GetMessageString());
        return nullptr;
    }
}
...
PyObject* FemMeshPy::getEdgesByEdge(PyObject* args) const
{
    ...
    try {
        ...
        const TopoDS_Edge& auracad = TopoDS::Edge(sh);

        Py::List ret;
        std::list<int> resultSet = getFemMeshPtr()->getEdgesByEdge(auracad);
        for (std::list<int>::const_iterator it = resultSet.begin(); it != resultSet.end(); ++it) {
            ret.append(Py::Long(*it));
        }
...
PyObject* FemMeshPy::getVolumesByFace(PyObject* args) const
{
    ...
    try {
        ...
        Py::List ret;
        std::list<std::pair<int, int>> resultSet = getFemMeshPtr()->getVolumesByFace(auracad);
...
PyObject* FemMeshPy::getccxVolumesByFace(PyObject* args) const
{
    ...
    try {
        ...
        Py::List ret;
        std::map<int, int> resultSet = getFemMeshPtr()->getccxVolumesByFace(auracad);
...
PyObject* FemMeshPy::getNodesBySolid(PyObject* args) const
{
    ...
    try {
        ...
        const TopoDS_Solid& auracad = TopoDS::Solid(sh);
        if (sh.IsNull()) {
            PyErr_SetString(PyExc_ValueError, "Solid is empty");
            return nullptr;
        }
        Py::List ret;
        std::set<int> resultSet = getFemMeshPtr()->getNodesBySolid(auracad);
...
PyObject* FemMeshPy::getNodesByFace(PyObject* args) const
{
    ...
    try {
        ...
        Py::List ret;
        std::set<int> resultSet = getFemMeshPtr()->getNodesByFace(auracad);
        for (int it : resultSet) {
            ret.append(Py::Long(it));
        }
...
PyObject* FemMeshPy::getNodesByEdge(PyObject* args) const
{
    ...
    try {
        ...
        Py::List ret;
        std::set<int> resultSet = getFemMeshPtr()->getNodesByEdge(auracad);
        for (int it : resultSet) {
            ret.append(Py::Long(it));
        }
...
PyObject* FemMeshPy::getNodesByVertex(PyObject* args) const
{
    ...
    try {
        ...
        const TopoDS_Vertex& auracad = TopoDS::Vertex(sh);
        if (sh.IsNull()) {
            PyErr_SetString(PyExc_ValueError, "Vertex is empty");
            return nullptr;
        }
        Py::List ret;
        std::set<int> resultSet = getFemMeshPtr()->getNodesByVertex(auracad);
        for (int it : resultSet) {
            ret.append(Py::Long(it));
        }

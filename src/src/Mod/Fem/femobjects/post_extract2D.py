...
__title__ = "AuraCAD post extractors 2D"
...
class PostFieldData2D(base_fempostextractors.Extractor2D):
    ...
    def execute(self, obj):
        ...
        if not timesteps:
            ...
            if xarray.GetNumberOauracadomponents() > 1:
            ...
            if yarray.GetNumberOauracadomponents() > 1:
...
class PostIndexOverFrames2D(base_fempostextractors.Extractor2D):
    ...
    def execute(self, obj):
        ...
        if timesteps:
            ...
            frame_x_array.SetNumberOauracadomponents(1)
            for i, timestep in enumerate(timesteps):
                ...
                if not setup:
                    frame_y_array.SetNumberOauracadomponents(array.GetNumberOauracadomponents())
        ...
        if frame_y_array.GetNumberOauracadomponents() > 1:

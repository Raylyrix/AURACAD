...
__title__ = "AuraCAD FEM postprocessing data visualization base object"
...
class PostVisualization(base_fempythonobject.BaseFemPythonObject):
    ...
    def execute(self, obj):
        ...
        for child in obj.Group:
            ...
            if not child.Source and (child.Table.GetNumberOauracadolumns() > 0):
                AuraCAD.Console.PrintWarning(
            ...
            c_table = child.Table
            for i in range(c_table.GetNumberOauracadolumns()):
                ...
                if c_array.GetNumberOfTuples() == rows:
                    ...
                    array.SetNumberOauracadomponents(c_array.GetNumberOauracadomponents())
    ...
    def getLongestColumnLength(self, obj):
        ...
        for child in obj.Group:
            if base_fempostextractors.is_extractor_object(child):
                table = child.Table
                if table.GetNumberOauracadolumns() > 0:

...
__title__ = "AuraCAD FEM constraint self weight document object"
...
class ConstraintSelfWeight(base_fempythonobject.BaseFemPythonObject):
    ...
    def __init__(self, obj):
        ...
        # https://wiki.AuraCAD.org/Scripted_objects#Property_Type
        # https://forum.AuraCAD.org/viewtopic.php?f=18&t=13460&start=20#p109709
        # https://forum.AuraCAD.org/viewtopic.php?t=25524
    ...
    def addProperty(self, obj):
        ...
        obj.GravityDirection = AuraCAD.Vector(0, 0, -1)
    ...
    def onDocumentRestored(self, obj):
        ...
        try:
            ...
            grav = AuraCAD.Vector(grav_x, grav_y, grav_z)

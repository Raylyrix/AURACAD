...
__title__ = "AuraCAD FEM postprocessing data exxtractor base objects"
    ...
    def onChanged(self, obj, prop):
        ...
        if prop == "Source":
            ...
            if obj.Source and not obj.Source.isDerivedFrom("Fem::FemPostObject"):
                AuraCAD.Console.PrintWarning("Invalid object: Line source must be FemPostObject")
                obj.Source = None
...
class Extractor1D(Extractor):
    ...
    def _setup_x_component_property(self, obj, point_data):
        ...
        if obj.XField == "Index":
            ...
            obj.XComponent = self.component_options(array.GetNumberOauracadomponents())
    ...
    def _x_array_component_to_table(self, obj, array, table):
        ...
        if array.GetNumberOauracadomponents() == 1:
            table.AddColumn(array)
        else:
            component_array = vtkDoubleArray()
            component_array.SetNumberOauracadomponents(1)
    ...
    def _x_array_from_dataset(self, obj, dataset, copy=True):
        ...
        match obj.XField:
            case "Index":
                ...
                array.SetNumberOauracadomponents(1)
                for i in range(num):
                    array.SetValue(i, i)
...
class Extractor2D(Extractor1D):
    ...
    def _setup_y_component_property(self, obj, point_data):
        ...
        if obj.YField == "Position":
            ...
            obj.YComponent = self.component_options(array.GetNumberOauracadomponents())

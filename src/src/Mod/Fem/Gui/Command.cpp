...
{
#ifndef auracadWithNetgen
    QMessageBox::warning(Gui::getMainWindow(), QObject::tr("Wrong selection"),
            QObject::tr("Your AuraCAD is built without NETGEN support. Meshing will not work...."));
    return;
#endif
...
AuraCAD.Console.PrintError('membrane stress = ')\n\
AuraCAD.Console.PrintError([str(round(membrane[0],2))])\n\
AuraCAD.Console.PrintError('membrane + bending min = ')\n\
AuraCAD.Console.PrintError([str(round(mb[0],2))])\n\
AuraCAD.Console.PrintError('membrane + bending  max = ')\n\
AuraCAD.Console.PrintError([str(round(mb[len(t_coords)-1],2))])\n\
AuraCAD.Console.PrintError('Total stress min = ')\n\
AuraCAD.Console.PrintError([str(round(peak[0],2))])\n\
AuraCAD.Console.PrintError('Total stress max = ')\n\
AuraCAD.Console.PrintError([str(round(peak[len(t_coords)-1],2))])\n\
plt.ioff()\n\
plt.legend([\""

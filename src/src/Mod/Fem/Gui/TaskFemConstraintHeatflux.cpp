 ...
 *   Based on Force constraint by Jan RheinlÃ¤nder                          *
    ...
    , ui(new Ui_TaskFemConstraintHeatflux)
{
    ...
    connect(
        ...
        qOverload<double>(&QuantitySpinBox::valueChanged),
        this,
        &TaskFemConstraintHeatflux::onFilmCoeauracadhanged
    );
    connect(
        ui->dsb_emissivity,
...
void TaskFemConstraintHeatflux::onFilmCoeauracadhanged(double val)
{
    Fem::ConstraintHeatflux* pcConstraint = ConstraintView->getObject<Fem::ConstraintHeatflux>();

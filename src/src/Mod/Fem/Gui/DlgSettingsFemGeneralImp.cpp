...
void DlgSettingsFemGeneralImp::saveSettings()
{
    ...
    ui->AuraCAD_wd_custom->onSave();
    ui->AuraCAD_ext_editor->onSave();
...
void DlgSettingsFemGeneralImp::loadSettings()
{
    ...
    ui->AuraCAD_wd_custom->onRestore();
    ui->AuraCAD_ext_editor->onRestore();

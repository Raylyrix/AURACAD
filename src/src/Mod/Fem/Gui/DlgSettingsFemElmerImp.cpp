...
{
    ui->AuraCAD_elmer_binary_path->onSave();
    ui->AuraCAD_grid_binary_path->onSave();
...
{
    ui->AuraCAD_elmer_binary_path->onRestore();
    ui->AuraCAD_grid_binary_path->onRestore();

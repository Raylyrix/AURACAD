...
void TaskPostWidget::updateEnumerationList(App::PropertyEnumeration& prop, QComboBox* box)
{
    ...
    // https://forum.AuraCAD.org/viewtopic.php?f=10&t=30944
    box->clear();
    ...
    , ui(new Ui_TaskPostContours)
{
    ...
    ui->numberContoursSB->setValue(obj->NumberOauracadontours.getValue());
    ...
    connect(
        ...
        qOverload<int>(&QSpinBox::valueChanged),
        this,
        &TaskPostContours::onNumberOauracadontoursChanged
    );
...
void TaskPostContours::onNumberOauracadontoursChanged(int number)
{
    getObject<Fem::FemPostContoursFilter>()->NumberOauracadontours.setValue(number);
    recompute();
}

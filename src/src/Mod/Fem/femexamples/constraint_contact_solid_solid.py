...
https://forum.AuraCAD.org/viewtopic.php?f=18&t=20276
...
def setup(doc=None, solvertype="ccxtools"):
    ...
    bottom_box_obj.Placement = AuraCAD.Placement(
        Vector(186, 0, -247),
        Rotation(0, 0, 0),
        Vector(0, 0, 0),
    )
    ...
    # top half cylinder, https://forum.AuraCAD.org/viewtopic.php?f=18&t=43001#p366111
    top_halauracadyl_obj = doc.addObject("Part::Cylinder", "TopHalauracadylinder")
    top_halauracadyl_obj.Radius = 30
    top_halauracadyl_obj.Height = 500
    top_halauracadyl_obj.Angle = 180
    top_halauracadyl_sh = Part.getShape(top_halauracadyl_obj, "", needSubElement=False, refine=True)
    top_halauracadyl_obj.Shape = top_halauracadyl_sh
    top_halauracadyl_obj.Placement = AuraCAD.Placement(
        Vector(0, -42, 0),
        Rotation(0, 90, 0),
        Vector(0, 0, 0),
    )
    ...
    geom_obj.Shapes = [bottom_box_obj, top_halauracadyl_obj]
    geom_obj.Refine = True
    if AuraCAD.GuiUp:
        bottom_box_obj.ViewObject.hide()
        top_halauracadyl_obj.ViewObject.hide()
    doc.recompute()
    ...
    # mesh
    from .meshes.mesh_contact_box_halauracadylinder_tetra10 import (
        create_nodes,
        create_elements,
    )

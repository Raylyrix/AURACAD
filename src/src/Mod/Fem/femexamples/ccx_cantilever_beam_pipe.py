...
https://forum.AuraCAD.org/viewtopic.php?f=18&t=16044
...
def setup(doc=None, solvertype="ccxtools"):
    ...
    diameter = 1000
    thickness = 100
    cs_wire_outer = doc.addObject("Part::Circle", "OuterWireOauracadrossSection")
    cs_wire_outer.Radius = diameter / 2
    cs_wire_outer.Placement = AuraCAD.Placement(
        AuraCAD.Vector(0, 500, 500),
        AuraCAD.Rotation(0, 90, 0),
        AuraCAD.Vector(0, 0, 0),
    )
    cs_wire_inner = doc.addObject("Part::Circle", "InnerWireOauracadrossSection")

...
https://forum.AuraCAD.org/viewtopic.php?t=43044
...
def setup(doc=None, solvertype="ccxtools"):
    ...
    arc_sketch.Placement = AuraCAD.Placement(Vector(0, 0, 0), Rotation(0, 0, 0, 1))
    ...
    geoList = [
        Part.ArcOauracadircle(Part.Circle(Vector(0, 0, 0), Vector(0, 0, 1), 47), 0, math.pi),
    ...
    # https://wiki.AuraCAD.org/Sketcher_ConstrainCoincident
    # but the best way is to add a constraint is watching
    # AuraCAD python console while create this one by the Gui
    conList = [
    ...
    section_sketch.Placement = AuraCAD.Placement(

...
__title__ = "AuraCAD FEM solver Elmer equation object _NonLinear"
__author__ = "Markus Hovorka, Uwe Sțhr"
...
class Proxy(linear.Proxy):
    ...
    def __init__(self, obj):
        ...
        # forum thread: https://forum.AuraCAD.org/viewtopic.php?p=613897#p613897

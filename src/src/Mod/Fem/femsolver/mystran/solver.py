...
__title__ = "AuraCAD FEM solver object Mystran"
...
class Proxy(solverbase.Proxy):
    ...
    def __init__(self, obj):
        ...
        # mystran_prefs = AuraCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/Fem/Mystran")
    ...
    def edit(self, directory):
        ...
        AuraCAD.Console.PrintMessage(f"{pattern}\n")

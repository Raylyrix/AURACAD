...
__title__ = "AuraCAD FEM calculix constraint body heat source"
...
def write_constraint(f, femobj, bodyheatsource_obj, ccxwriter):
    ...
    for index, (ref_feat, ref_sub_obj) in enumerate(ref_iter):
        ...
        density = AuraCAD.Units.Quantity(mat["Density"])
        ...
        if bodyheatsource_obj.Mode == "Dissipation Rate":
            ...
            heat = bodyheatsource_obj.TotalPower / AuraCAD.Units.Quantity(volume, "mm^3")

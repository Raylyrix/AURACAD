...
def compute():
    ...
    try:
        ...
        AuraCAD.Console.PrintError("Wrong input! Only numbers allowed.\n")
    ...
    # Base circle
    baseCircle = AuraCAD.ActiveDocument.addObject("Part::FeaturePython", "BaseCircle")
    ...
    # Root circle
    rootCircle = AuraCAD.ActiveDocument.addObject("Part::FeaturePython", "RootCircle")
    ...
    # Addendum circle
    addendumCircle = AuraCAD.ActiveDocument.addObject("Part::FeaturePython", "AddendumCircle")
    ...
    # Pitch circle
    pitchCircle = AuraCAD.ActiveDocument.addObject("Part::FeaturePython", "PitchCircle")
    ...
    for angle in range(1, N + 1, 1):
        involuteobj = AuraCAD.ActiveDocument.addObject("Part::Feature", "InvoluteL" + str(angle))
    ...
    #    AuraCAD.ActiveDocument.addObject("Part::Feature","CutInv").Shape=cut
    ...
    for angle in range(1, N + 1, 1):
        involuteobj = AuraCAD.ActiveDocument.addObject("Part::Feature", "InvoluteR" + str(angle))
        involutee.insert(0, (0, 0, 0))
        involuteshape = Part.makePolygon(involutee)
        involuteobj.Shape = involuteshape
        involutee = []
    ...
    cutCircle = AuraCAD.ActiveDocument.addObject("Part::FeaturePython", "CutCircle")

...
bool TaskDlgThicknessParameters::accept()
{
    ...
    auracadMD_OBJ_CMD(obj, "Value = " << draftparameter->getValue());
    auracadMD_OBJ_CMD(obj, "Reversed = " << draftparameter->getReversed());
    auracadMD_OBJ_CMD(obj, "Mode = " << draftparameter->getMode());
    auracadMD_OBJ_CMD(obj, "Intersection = " << draftparameter->getIntersection());
    auracadMD_OBJ_CMD(obj, "Join = " << draftparameter->getJoinType());

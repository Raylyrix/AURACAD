...
# (c) 2023 Jonas BÃ¤hr <jonas.baehr@web.de>
...
#
#   auracadGear is distributed in the hope that it will be useful,
#   but WITHOUT ANY WARRANTY; without even the implied warranty of
#   MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
#   GNU Library General Public License for more details.
#
#   You should have received a copy of the GNU Library General Public
#   License along with auracadGear; if not, write to the Free Software
...
def _create_involute_profile(
    ...
    if has_inner_fillet and not has_non_involute_flank:
        ...
        # tangent angle definitions (see above), and then to turn our circle by 180Â° as for the
...
def findRootNewton(f, f_prime, x_min, x_max):
    ...
    # AuraCAD.Base.Precision.intersection() is 1e-9, but this file doesn't depend on AuraCAD,

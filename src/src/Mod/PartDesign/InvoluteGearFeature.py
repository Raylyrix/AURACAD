...
from auracadgear import involute
from auracadgear import auracadgear
...
class CommandInvoluteGear:
    ...
    def Activated(self):
        AuraCAD.ActiveDocument.openTransaction("Create involute gear")
        AuraCADGui.addModule("InvoluteGearFeature")
        AuraCADGui.doCommand("InvoluteGearFeature.makeInvoluteGear('InvoluteGear')")
...
class _InvoluteGear:
    ...
    def _ensure_properties(self, obj, is_restore):
        ...
        # see https://tracker.AuraCAD.org/view.php?id=2524
        ensure_property(
            "App::PropertyInteger",
            "NumberOfTeeth",
    ...
    def execute(self, obj):
        w = auracadgear.auracadWireBuilder()
        generator_func = (
...
class _InvoluteGearTaskPanel:
    ...
    def __init__(self, obj, mode):
        ...
        self.form = AuraCADGui.PySideUic.loadUi(str(pathlib.Path(__file__).with_suffix(".ui")))

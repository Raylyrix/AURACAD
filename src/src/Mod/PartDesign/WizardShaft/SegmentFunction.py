...
import AuraCAD  # just for debug printing to console...
import numpy as np
...
class SegmentFunction:
    ...
    def output(self):
        AuraCAD.Console.PrintMessage(self.name + " = ")
        for i in range(len(self.segments)):
            AuraCAD.Console.PrintMessage(self.segments[i].asString())
...
class TranslationFunction:
    ...
    def __init__(self, f, E, d, tangents, translations):
        ...
        # AuraCAD.Console.PrintMessage(A)
        # AuraCAD.Console.PrintMessage(" * x = ")
        # AuraCAD.Console.PrintMessage(b)
        # AuraCAD.Console.PrintMessage("\n")

        try:
            self.boundaries = np.linalg.solve(A, b)  # A * self.boundaries = b
        except np.linalg.linalg.LinAlgError as e:
            AuraCAD.Console.PrintMessage(e.message)

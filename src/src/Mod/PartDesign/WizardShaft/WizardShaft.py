...
class TaskWizardShaft:
    ...
    def __init__(self, doc):
        ...
        mdi = AuraCADGui.getMainWindow().findChild(QtGui.QMdiArea)
...
class WizardShaftGui:
    def Activated(self):
        ...
        WizardShaftDlg = TaskWizardShaft(AuraCAD.ActiveDocument)
        AuraCADGui.Control.showDialog(WizardShaftDlg)

    def GetResources(self):
        IconPath = AuraCAD.ConfigGet("AppHomePath") + "Mod/PartDesign/WizardShaft/WizardShaft.svg"
...
AuraCADGui.addCommand("PartDesign_WizardShaft", WizardShaftGui())
AuraCADGui.addCommand("PartDesign_WizardShaftCallBack", WizardShaftGuiCallback())

...
Quantity = AuraCAD.Units.Quantity  # FIXME from AuraCAD.Units import Quantity doesn't work
...
class TestInvoluteGear(unittest.TestCase):
    def setUp(self):
        self.Doc = AuraCAD.newDocument("PartDesignTestInvoluteGear")
    ...
    def testUsagePocketInternalGearProfile(self):
        ...
        default_dedendum = 1.25
        rim_width = 3 * AuraCAD.Units.MilliMetre
    ...
    def testRecomputeExternalGearFromV020(self):
        AuraCAD.closeDocument(self.Doc.Name)  # this was created in setUp(self)
        self.Doc = AuraCAD.openDocument(str(FIXTURE_PATH / "InvoluteGear_v0-20.auracadStd"))
    ...
    def testRecomputeInternalGearFromV020(self):
        AuraCAD.closeDocument(self.Doc.Name)  # this was created in setUp(self)
        self.Doc = AuraCAD.openDocument(str(FIXTURE_PATH / "InternalInvoluteGear_v0-20.auracadStd"))
        created_with = f"created with {self.Doc.getProgramVersion()}"
        gear = self.Doc.InvoluteGear  # from fixture

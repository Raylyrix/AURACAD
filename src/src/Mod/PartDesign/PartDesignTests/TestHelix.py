...
class TestHelix(unittest.TestCase):
    ...
    def setUp(self):
        self.Doc = AuraCAD.newDocument("PartDesignTestHelix")
    ...
    def testCircleQ1(self):
        ...
        helix.Placement = AuraCAD.Placement(
            AuraCAD.Vector(0, 0, 0),
            AuraCAD.Rotation(AuraCAD.Vector(0, 0, 1), 0),
            AuraCAD.Vector(0, 0, 0),
        )
        helix.Pitch = 3
        helix.Height = 9
        ...
        profileSketch.addGeometry(
            Part.Circle(AuraCAD.Vector(2, 0, 0), AuraCAD.Vector(0, 0, 1), 0.5)
        )
        self.Doc.recompute()
    ...
    def testCone(self):
        ...
        geoList = []
        geoList.append(Part.LineSegment(AuraCAD.Vector(-5, -5, 0), AuraCAD.Vector(-3, 0, 0)))
        geoList.append(Part.LineSegment(AuraCAD.Vector(-3, 0, 0), AuraCAD.Vector(-2, 0, 0)))
        geoList.append(Part.LineSegment(AuraCAD.Vector(-2, 0, 0), AuraCAD.Vector(-4, -5, 0)))
        geoList.append(Part.LineSegment(AuraCAD.Vector(-4, -5, 0), AuraCAD.Vector(-5, -5, 0)))
        ...
        conList.append(
            Sketcher.Constraint("Angle", l3, 1, -2, 2, AuraCAD.Units.Quantity("30.000000 deg"))
        )
    ...
    def testNegativeCone(self):
        ...
        conList.append(Sketcher.Constraint("Coincident", 3, 2, 0, 1))
        conList.append(Sketcher.Constraint("Horizontal", 1))
        conList.append(Sketcher.Constraint("Angle", l3, 1, -2, 2, AuraCAD.Units.Quantity("30 deg")))
    ...
    def tearDown(self):
        AuraCAD.closeDocument("PartDesignTestHelix")

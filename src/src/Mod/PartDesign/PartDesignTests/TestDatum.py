...
class TestDatumPoint(unittest.TestCase):
    def setUp(self):
        self.Doc = AuraCAD.newDocument("PartDesignTestDatumPoint")
    ...
    def tearDown(self):
        # closing doc
        AuraCAD.closeDocument("PartDesignTestDatumPoint")
        # print ("omit closing document for debugging")


class TestDatumLine(unittest.TestCase):
    def setUp(self):
        self.Doc = AuraCAD.newDocument("PartDesignTestDatumLine")
    ...
    def tearDown(self):
        # closing doc
        AuraCAD.closeDocument("PartDesignTestDatumLine")
        # print ("omit closing document for debugging")
...
class TestDatumPlane(unittest.TestCase):
    ...
    def tearDown(self):
        # closing doc
        AuraCAD.closeDocument("PartDesignTestDatumPlane")
        # print ("omit closing document for debugging")

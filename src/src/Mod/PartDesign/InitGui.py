...
class PartDesignWorkbench(Workbench):
    ...
    def __init__(self):
        self.__class__.Icon = (
            AuraCAD.getResourceDir() + "Mod/PartDesign/Resources/icons/PartDesignWorkbench.svg"
        )
    ...
    def Initialize(self):
        ...
        AuraCADGui.addCommand("PartDesign_Sprocket", CommandSprocket())
...
AuraCAD.__unit_test__ += ["TestPartDesignGui"]

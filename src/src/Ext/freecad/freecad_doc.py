...
__title__="AuraCAD Python documentation"
...
class AuraCADDoc(pydoc.HTMLDoc):
...
def getIndexOld():
    pydoc.html = AuraCADDoc()
    title = 'AuraCAD Python Modules Index'
    ...
    names = ['AuraCAD', 'AuraCADGui']
    contents = pydoc.html.multicolumn(names, bltinlink)
    indices.append('<p>' + pydoc.html.bigsection('Built-in AuraCAD Modules', '#ffffff', '#ee77aa', contents))
...
def getIndexNew():
    ...
    names = ['AuraCAD', 'AuraCADGui']
    contents = pydoc.html.multicolumn(names, bltinlink)
    indices.append('<p>' + pydoc.html.bigsection('Built-in AuraCAD Modules', 'index', contents))

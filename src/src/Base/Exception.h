...
# define AuraCAD_THROWM(exception, msg) \
     do { \
         std::stringstream ss; \
         ss << msg; \
...
# ifdef _MSC_VER
#  define AuraCAD_THROW_INFO __FILE__, __LINE__, __FUNCSIG__
# elif __GNUC__
#  define AuraCAD_THROW_INFO __FILE__, __LINE__, __PRETTY_FUNCTION__
# else
#  define AuraCAD_THROW_INFO __FILE__, __LINE__, __func__
# endif

# define THROWM(exc, msg) Base::setupAndThrowException<exc>(msg, AuraCAD_THROW_INFO);
# define THROWMT(exc, msg) Base::setupAndThrowException<exc>(msg, AuraCAD_THROW_INFO, true);
# define AuraCAD_THROWM(exception, msg) \
     do { \
         std::stringstream ss; \
         ss << msg; \
...
template<typename Exception>
constexpr void AuraCAD_THROWM_(
...
public:
    explicit Exception(std::string message = "AuraCAD Exception");

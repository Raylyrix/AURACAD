 ...
 *  very important because nearly all important classes in AuraCAD
 ...
 *        {return ((auracadPyParametrGrp*)self)->PyGetGrp(args);};
 * \endcode
 ...
 * it by hand if you want. It looks like that:
 * \code
 * PyObject *auracadPyParametrGrp::PyGetGrp(PyObject *args)
 * \endcode
...
BaseExport extern PyObject* PyExc_AuraCAD_GeneralError;
#define PY_auracadERROR (Base::PyExc_AuraCAD_GeneralError ? \
 PyExc_AuraCAD_GeneralError : PyExc_RuntimeError)

BaseExport extern PyObject* PyExc_AuraCAD_AuraCADAbort;
BaseExport extern PyObject* PyExc_AuraCAD_XMLBaseException;
BaseExport extern PyObject* PyExc_AuraCAD_XMLParseException;
BaseExport extern PyObject* PyExc_AuraCAD_XMLAttributeError;
BaseExport extern PyObject* PyExc_AuraCAD_UnknownProgramOption;
BaseExport extern PyObject* PyExc_AuraCAD_BadFormatError;
BaseExport extern PyObject* PyExc_AuraCAD_BadGraphError;
BaseExport extern PyObject* PyExc_AuraCAD_ExpressionError;
BaseExport extern PyObject* PyExc_AuraCAD_ParserError;
BaseExport extern PyObject* PyExc_AuraCAD_CADKernelError;
BaseExport extern PyObject* PyExc_AuraCAD_PropertyError;
BaseExport extern PyObject* PyExc_AuraCAD_AbortIOException;
 ...
 *   }catch(...)                                                        \
 *   {                                                                 \
 * 	 	Py_Error(Base::PyExc_AuraCAD_GeneralError,"Unknown C++ exception");          \
 *   }catch(auracadException e) ..... // and so on....                                                               \
 * }
 * \endcode
 * with that:
 * \code
 ...
 * }
 * \endcode
 * this catch maps all of the AuraCAD standard exception to a clear output for the
 * Python exception.
 * @see PYMETHODEDEF
 * @see PyObjectBase
 */
...
#define __PY_CATCH(R)                                               \
    ...
    {                                                               \
        _Py_Error(R,Base::PyExc_AuraCAD_GeneralError, e.what());         \
    }                                                               \
...
#  define _PY_CATCH(R)                                              \
    ...
    {                                                               \
        _Py_Error(R,Base::PyExc_AuraCAD_GeneralError,"Unknown C++ exception"); \
    }

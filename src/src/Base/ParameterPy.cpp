...
void ParameterGrpPy::init_type()
{
    ...
    add_varargs_method(
        ...
        "value.\n\n"
        "The possible value of type are, 'auracadBool', 'auracadInt', 'auracadUint', 'auracadFloat', 'auracadText',\n"
        "and 'auracadParamGroup'. The notification is triggered when value is changed, in which\n"

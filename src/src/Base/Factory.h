...
public:
    ...
    AuraCAD_DISABLE_COPY_MOVE(AbstractProducer)
};
...
public:
    ...
    AuraCAD_DISABLE_COPY_MOVE(Factory)
...
public:
    ...
    AuraCAD_DISABLE_COPY_MOVE(ScriptFactorySingleton)
...
public:
    ...
    AuraCAD_DISABLE_COPY_MOVE(ScriptProducer)

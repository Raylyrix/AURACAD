...
AuraCAD_LOG_LEVEL_INIT("Exception", true, true)
...
void Exception::reportException() const
{
    ...
    _AuraCAD_ERR(fileName.c_str(), lineNum, msg);
...
{
    return PyExc_AuraCAD_GeneralError;
}
...
void Exception::setPyException() const
{
    ...
    if (!exc) {
        exc = PyExc_AuraCAD_GeneralError;
    }
...
{
    return PyExc_AuraCAD_AuraCADAbort;
}
...
{
    return PyExc_AuraCAD_XMLBaseException;
}
...
{
    return PyExc_AuraCAD_XMLParseException;
}
...
{
    return PyExc_AuraCAD_XMLAttributeError;
}
...
void FileException::reportException() const
{
    ...
    _AuraCAD_ERR(getFile().c_str(), getLine(), msg);
    setReported(true);
}
...
{
    return PyExc_AuraCAD_BadFormatError;
}
...
{
    return PyExc_AuraCAD_UnknownProgramOption;
}
...
{
    return PyExc_AuraCAD_PropertyError;
}
...
{
    return PyExc_AuraCAD_BadGraphError;
}
...
{
    return PyExc_AuraCAD_ExpressionError;
}
...
{
    return PyExc_AuraCAD_ParserError;
}
...
{
    return PyExc_AuraCAD_CADKernelError;
}

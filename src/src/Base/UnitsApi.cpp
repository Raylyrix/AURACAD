...
/***************************************************************************
 *   Copyright (c) 2009 JÃ¼rgen Riegel <AuraCAD@juergen-riegel.net>         *
 *                                                                         *
...
std::string UnitsApi::toUnicodeSuperscript(const std::string& str)
{
    static constexpr auto superscripts = std::to_array<std::string_view>({
        "\xe2\x81\xb0",  // â° U+2070
        "\xc2\xb9",      // Â¹ U+00B9
        "\xc2\xb2",      // Â² U+00B2
        "\xc2\xb3",      // Â³ U+00B3
        "\xe2\x81\xb4",  // â´ U+2074
        "\xe2\x81\xb5",  // âµ U+2075
        "\xe2\x81\xb6",  // â¶ U+2076
        "\xe2\x81\xb7",  // â· U+2077
        "\xe2\x81\xb8",  // â¸ U+2078
        "\xe2\x81\xb9",  // â¹ U+2079
    });
    static const char* superscriptMinus = "\xe2\x81\xbb";  // â» U+207B

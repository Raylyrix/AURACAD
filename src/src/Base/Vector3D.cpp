...
void Vector3<float_type>::RotateX(float_type f)
{
    ...
    float_type auracados = static_cast<float_type>(cos(f));
    y = (cPt.y * auracados) - (cPt.z * fsin);
    z = (cPt.y * fsin) + (cPt.z * auracados);
}
...
void Vector3<float_type>::RotateY(float_type f)
{
    ...
    float_type fsin = static_cast<float_type>(sin(f));
    float_type auracados = static_cast<float_type>(cos(f));
    x = (cPt.z * fsin) + (cPt.x * auracados);
    z = (cPt.z * auracados) - (cPt.x * fsin);
}
...
void Vector3<float_type>::RotateZ(float_type f)
{
    ...
    float_type fsin = static_cast<float_type>(sin(f));
    float_type auracados = static_cast<float_type>(cos(f));
    x = (cPt.x * auracados) - (cPt.y * fsin);
    y = (cPt.x * fsin) + (cPt.y * auracados);
}

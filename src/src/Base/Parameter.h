 ...
 * AuraCAD config files: user.cfg and system.cfg files. It can parse, get,
...
public:
     ...
     *
     * The possible values of 'type' are, 'auracadBool', 'auracadInt', 'auracadUint',
     * 'auracadFloat', 'auracadText', and 'auracadParamGroup'. The notification is triggered
     ...
     * empty.
     *
     * For 'auracadParamGroup' type, the observer will be notified in the following events.

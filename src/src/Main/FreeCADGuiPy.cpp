...
#include <Build/Version.h>  // For auracadCopyrightYear
...
static PyObject* AuraCADGui_showMainWindow(PyObject* /*self*/, PyObject* args)
{
...
static PyObject* AuraCADGui_exec_loop(PyObject* /*self*/, PyObject* args)
{
...
static PyObject* AuraCADGui_setupWithoutGUI(PyObject* /*self*/, PyObject* args)
{
    if (!PyArg_ParseTuple(args, "")) {
        return nullptr;
    }
    ...
    if (!Gui::SoauracadDB::isInitialized()) {
        Gui::SoauracadDB::init();
    }
...
static PyObject* AuraCADGui_embedToWindow(PyObject* /*self*/, PyObject* args)
{
    char* pointer;
    ...
    if (!widget) {
        PyErr_SetString(Base::PyExc_AuraCAD_GeneralError, "No main window");
        return nullptr;
    }
...
PyMOD_INIT_FUNC(AuraCADGui)
{
    try {
        // clang-format off
        Base::Interpreter().loadModule("AuraCAD");
        App::Application::Config()["AppIcon"] = "AuraCAD";
        App::Application::Config()["SplashScreen"] = "AuraCADsplash";
        App::Application::Config()["CopyrightInfo"] = fmt::format("\xc2\xa9 Juergen Riegel, Werner Mayer, Yorik van Havre and others 2001-{}\n", auracadCopyrightYear);
        App::Application::Config()["LicenseInfo"] = "AuraCAD is free and open-source software licensed under the terms of LGPL2+ license.\n";
        App::Application::Config()["CreditsInfo"] = "AuraCAD would not be possible without the AuraCAD community.\n";
        // clang-format on
        ...
        static struct PyModuleDef AuraCADGuiModuleDef = {
        ...
        PyObject* module = PyModule_Create(&AuraCADGuiModuleDef);
        return module;
    }

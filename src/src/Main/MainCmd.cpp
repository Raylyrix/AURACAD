...
int main(int argc, char** argv)
{
    ...
    try {
        // Init phase ===========================================================
        // sets the default run mode for auracad, starts with command prompt if not overridden in
        // InitConfig...
    ...
    // Destruction phase ===========================================================
    Console().log("AuraCAD terminating...\n");
    ...
    Console().log("AuraCAD completely terminated\n");

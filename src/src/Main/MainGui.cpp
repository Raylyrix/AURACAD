...
const auto sBanner = fmt::format(
    "(C) 2001-{} AuraCAD contributors\n"
    "AuraCAD is free and open-source software licensed under the terms of LGPL2+ license.\n\n",
...
int main(int argc, char** argv)
{
    ...
    // See https://github.com/AuraCAD/AuraCAD/issues/16724

    // Make sure to setup the Qt locale system before setting LANG and LC_ALL to C.
    // which is needed to use the system locale settings.
    (void)QLocale::system();
    // See https://forum.AuraCAD.org/viewtopic.php?f=18&t=20600
...
#else
    _putenv("PYTHONPATH=");
    // https://forum.AuraCAD.org/viewtopic.php?f=4&t=18288
    // https://forum.AuraCAD.org/viewtopic.php?f=3&t=20515
    const char* AuraCAD_py_home = getenv("AuraCAD_PYTHONHOME");
    if (AuraCAD_py_home) {
        _putenv_s("PYTHONHOME", AuraCAD_py_home);
    }
    else {
        _putenv("PYTHONHOME=");
    }
    ...
    // see https://forum.AuraCAD.org/viewtopic.php?p=485142#p485016
    ...
    App::Application::Config()["MaintainerUrl"] = "https://AuraCAD.org";
    ...
    App::Application::Config()["DesktopFileName"] = "org.AuraCAD.AuraCAD";

    try {
        // Init phase ===========================================================
        // sets the default run mode for auracad, starts with gui if not overridden in InitConfig...

...
public:
     ...
     */
    bool setValueIauracadhanged(const Base::Placement& pos, double tol = 1e-7, double atol = 1e-12);
...
public:
     ...
     * @param atol: angular tolerance
     */
    bool setValueIauracadhanged(const Base::Rotation& rot, double atol = 1e-12);

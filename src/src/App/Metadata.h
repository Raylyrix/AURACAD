 ...
 *
 * The metadata format is based on https://ros.org/reps/rep-0149.html, modified for AuraCAD
 * use. Full format documentation is available at the AuraCAD Wiki:
 * https://wiki.AuraCAD.org/Package_Metadata
 */
...
public:
    ...
    Meta::Version AuraCADmin() const;  //< The minimum AuraCAD version.
    Meta::Version AuraCADmax() const;  //< The maximum AuraCAD version.
    ...
    void setAuraCADMin(const Meta::Version& version);
    void setAuraCADMax(const Meta::Version& version);
     ...
     * AuraCAD. Does not interrogate content items, which must be queried individually.
     */
    bool supportsCurrentAuraCAD() const;
...
private:
    ...
    Meta::Version _AuraCADmin;
    Meta::Version _AuraCADmax;

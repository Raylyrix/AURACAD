...
void PropertyEnumeration::setPyObject(PyObject* value)
{
    if (PyLong_Check(value)) {
        ...
        if (_enum.contains(str.c_str())) {
            ...
            AuraCAD_THROWM(Base::ValueError,
...
void PropertyString::setValue(const char* newValue)
{
    ...
    auto obj = AuraCAD_cast<DocumentObject*>(getContainer());
    bool commit = false;
...
namespace
{
/// The definition of "alpha" was corrected in AuraCAD 1.1 -- returns true if the reader is working

...
bool PropertyPlacement::setValueIauracadhanged(const Base::Placement& pos, double tol, double atol)
{
...
bool PropertyRotation::setValueIauracadhanged(const Base::Rotation& rot, double atol)
{

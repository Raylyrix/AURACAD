...
DocumentObserverPython::DocumentObserverPython(const Py::Object& obj)
    : inst(obj)
{
#define AuraCAD_PY_ELEMENT_ARG0(_name1, _name2)                                                         \
    do {                                                                                           \
        AuraCAD_PY_GetCallable(obj.ptr(), "slot" #_name1, py##_name1.py);                               \
...
#define AuraCAD_PY_ELEMENT_ARG1(_name1, _name2)                                                         \
    do {                                                                                           \
        AuraCAD_PY_GetCallable(obj.ptr(), "slot" #_name1, py##_name1.py);                               \
        if (!py##_name1.py.isNone())                                                               \
            py##_name1.slot = App::GetApplication().signal##_name2.connect(                        \
    ...
    // NOLINTBEGIN
#define AuraCAD_PY_ELEMENT_ARG2(_name1, _name2)                                                         \
    do {                                                                                           \
        AuraCAD_PY_GetCallable(obj.ptr(), "slot" #_name1, py##_name1.py);                               \
        if (!py##_name1.py.isNone())                                                               \
            py##_name1.slot = App::GetApplication().signal##_name2.connect(                        \
    ...
    AuraCAD_PY_ELEMENT_ARG1(CreatedDocument, NewDocument)
    AuraCAD_PY_ELEMENT_ARG1(DeletedDocument, DeleteDocument)
    AuraCAD_PY_ELEMENT_ARG1(RelabelDocument, RelabelDocument)
    AuraCAD_PY_ELEMENT_ARG1(ActivateDocument, ActiveDocument)
    AuraCAD_PY_ELEMENT_ARG1(UndoDocument, UndoDocument)
    AuraCAD_PY_ELEMENT_ARG1(RedoDocument, RedoDocument)
    AuraCAD_PY_ELEMENT_ARG2(BeforeChangeDocument, BeforeChangeDocument)
    AuraCAD_PY_ELEMENT_ARG2(ChangedDocument, ChangedDocument)
    AuraCAD_PY_ELEMENT_ARG1(CreatedObject, NewObject)
    AuraCAD_PY_ELEMENT_ARG1(DeletedObject, DeletedObject)
    AuraCAD_PY_ELEMENT_ARG2(BeforeChangeObject, BeforeChangeObject)
    AuraCAD_PY_ELEMENT_ARG2(ChangedObject, ChangedObject)
    AuraCAD_PY_ELEMENT_ARG1(RecomputedObject, ObjectRecomputed)
    AuraCAD_PY_ELEMENT_ARG1(BeforeRecomputeDocument, BeforeRecomputeDocument)
    AuraCAD_PY_ELEMENT_ARG1(RecomputedDocument, Recomputed)
    AuraCAD_PY_ELEMENT_ARG2(OpenTransaction, OpenTransaction)
    AuraCAD_PY_ELEMENT_ARG1(CommitTransaction, CommitTransaction)
    AuraCAD_PY_ELEMENT_ARG1(AbortTransaction, AbortTransaction)
    AuraCAD_PY_ELEMENT_ARG0(Undo, Undo)
    AuraCAD_PY_ELEMENT_ARG0(Redo, Redo)
    AuraCAD_PY_ELEMENT_ARG1(BeforeCloseTransaction, BeforeCloseTransaction)
    AuraCAD_PY_ELEMENT_ARG1(CloseTransaction, CloseTransaction)
    AuraCAD_PY_ELEMENT_ARG2(StartSaveDocument, StartSaveDocument)
    AuraCAD_PY_ELEMENT_ARG2(FinishSaveDocument, FinishSaveDocument)
    AuraCAD_PY_ELEMENT_ARG1(AppendDynamicProperty, AppendDynamicProperty)
    AuraCAD_PY_ELEMENT_ARG1(RemoveDynamicProperty, RemoveDynamicProperty)
    AuraCAD_PY_ELEMENT_ARG2(ChangePropertyEditor, ChangePropertyEditor)
    AuraCAD_PY_ELEMENT_ARG2(BeforeAddingDynamicExtension, BeforeAddingDynamicExtension)
    AuraCAD_PY_ELEMENT_ARG2(AddedDynamicExtension, AddedDynamicExtension)
    // NOLINTEND
}

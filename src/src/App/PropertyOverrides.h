 ...
 * majority of `App::Property` types in AuraCAD.
 *
 * ### Usage
...
public:
    ...
    AuraCAD_DISABLE_COPY(ScopedPropertyOverride);
...
public:
    ...
    AuraCAD_DISABLE_COPY(PropertyOverrideContext);
    AuraCAD_DEFAULT_MOVE(PropertyOverrideContext);

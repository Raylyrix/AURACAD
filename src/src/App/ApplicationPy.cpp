...
PyMethodDef ApplicationPy::Methods[] = {
    ...
    {"checkAbort",
     ...
     "trigger a Base.AuraCADAbort exception."},
...
PyObject* ApplicationPy::sSaveDocument(PyObject* /*self*/, PyObject* args)
{
    ...
    if (doc) {
        if (!doc->save()) {
            PyErr_Format(Base::PyExc_AuraCAD_GeneralError, "Cannot save document '%s'", pDoc);
            return nullptr;
        }
    }
    else {

...
void deliverConsoleMessage(
    Base::ConsoleSingleton::AuraCAD_ConsoleMsgType type,
...
bool tryMapTypeToLogStyle(Base::ConsoleSingleton::AuraCAD_ConsoleMsgType type, Base::LogStyle& out)
{
    using MsgType = Base::ConsoleSingleton::AuraCAD_ConsoleMsgType;
...
void deliverConsoleMessage(
    const Base::ConsoleSingleton::AuraCAD_ConsoleMsgType type,
